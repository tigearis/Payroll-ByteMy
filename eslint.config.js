  ...
  ...compat.extends("next/core-web-vitals", "next/typescript"),
  {
    rules: {
      ...
      "@typescript-eslint/no-unused-vars": [
        "off", // Disabled for now - too many false positives in development
        {
          argsIgnorePattern: "^_",
          varsIgnorePattern: "^_",
      ...
      "@typescript-eslint/no-explicit-any": "off", // Disabled for flexibility - can be enabled later
      ...
      "import/order": [
        "off", // Disabled for now - can be enabled later if desired
        {
          groups: [
            "builtin",
            "external",
