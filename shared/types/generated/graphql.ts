 ...
 * 
 * Generated: 2025-06-23T12:57:46.533Z
...
export type PermissionWithResourceFragment = { __typename: 'permissions', id: string, action: string, description: string | null, resourceId: string, createdAt: string, updatedAt: string, resource: { __typename: 'resources', id: string, name: string, description: string | null } };
...
export type PayrollCoreFragment = { __typename: 'payrolls', id: string, name: string, status: string, clientId: string, primaryConsultantUserId: string | null, managerUserId: string | null, createdAt: string | null, updatedAt: string | null };

export type PayrollBasicFragment = { __typename: 'payrolls', id: string, name: string, status: string, clientId: string };
...
export type UserRoleCoreFragment = { __typename: 'user_roles', id: string, userId: string, roleId: string, createdAt: string, updatedAt: string };

export type RolePermissionCoreFragment = { __typename: 'role_permissions', id: string, roleId: string, permissionId: string, conditions: any | null, createdAt: string, updatedAt: string };

export type AuditFieldsFragment = { __typename: 'audit_audit_log', id: string, eventTime: string, action: string, resourceType: string, resourceId: string | null, userId: string | null, ipAddress: string | null, userAgent: string | null, success: boolean | null, user_email: string | null, user_role: string | null };
...
export type GetDashboardStatsQuery = { __typename: 'query_root', clients_aggregate: { __typename: 'clients_aggregate', aggregate: { __typename: 'clients_aggregate_fields', count: number } | null }, payrolls_aggregate: { __typename: 'payrolls_aggregate', aggregate: { __typename: 'payrolls_aggregate_fields', count: number } | null }, active_payrolls: { __typename: 'payrolls_aggregate', aggregate: { __typename: 'payrolls_aggregate_fields', count: number } | null }, processing_queue: { __typename: 'payrolls_aggregate', aggregate: { __typename: 'payrolls_aggregate_fields', count: number } | null } };

export type GetSystemStatsQueryVariables = Exact<{ [key: string]: never; }>;


export type GetSystemStatsQuery = { __typename: 'query_root', total_payrolls: { __typename: 'payrolls_aggregate', aggregate: { __typename: 'payrolls_aggregate_fields', count: number } | null }, total_clients: { __typename: 'clients_aggregate', aggregate: { __typename: 'clients_aggregate_fields', count: number } | null }, total_users: { __typename: 'users_aggregate', aggregate: { __typename: 'users_aggregate_fields', count: number } | null } };
...
export type GetUpcomingPayrollsQuery = { __typename: 'query_root', payrolls: Array<{ __typename: 'payrolls', id: string, name: string, status: string, client: { __typename: 'clients', id: string, name: string }, payrollDates: Array<{ __typename: 'payroll_dates', id: string, adjustedEftDate: string, processingDate: string }> }> };
...
export type GetUnifiedDashboardDataQuery = { __typename: 'query_root', clients_aggregate: { __typename: 'clients_aggregate', aggregate: { __typename: 'clients_aggregate_fields', count: number } | null }, payrolls_aggregate: { __typename: 'payrolls_aggregate', aggregate: { __typename: 'payrolls_aggregate_fields', count: number } | null }, active_payrolls: { __typename: 'payrolls_aggregate', aggregate: { __typename: 'payrolls_aggregate_fields', count: number } | null }, processing_queue: { __typename: 'payrolls_aggregate', aggregate: { __typename: 'payrolls_aggregate_fields', count: number } | null }, active_users: { __typename: 'users_aggregate', aggregate: { __typename: 'users_aggregate_fields', count: number } | null }, upcoming_payrolls: Array<{ __typename: 'payrolls', id: string, name: string, status: string, employeeCount: number | null, client: { __typename: 'clients', id: string, name: string }, primaryConsultant: { __typename: 'users', id: string, name: string } | null, payrollDates: Array<{ __typename: 'payroll_dates', id: string, adjustedEftDate: string, processingDate: string }> }>, recent_payroll_updates: Array<{ __typename: 'payrolls', id: string, name: string, status: string, updatedAt: string | null, client: { __typename: 'clients', name: string } }> };

export type GetDashboardStatsMinimalQueryVariables = Exact<{ [key: string]: never; }>;


export type GetDashboardStatsMinimalQuery = { __typename: 'query_root', clientCount: { __typename: 'clients_aggregate', aggregate: { __typename: 'clients_aggregate_fields', count: number } | null }, payrollCount: { __typename: 'payrolls_aggregate', aggregate: { __typename: 'payrolls_aggregate_fields', count: number } | null }, userCount: { __typename: 'users_aggregate', aggregate: { __typename: 'users_aggregate_fields', count: number } | null } };
...
export type GetUpcomingPayrollsMinimalQuery = { __typename: 'query_root', payrolls: Array<{ __typename: 'payrolls', id: string, name: string, status: string, client: { __typename: 'clients', name: string }, nextDate: Array<{ __typename: 'payroll_dates', adjustedEftDate: string }> }> };
...
export type GetQuickStatsOnlyQuery = { __typename: 'query_root', totals: { __typename: 'payrolls_aggregate', aggregate: { __typename: 'payrolls_aggregate_fields', count: number } | null }, activeClients: { __typename: 'clients_aggregate', aggregate: { __typename: 'clients_aggregate_fields', count: number } | null }, activeUsers: { __typename: 'users_aggregate', aggregate: { __typename: 'users_aggregate_fields', count: number } | null } };

export type ClientCountUpdatesSubscriptionVariables = Exact<{ [key: string]: never; }>;


export type ClientCountUpdatesSubscription = { __typename: 'subscription_root', clientsAggregate: { __typename: 'clients_aggregate', aggregate: { __typename: 'clients_aggregate_fields', count: number } | null } };

export type PayrollCountUpdatesSubscriptionVariables = Exact<{ [key: string]: never; }>;


export type PayrollCountUpdatesSubscription = { __typename: 'subscription_root', payrollsAggregate: { __typename: 'payrolls_aggregate', aggregate: { __typename: 'payrolls_aggregate_fields', count: number } | null } };

export type UserCountUpdatesSubscriptionVariables = Exact<{ [key: string]: never; }>;


export type UserCountUpdatesSubscription = { __typename: 'subscription_root', usersAggregate: { __typename: 'users_aggregate', aggregate: { __typename: 'users_aggregate_fields', count: number } | null } };
...
export type UpcomingPayrollsUpdatesSubscription = { __typename: 'subscription_root', payrolls: Array<{ __typename: 'payrolls', id: string, name: string, status: string, client: { __typename: 'clients', name: string }, nextDate: Array<{ __typename: 'payroll_dates', adjustedEftDate: string }> }> };
...
export const CriticalPayrollNotificationsDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"subscription","name":{"kind":"Name","value":"CriticalPayrollNotifications"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"payrolls"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"where"},"value":{"kind":"ObjectValue","fields":[{"kind":"ObjectField","name":{"kind":"Name","value":"supersededDate"},"value":{"kind":"ObjectValue","fields":[{"kind":"ObjectField","name":{"kind":"Name","value":"_is_null"},"value":{"kind":"BooleanValue","value":true}}]}},{"kind":"ObjectField","name":{"kind":"Name","value":"status"},"value":{"kind":"ObjectValue","fields":[{"kind":"ObjectField","name":{"kind":"Name","value":"_in"},"value":{"kind":"ListValue","values":[{"kind":"StringValue","value":"Issue","block":false},{"kind":"StringValue","value":"Critical","block":false}]}}]}}]}},{"kind":"Argument","name":{"kind":"Name","value":"order_by"},"value":{"kind":"ObjectValue","fields":[{"kind":"ObjectField","name":{"kind":"Name","value":"updatedAt"},"value":{"kind":"EnumValue","value":"desc"}}]}},{"kind":"Argument","name":{"kind":"Name","value":"limit"},"value":{"kind":"IntValue","value":"10"}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"name"}},{"kind":"Field","name":{"kind":"Name","value":"status"}},{"kind":"Field","name":{"kind":"Name","value":"client"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"name"}}]}},{"kind":"Field","name":{"kind":"Name","value":"primaryConsultant"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"name"}}]}}]}}]}}]} as unknown as DocumentNode<CriticalPayrollNotificationsSubscription, CriticalPayrollNotificationsSubscriptionVariables>;
export const UpcomingPayrollsUpdatesDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"subscription","name":{"kind":"Name","value":"UpcomingPayrollsUpdates"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"fromDate"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"date"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"payrolls"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"where"},"value":{"kind":"ObjectValue","fields":[{"kind":"ObjectField","name":{"kind":"Name","value":"supersededDate"},"value":{"kind":"ObjectValue","fields":[{"kind":"ObjectField","name":{"kind":"Name","value":"_is_null"},"value":{"kind":"BooleanValue","value":true}}]}},{"kind":"ObjectField","name":{"kind":"Name","value":"payrollDates"},"value":{"kind":"ObjectValue","fields":[{"kind":"ObjectField","name":{"kind":"Name","value":"adjustedEftDate"},"value":{"kind":"ObjectValue","fields":[{"kind":"ObjectField","name":{"kind":"Name","value":"_gte"},"value":{"kind":"Variable","name":{"kind":"Name","value":"fromDate"}}}]}}]}}]}},{"kind":"Argument","name":{"kind":"Name","value":"order_by"},"value":{"kind":"ObjectValue","fields":[{"kind":"ObjectField","name":{"kind":"Name","value":"payrollDates_aggregate"},"value":{"kind":"ObjectValue","fields":[{"kind":"ObjectField","name":{"kind":"Name","value":"min"},"value":{"kind":"ObjectValue","fields":[{"kind":"ObjectField","name":{"kind":"Name","value":"adjustedEftDate"},"value":{"kind":"EnumValue","value":"asc"}}]}}]}}]}},{"kind":"Argument","name":{"kind":"Name","value":"limit"},"value":{"kind":"IntValue","value":"5"}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"name"}},{"kind":"Field","name":{"kind":"Name","value":"status"}},{"kind":"Field","name":{"kind":"Name","value":"client"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"name"}}]}},{"kind":"Field","alias":{"kind":"Name","value":"nextDate"},"name":{"kind":"Name","value":"payrollDates"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"where"},"value":{"kind":"ObjectValue","fields":[{"kind":"ObjectField","name":{"kind":"Name","value":"adjustedEftDate"},"value":{"kind":"ObjectValue","fields":[{"kind":"ObjectField","name":{"kind":"Name","value":"_gte"},"value":{"kind":"Variable","name":{"kind":"Name","value":"fromDate"}}}]}}]}},{"kind":"Argument","name":{"kind":"Name","value":"order_by"},"value":{"kind":"ObjectValue","fields":[{"kind":"ObjectField","name":{"kind":"Name","value":"adjustedEftDate"},"value":{"kind":"EnumValue","value":"asc"}}]}},{"kind":"Argument","name":{"kind":"Name","value":"limit"},"value":{"kind":"IntValue","value":"1"}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"adjustedEftDate"}}]}}]}}]}}]} as unknown as DocumentNode<UpcomingPayrollsUpdatesSubscription, UpcomingPayrollsUpdatesSubscriptionVariables>;