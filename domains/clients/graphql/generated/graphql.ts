 ...
 * 
 * Generated: 2025-06-26T08:26:40.472Z
...
export type ClientWithContactFragment = { __typename?: 'clients', contactEmail?: string | null | undefined, contactPhone?: string | null | undefined, id: string, name: string };

export type ClientForBillingFragment = { __typename?: 'clients', id: string, name: string, contactPerson?: string | null | undefined, contactEmail?: string | null | undefined };

export type ClientForAuditFragment = { __typename?: 'clients', id: string, name: string };

export type ClientWithRelationsFragment = { __typename?: 'clients', active?: boolean | null | undefined, contactPerson?: string | null | undefined, createdAt?: string | null | undefined, updatedAt?: string | null | undefined, contactEmail?: string | null | undefined, contactPhone?: string | null | undefined, id: string, name: string, payrolls: Array<{ __typename?: 'payrolls', id: string, name: string, status: string, employeeCount?: number | null | undefined, createdAt?: string | null | undefined, updatedAt?: string | null | undefined, supersededDate?: string | null | undefined, primaryConsultant?: { __typename?: 'users', id: string, name: string } | null | undefined, manager?: { __typename?: 'users', id: string, name: string } | null | undefined, payrollCycle: { __typename?: 'payrollCycles', id: string, name: string } }> };

export type ClientSummaryFragment = { __typename?: 'clients', id: string, name: string, active?: boolean | null | undefined };

export type ClientListItemFragment = { __typename?: 'clients', contactEmail?: string | null | undefined, contactPhone?: string | null | undefined, id: string, name: string, active?: boolean | null | undefined, payrollCount: { __typename?: 'payrollsAggregate', aggregate?: { __typename?: 'payrollsAggregateFields', count: number } | null | undefined } };

export type ClientDashboardCardFragment = { __typename?: 'clients', id: string, name: string, active?: boolean | null | undefined, activePayrolls: { __typename?: 'payrollsAggregate', aggregate?: { __typename?: 'payrollsAggregateFields', count: number } | null | undefined } };

export type ClientTableRowFragment = { __typename?: 'clients', contactPerson?: string | null | undefined, updatedAt?: string | null | undefined, contactEmail?: string | null | undefined, contactPhone?: string | null | undefined, id: string, name: string, active?: boolean | null | undefined, payrollCount: { __typename?: 'payrollsAggregate', aggregate?: { __typename?: 'payrollsAggregateFields', count: number } | null | undefined } };

export type ClientMinimalFragment = { __typename?: 'clients', id: string, name: string };

export type ClientWithMetricsFragment = { __typename?: 'clients', id: string, name: string, active?: boolean | null | undefined, totalPayrolls: { __typename?: 'payrollsAggregate', aggregate?: { __typename?: 'payrollsAggregateFields', count: number } | null | undefined }, activePayrolls: { __typename?: 'payrollsAggregate', aggregate?: { __typename?: 'payrollsAggregateFields', count: number } | null | undefined }, recentPayrolls: Array<{ __typename?: 'payrolls', id: string, name: string, status: string, updatedAt?: string | null | undefined }> };
...
export type CreateClientMutation = { __typename?: 'mutation_root', insertClient?: { __typename?: 'clients', contactEmail?: string | null | undefined, contactPhone?: string | null | undefined, id: string, name: string } | null | undefined };
...
export type UpdateClientMutation = { __typename?: 'mutation_root', updateClientById?: { __typename?: 'clients', contactEmail?: string | null | undefined, contactPhone?: string | null | undefined, id: string, name: string } | null | undefined };
...
export type UpdateClientStatusMutation = { __typename?: 'mutation_root', updateClientById?: { __typename?: 'clients', id: string, name: string } | null | undefined };
...
export type DeactivateClientMutation = { __typename?: 'mutation_root', updateClientById?: { __typename?: 'clients', id: string, name: string } | null | undefined };
...
export type ActivateClientMutation = { __typename?: 'mutation_root', updateClientById?: { __typename?: 'clients', id: string, name: string } | null | undefined };
...
export type ArchiveClientMutation = { __typename?: 'mutation_root', updateClientById?: { __typename?: 'clients', id: string, name: string } | null | undefined };
...
export type BulkUpdateClientStatusMutation = { __typename?: 'mutation_root', bulkUpdateClients?: { __typename?: 'clientsMutationResponse', affectedRows: number, returning: Array<{ __typename?: 'clients', id: string, name: string }> } | null | undefined };
...
export type DeleteClientMutation = { __typename?: 'mutation_root', updateClientById?: { __typename?: 'clients', id: string, name: string, active?: boolean | null | undefined } | null | undefined };
...
export type GetClientsWithContactQuery = { __typename?: 'query_root', clients: Array<{ __typename?: 'clients', contactEmail?: string | null | undefined, contactPhone?: string | null | undefined, id: string, name: string }> };
...
export type ClientsGetClientByIdQuery = { __typename?: 'query_root', clientById?: { __typename?: 'clients', active?: boolean | null | undefined, contactPerson?: string | null | undefined, createdAt?: string | null | undefined, updatedAt?: string | null | undefined, contactEmail?: string | null | undefined, contactPhone?: string | null | undefined, id: string, name: string, payrolls: Array<{ __typename?: 'payrolls', id: string, name: string, status: string, employeeCount?: number | null | undefined, createdAt?: string | null | undefined, updatedAt?: string | null | undefined, supersededDate?: string | null | undefined, primaryConsultant?: { __typename?: 'users', id: string, name: string } | null | undefined, manager?: { __typename?: 'users', id: string, name: string } | null | undefined, payrollCycle: { __typename?: 'payrollCycles', id: string, name: string } }> } | null | undefined };
...
export type GetClientBasicByIdQuery = { __typename?: 'query_root', clientById?: { __typename?: 'clients', id: string, name: string } | null | undefined };
...
export type GetClientsForBillingQuery = { __typename?: 'query_root', clients: Array<{ __typename?: 'clients', id: string, name: string, contactPerson?: string | null | undefined, contactEmail?: string | null | undefined }> };
...
export type SearchClientsQuery = { __typename?: 'query_root', clients: Array<{ __typename?: 'clients', contactEmail?: string | null | undefined, contactPhone?: string | null | undefined, id: string, name: string }> };
...
export type GetClientStatsQuery = { __typename?: 'query_root', clientsAggregate: { __typename?: 'clientsAggregate', aggregate?: { __typename?: 'clientsAggregateFields', count: number } | null | undefined }, active_clients: { __typename?: 'clientsAggregate', aggregate?: { __typename?: 'clientsAggregateFields', count: number } | null | undefined }, inactive_clients: { __typename?: 'clientsAggregate', aggregate?: { __typename?: 'clientsAggregateFields', count: number } | null | undefined } };
...
export type GetClientsPaginatedQuery = { __typename?: 'query_root', clients: Array<{ __typename?: 'clients', contactEmail?: string | null | undefined, contactPhone?: string | null | undefined, id: string, name: string, active?: boolean | null | undefined, payrollCount: { __typename?: 'payrollsAggregate', aggregate?: { __typename?: 'payrollsAggregateFields', count: number } | null | undefined } }>, clientsAggregate: { __typename?: 'clientsAggregate', aggregate?: { __typename?: 'clientsAggregateFields', count: number } | null | undefined } };
...
export type GetAllClientsPaginatedQuery = { __typename?: 'query_root', clients: Array<{ __typename?: 'clients', contactPerson?: string | null | undefined, updatedAt?: string | null | undefined, contactEmail?: string | null | undefined, contactPhone?: string | null | undefined, id: string, name: string, active?: boolean | null | undefined, payrollCount: { __typename?: 'payrollsAggregate', aggregate?: { __typename?: 'payrollsAggregateFields', count: number } | null | undefined } }>, allClientsAggregate: { __typename?: 'clientsAggregate', aggregate?: { __typename?: 'clientsAggregateFields', count: number } | null | undefined } };
...
export type SearchClientsPaginatedQuery = { __typename?: 'query_root', clients: Array<{ __typename?: 'clients', contactEmail?: string | null | undefined, contactPhone?: string | null | undefined, id: string, name: string, active?: boolean | null | undefined, payrollCount: { __typename?: 'payrollsAggregate', aggregate?: { __typename?: 'payrollsAggregateFields', count: number } | null | undefined } }>, searchAggregate: { __typename?: 'clientsAggregate', aggregate?: { __typename?: 'clientsAggregateFields', count: number } | null | undefined } };
...
export type GetInactiveClientsPaginatedQuery = { __typename?: 'query_root', clients: Array<{ __typename?: 'clients', contactPerson?: string | null | undefined, updatedAt?: string | null | undefined, contactEmail?: string | null | undefined, contactPhone?: string | null | undefined, id: string, name: string, active?: boolean | null | undefined, payrollCount: { __typename?: 'payrollsAggregate', aggregate?: { __typename?: 'payrollsAggregateFields', count: number } | null | undefined } }>, inactiveAggregate: { __typename?: 'clientsAggregate', aggregate?: { __typename?: 'clientsAggregateFields', count: number } | null | undefined } };
...
export type GetClientCardQuery = { __typename?: 'query_root', clientById?: { __typename?: 'clients', contactEmail?: string | null | undefined, id: string, name: string, active?: boolean | null | undefined, payrollCount: { __typename?: 'payrollsAggregate', aggregate?: { __typename?: 'payrollsAggregateFields', count: number } | null | undefined } } | null | undefined };

export type ClientsGetAllForDeveloperQueryVariables = Exact<{ [key: string]: never; }>;


export type ClientsGetAllForDeveloperQuery = { __typename?: 'query_root', clients: Array<{ __typename?: 'clients', id: string, name: string, contactPerson?: string | null | undefined, contactEmail?: string | null | undefined, active?: boolean | null | undefined }> };
...
export type GetClientDashboardCardsQuery = { __typename?: 'query_root', clients: Array<{ __typename?: 'clients', id: string, name: string, active?: boolean | null | undefined, activePayrolls: { __typename?: 'payrollsAggregate', aggregate?: { __typename?: 'payrollsAggregateFields', count: number } | null | undefined } }> };
...
export type GetClientWithActivePayrollsQuery = { __typename?: 'query_root', clientById?: { __typename?: 'clients', contactEmail?: string | null | undefined, contactPhone?: string | null | undefined, contactPerson?: string | null | undefined, id: string, name: string, active?: boolean | null | undefined, activePayrolls: Array<{ __typename?: 'payrolls', id: string, name: string, status: string, primaryConsultant?: { __typename?: 'users', name: string } | null | undefined }> } | null | undefined };

export type GetAllClientsForDeveloperQueryVariables = Exact<{ [key: string]: never; }>;


export type GetAllClientsForDeveloperQuery = { __typename?: 'query_root', clients: Array<{ __typename?: 'clients', id: string, name: string, contactPerson?: string | null | undefined, contactEmail?: string | null | undefined, active?: boolean | null | undefined }> };

export type ClientsGetPayrollsDataQueryVariables = Exact<{ [key: string]: never; }>;


export type ClientsGetPayrollsDataQuery = { __typename?: 'query_root', clients: Array<{ __typename?: 'clients', contactEmail?: string | null | undefined, contactPhone?: string | null | undefined, id: string, name: string, active?: boolean | null | undefined, payrolls: Array<{ __typename?: 'payrolls', id: string, name: string, status: string, employeeCount?: number | null | undefined, payrollCycle: { __typename?: 'payrollCycles', name: string }, payrollDateType: { __typename?: 'payrollDateTypes', name: string }, payrollDates: Array<{ __typename?: 'payrollDates', adjustedEftDate: string }> }>, payrollCount: { __typename?: 'payrollsAggregate', aggregate?: { __typename?: 'payrollsAggregateFields', count: number } | null | undefined } }> };
...
export type ClientUpdatesSubscription = { __typename?: 'subscription_root', clientById?: { __typename?: 'clients', active?: boolean | null | undefined, contactPerson?: string | null | undefined, createdAt?: string | null | undefined, updatedAt?: string | null | undefined, contactEmail?: string | null | undefined, contactPhone?: string | null | undefined, id: string, name: string, payrolls: Array<{ __typename?: 'payrolls', id: string, name: string, status: string, employeeCount?: number | null | undefined, createdAt?: string | null | undefined, updatedAt?: string | null | undefined, supersededDate?: string | null | undefined, primaryConsultant?: { __typename?: 'users', id: string, name: string } | null | undefined, manager?: { __typename?: 'users', id: string, name: string } | null | undefined, payrollCycle: { __typename?: 'payrollCycles', id: string, name: string } }> } | null | undefined };
...
export type ClientStatusUpdatesSubscription = { __typename?: 'subscription_root', clientById?: { __typename?: 'clients', id: string, name: string, active?: boolean | null | undefined, updatedAt?: string | null | undefined } | null | undefined };
...
export type ClientPayrollUpdatesSubscription = { __typename?: 'subscription_root', payrolls: Array<{ __typename?: 'payrolls', id: string, name: string, status: string, updatedAt?: string | null | undefined }> };

export type ActiveClientsCountSubscriptionVariables = Exact<{ [key: string]: never; }>;


export type ActiveClientsCountSubscription = { __typename?: 'subscription_root', clientsAggregate: { __typename?: 'clientsAggregate', aggregate?: { __typename?: 'clientsAggregateFields', count: number } | null | undefined } };

export type ClientDashboardUpdatesSubscriptionVariables = Exact<{ [key: string]: never; }>;


export type ClientDashboardUpdatesSubscription = { __typename?: 'subscription_root', clients: Array<{ __typename?: 'clients', id: string, name: string, active?: boolean | null | undefined, activePayrolls: { __typename?: 'payrollsAggregate', aggregate?: { __typename?: 'payrollsAggregateFields', count: number } | null | undefined } }> };
...
export type ClientMetricsUpdatesSubscription = { __typename?: 'subscription_root', clientById?: { __typename?: 'clients', id: string, name: string, active?: boolean | null | undefined, totalPayrolls: { __typename?: 'payrollsAggregate', aggregate?: { __typename?: 'payrollsAggregateFields', count: number } | null | undefined }, activePayrolls: { __typename?: 'payrollsAggregate', aggregate?: { __typename?: 'payrollsAggregateFields', count: number } | null | undefined }, recentPayrolls: Array<{ __typename?: 'payrolls', id: string, name: string, status: string, updatedAt?: string | null | undefined }> } | null | undefined };
...
export type ActivateClientMutationFn = Apollo.MutationFunction<ActivateClientMutation, ActivateClientMutationVariables>;
 ...
 * });
 */
export function useActivateClientMutation(baseOptions?: Apollo.MutationHookOptions<ActivateClientMutation, ActivateClientMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<ActivateClientMutation, ActivateClientMutationVariables>(ActivateClientDocument, options);
      }
export type ActivateClientMutationHookResult = ReturnType<typeof useActivateClientMutation>;
export type ActivateClientMutationResult = Apollo.MutationResult<ActivateClientMutation>;
export type ActivateClientMutationOptions = Apollo.BaseMutationOptions<ActivateClientMutation, ActivateClientMutationVariables>;
...
export type BulkUpdateClientStatusMutationFn = Apollo.MutationFunction<BulkUpdateClientStatusMutation, BulkUpdateClientStatusMutationVariables>;

/**
 * __useBulkUpdateClientStatusMutation__
 *
 * To run a mutation, you first call `useBulkUpdateClientStatusMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useBulkUpdateClientStatusMutation` returns a tuple that includes:
 * - A mutate function that you can call at any time to execute the mutation
 * - An object with fields that represent the current status of the mutation's execution
 *
 * @param baseOptions options that will be passed into the mutation, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options-2;
 *
 * @example
 * const [bulkUpdateClientStatusMutation, { data, loading, error }] = useBulkUpdateClientStatusMutation({
 *   variables: {
 ...
 * });
 */
export function useBulkUpdateClientStatusMutation(baseOptions?: Apollo.MutationHookOptions<BulkUpdateClientStatusMutation, BulkUpdateClientStatusMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<BulkUpdateClientStatusMutation, BulkUpdateClientStatusMutationVariables>(BulkUpdateClientStatusDocument, options);
      }
export type BulkUpdateClientStatusMutationHookResult = ReturnType<typeof useBulkUpdateClientStatusMutation>;
export type BulkUpdateClientStatusMutationResult = Apollo.MutationResult<BulkUpdateClientStatusMutation>;
export type BulkUpdateClientStatusMutationOptions = Apollo.BaseMutationOptions<BulkUpdateClientStatusMutation, BulkUpdateClientStatusMutationVariables>;
...
/**
 * __useGetClientsSimpleQuery__
 *
 * To run a query within a React component, call `useGetClientsSimpleQuery` and pass it any options that fit your needs.
 * When your component renders, `useGetClientsSimpleQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useGetClientsSimpleQuery({
 *   variables: {
 *   },
 * });
 */
export function useGetClientsSimpleQuery(baseOptions?: Apollo.QueryHookOptions<GetClientsSimpleQuery, GetClientsSimpleQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GetClientsSimpleQuery, GetClientsSimpleQueryVariables>(GetClientsSimpleDocument, options);
      }
export function useGetClientsSimpleLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetClientsSimpleQuery, GetClientsSimpleQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GetClientsSimpleQuery, GetClientsSimpleQueryVariables>(GetClientsSimpleDocument, options);
        }
export function useGetClientsSimpleSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<GetClientsSimpleQuery, GetClientsSimpleQueryVariables>) {
          const options = baseOptions === Apollo.skipToken ? baseOptions : {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<GetClientsSimpleQuery, GetClientsSimpleQueryVariables>(GetClientsSimpleDocument, options);
        }
export type GetClientsSimpleQueryHookResult = ReturnType<typeof useGetClientsSimpleQuery>;
export type GetClientsSimpleLazyQueryHookResult = ReturnType<typeof useGetClientsSimpleLazyQuery>;
export type GetClientsSimpleSuspenseQueryHookResult = ReturnType<typeof useGetClientsSimpleSuspenseQuery>;
export type GetClientsSimpleQueryResult = Apollo.QueryResult<GetClientsSimpleQuery, GetClientsSimpleQueryVariables>;
...
/**
 * __useGetClientsWithContactQuery__
 *
 * To run a query within a React component, call `useGetClientsWithContactQuery` and pass it any options that fit your needs.
 * When your component renders, `useGetClientsWithContactQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useGetClientsWithContactQuery({
 *   variables: {
 *   },
 * });
 */
export function useGetClientsWithContactQuery(baseOptions?: Apollo.QueryHookOptions<GetClientsWithContactQuery, GetClientsWithContactQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GetClientsWithContactQuery, GetClientsWithContactQueryVariables>(GetClientsWithContactDocument, options);
      }
export function useGetClientsWithContactLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetClientsWithContactQuery, GetClientsWithContactQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GetClientsWithContactQuery, GetClientsWithContactQueryVariables>(GetClientsWithContactDocument, options);
        }
export function useGetClientsWithContactSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<GetClientsWithContactQuery, GetClientsWithContactQueryVariables>) {
          const options = baseOptions === Apollo.skipToken ? baseOptions : {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<GetClientsWithContactQuery, GetClientsWithContactQueryVariables>(GetClientsWithContactDocument, options);
        }
export type GetClientsWithContactQueryHookResult = ReturnType<typeof useGetClientsWithContactQuery>;
export type GetClientsWithContactLazyQueryHookResult = ReturnType<typeof useGetClientsWithContactLazyQuery>;
export type GetClientsWithContactSuspenseQueryHookResult = ReturnType<typeof useGetClientsWithContactSuspenseQuery>;
export type GetClientsWithContactQueryResult = Apollo.QueryResult<GetClientsWithContactQuery, GetClientsWithContactQueryVariables>;
...
/**
 * __useClientsGetClientByIdQuery__
 *
 * To run a query within a React component, call `useClientsGetClientByIdQuery` and pass it any options that fit your needs.
 * When your component renders, `useClientsGetClientByIdQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useClientsGetClientByIdQuery({
 *   variables: {
 *      id: // value for 'id'
 *   },
 * });
 */
export function useClientsGetClientByIdQuery(baseOptions: Apollo.QueryHookOptions<ClientsGetClientByIdQuery, ClientsGetClientByIdQueryVariables> & ({ variables: ClientsGetClientByIdQueryVariables; skip?: boolean; } | { skip: boolean; }) ) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<ClientsGetClientByIdQuery, ClientsGetClientByIdQueryVariables>(ClientsGetClientByIdDocument, options);
      }
export function useClientsGetClientByIdLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<ClientsGetClientByIdQuery, ClientsGetClientByIdQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<ClientsGetClientByIdQuery, ClientsGetClientByIdQueryVariables>(ClientsGetClientByIdDocument, options);
        }
export function useClientsGetClientByIdSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<ClientsGetClientByIdQuery, ClientsGetClientByIdQueryVariables>) {
          const options = baseOptions === Apollo.skipToken ? baseOptions : {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<ClientsGetClientByIdQuery, ClientsGetClientByIdQueryVariables>(ClientsGetClientByIdDocument, options);
        }
export type ClientsGetClientByIdQueryHookResult = ReturnType<typeof useClientsGetClientByIdQuery>;
export type ClientsGetClientByIdLazyQueryHookResult = ReturnType<typeof useClientsGetClientByIdLazyQuery>;
export type ClientsGetClientByIdSuspenseQueryHookResult = ReturnType<typeof useClientsGetClientByIdSuspenseQuery>;
export type ClientsGetClientByIdQueryResult = Apollo.QueryResult<ClientsGetClientByIdQuery, ClientsGetClientByIdQueryVariables>;
...
/**
 * __useGetClientBasicByIdQuery__
 *
 * To run a query within a React component, call `useGetClientBasicByIdQuery` and pass it any options that fit your needs.
 * When your component renders, `useGetClientBasicByIdQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useGetClientBasicByIdQuery({
 *   variables: {
 *      id: // value for 'id'
 *   },
 * });
 */
export function useGetClientBasicByIdQuery(baseOptions: Apollo.QueryHookOptions<GetClientBasicByIdQuery, GetClientBasicByIdQueryVariables> & ({ variables: GetClientBasicByIdQueryVariables; skip?: boolean; } | { skip: boolean; }) ) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GetClientBasicByIdQuery, GetClientBasicByIdQueryVariables>(GetClientBasicByIdDocument, options);
      }
export function useGetClientBasicByIdLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetClientBasicByIdQuery, GetClientBasicByIdQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GetClientBasicByIdQuery, GetClientBasicByIdQueryVariables>(GetClientBasicByIdDocument, options);
        }
export function useGetClientBasicByIdSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<GetClientBasicByIdQuery, GetClientBasicByIdQueryVariables>) {
          const options = baseOptions === Apollo.skipToken ? baseOptions : {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<GetClientBasicByIdQuery, GetClientBasicByIdQueryVariables>(GetClientBasicByIdDocument, options);
        }
export type GetClientBasicByIdQueryHookResult = ReturnType<typeof useGetClientBasicByIdQuery>;
export type GetClientBasicByIdLazyQueryHookResult = ReturnType<typeof useGetClientBasicByIdLazyQuery>;
export type GetClientBasicByIdSuspenseQueryHookResult = ReturnType<typeof useGetClientBasicByIdSuspenseQuery>;
export type GetClientBasicByIdQueryResult = Apollo.QueryResult<GetClientBasicByIdQuery, GetClientBasicByIdQueryVariables>;
...
/**
 * __useGetActiveClientsQuery__
 *
 * To run a query within a React component, call `useGetActiveClientsQuery` and pass it any options that fit your needs.
 * When your component renders, `useGetActiveClientsQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useGetActiveClientsQuery({
 *   variables: {
 *   },
 * });
 */
export function useGetActiveClientsQuery(baseOptions?: Apollo.QueryHookOptions<GetActiveClientsQuery, GetActiveClientsQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GetActiveClientsQuery, GetActiveClientsQueryVariables>(GetActiveClientsDocument, options);
      }
export function useGetActiveClientsLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetActiveClientsQuery, GetActiveClientsQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GetActiveClientsQuery, GetActiveClientsQueryVariables>(GetActiveClientsDocument, options);
        }
export function useGetActiveClientsSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<GetActiveClientsQuery, GetActiveClientsQueryVariables>) {
          const options = baseOptions === Apollo.skipToken ? baseOptions : {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<GetActiveClientsQuery, GetActiveClientsQueryVariables>(GetActiveClientsDocument, options);
        }
export type GetActiveClientsQueryHookResult = ReturnType<typeof useGetActiveClientsQuery>;
export type GetActiveClientsLazyQueryHookResult = ReturnType<typeof useGetActiveClientsLazyQuery>;
export type GetActiveClientsSuspenseQueryHookResult = ReturnType<typeof useGetActiveClientsSuspenseQuery>;
export type GetActiveClientsQueryResult = Apollo.QueryResult<GetActiveClientsQuery, GetActiveClientsQueryVariables>;
...
/**
 * __useGetClientsForBillingQuery__
 *
 * To run a query within a React component, call `useGetClientsForBillingQuery` and pass it any options that fit your needs.
 * When your component renders, `useGetClientsForBillingQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useGetClientsForBillingQuery({
 *   variables: {
 *   },
 * });
 */
export function useGetClientsForBillingQuery(baseOptions?: Apollo.QueryHookOptions<GetClientsForBillingQuery, GetClientsForBillingQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GetClientsForBillingQuery, GetClientsForBillingQueryVariables>(GetClientsForBillingDocument, options);
      }
export function useGetClientsForBillingLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetClientsForBillingQuery, GetClientsForBillingQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GetClientsForBillingQuery, GetClientsForBillingQueryVariables>(GetClientsForBillingDocument, options);
        }
export function useGetClientsForBillingSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<GetClientsForBillingQuery, GetClientsForBillingQueryVariables>) {
          const options = baseOptions === Apollo.skipToken ? baseOptions : {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<GetClientsForBillingQuery, GetClientsForBillingQueryVariables>(GetClientsForBillingDocument, options);
        }
export type GetClientsForBillingQueryHookResult = ReturnType<typeof useGetClientsForBillingQuery>;
export type GetClientsForBillingLazyQueryHookResult = ReturnType<typeof useGetClientsForBillingLazyQuery>;
export type GetClientsForBillingSuspenseQueryHookResult = ReturnType<typeof useGetClientsForBillingSuspenseQuery>;
export type GetClientsForBillingQueryResult = Apollo.QueryResult<GetClientsForBillingQuery, GetClientsForBillingQueryVariables>;
...
/**
 * __useGetClientsForAuditQuery__
 *
 * To run a query within a React component, call `useGetClientsForAuditQuery` and pass it any options that fit your needs.
 * When your component renders, `useGetClientsForAuditQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useGetClientsForAuditQuery({
 *   variables: {
 *   },
 * });
 */
export function useGetClientsForAuditQuery(baseOptions?: Apollo.QueryHookOptions<GetClientsForAuditQuery, GetClientsForAuditQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GetClientsForAuditQuery, GetClientsForAuditQueryVariables>(GetClientsForAuditDocument, options);
      }
export function useGetClientsForAuditLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetClientsForAuditQuery, GetClientsForAuditQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GetClientsForAuditQuery, GetClientsForAuditQueryVariables>(GetClientsForAuditDocument, options);
        }
export function useGetClientsForAuditSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<GetClientsForAuditQuery, GetClientsForAuditQueryVariables>) {
          const options = baseOptions === Apollo.skipToken ? baseOptions : {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<GetClientsForAuditQuery, GetClientsForAuditQueryVariables>(GetClientsForAuditDocument, options);
        }
export type GetClientsForAuditQueryHookResult = ReturnType<typeof useGetClientsForAuditQuery>;
export type GetClientsForAuditLazyQueryHookResult = ReturnType<typeof useGetClientsForAuditLazyQuery>;
export type GetClientsForAuditSuspenseQueryHookResult = ReturnType<typeof useGetClientsForAuditSuspenseQuery>;
export type GetClientsForAuditQueryResult = Apollo.QueryResult<GetClientsForAuditQuery, GetClientsForAuditQueryVariables>;
...
export function useGetClientStatsSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<GetClientStatsQuery, GetClientStatsQueryVariables>) {
          const options = baseOptions === Apollo.skipToken ? baseOptions : {...defaultOptions, ...baseOptions}
...
/**
 * __useGetClientsPaginatedQuery__
 *
 * To run a query within a React component, call `useGetClientsPaginatedQuery` and pass it any options that fit your needs.
 * When your component renders, `useGetClientsPaginatedQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useGetClientsPaginatedQuery({
 *   variables: {
 ...
 * });
 */
export function useGetClientsPaginatedQuery(baseOptions?: Apollo.QueryHookOptions<GetClientsPaginatedQuery, GetClientsPaginatedQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GetClientsPaginatedQuery, GetClientsPaginatedQueryVariables>(GetClientsPaginatedDocument, options);
      }
export function useGetClientsPaginatedLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetClientsPaginatedQuery, GetClientsPaginatedQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GetClientsPaginatedQuery, GetClientsPaginatedQueryVariables>(GetClientsPaginatedDocument, options);
        }
export function useGetClientsPaginatedSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<GetClientsPaginatedQuery, GetClientsPaginatedQueryVariables>) {
          const options = baseOptions === Apollo.skipToken ? baseOptions : {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<GetClientsPaginatedQuery, GetClientsPaginatedQueryVariables>(GetClientsPaginatedDocument, options);
        }
export type GetClientsPaginatedQueryHookResult = ReturnType<typeof useGetClientsPaginatedQuery>;
export type GetClientsPaginatedLazyQueryHookResult = ReturnType<typeof useGetClientsPaginatedLazyQuery>;
export type GetClientsPaginatedSuspenseQueryHookResult = ReturnType<typeof useGetClientsPaginatedSuspenseQuery>;
export type GetClientsPaginatedQueryResult = Apollo.QueryResult<GetClientsPaginatedQuery, GetClientsPaginatedQueryVariables>;
...
/**
 * __useGetAllClientsPaginatedQuery__
 *
 * To run a query within a React component, call `useGetAllClientsPaginatedQuery` and pass it any options that fit your needs.
 * When your component renders, `useGetAllClientsPaginatedQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useGetAllClientsPaginatedQuery({
 *   variables: {
 *      limit: // value for 'limit'
 *      offset: // value for 'offset'
 *      where: // value for 'where'
 ...
 * });
 */
export function useGetAllClientsPaginatedQuery(baseOptions?: Apollo.QueryHookOptions<GetAllClientsPaginatedQuery, GetAllClientsPaginatedQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GetAllClientsPaginatedQuery, GetAllClientsPaginatedQueryVariables>(GetAllClientsPaginatedDocument, options);
      }
export function useGetAllClientsPaginatedLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetAllClientsPaginatedQuery, GetAllClientsPaginatedQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GetAllClientsPaginatedQuery, GetAllClientsPaginatedQueryVariables>(GetAllClientsPaginatedDocument, options);
        }
export function useGetAllClientsPaginatedSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<GetAllClientsPaginatedQuery, GetAllClientsPaginatedQueryVariables>) {
          const options = baseOptions === Apollo.skipToken ? baseOptions : {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<GetAllClientsPaginatedQuery, GetAllClientsPaginatedQueryVariables>(GetAllClientsPaginatedDocument, options);
        }
export type GetAllClientsPaginatedQueryHookResult = ReturnType<typeof useGetAllClientsPaginatedQuery>;
export type GetAllClientsPaginatedLazyQueryHookResult = ReturnType<typeof useGetAllClientsPaginatedLazyQuery>;
export type GetAllClientsPaginatedSuspenseQueryHookResult = ReturnType<typeof useGetAllClientsPaginatedSuspenseQuery>;
export type GetAllClientsPaginatedQueryResult = Apollo.QueryResult<GetAllClientsPaginatedQuery, GetAllClientsPaginatedQueryVariables>;
...
/**
 * __useSearchClientsPaginatedQuery__
 *
 * To run a query within a React component, call `useSearchClientsPaginatedQuery` and pass it any options that fit your needs.
 * When your component renders, `useSearchClientsPaginatedQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useSearchClientsPaginatedQuery({
 *   variables: {
 *      searchTerm: // value for 'searchTerm'
 *      limit: // value for 'limit'
 *      offset: // value for 'offset'
 ...
 * });
 */
export function useSearchClientsPaginatedQuery(baseOptions: Apollo.QueryHookOptions<SearchClientsPaginatedQuery, SearchClientsPaginatedQueryVariables> & ({ variables: SearchClientsPaginatedQueryVariables; skip?: boolean; } | { skip: boolean; }) ) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<SearchClientsPaginatedQuery, SearchClientsPaginatedQueryVariables>(SearchClientsPaginatedDocument, options);
      }
export function useSearchClientsPaginatedLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<SearchClientsPaginatedQuery, SearchClientsPaginatedQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<SearchClientsPaginatedQuery, SearchClientsPaginatedQueryVariables>(SearchClientsPaginatedDocument, options);
        }
export function useSearchClientsPaginatedSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<SearchClientsPaginatedQuery, SearchClientsPaginatedQueryVariables>) {
          const options = baseOptions === Apollo.skipToken ? baseOptions : {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<SearchClientsPaginatedQuery, SearchClientsPaginatedQueryVariables>(SearchClientsPaginatedDocument, options);
        }
export type SearchClientsPaginatedQueryHookResult = ReturnType<typeof useSearchClientsPaginatedQuery>;
export type SearchClientsPaginatedLazyQueryHookResult = ReturnType<typeof useSearchClientsPaginatedLazyQuery>;
export type SearchClientsPaginatedSuspenseQueryHookResult = ReturnType<typeof useSearchClientsPaginatedSuspenseQuery>;
export type SearchClientsPaginatedQueryResult = Apollo.QueryResult<SearchClientsPaginatedQuery, SearchClientsPaginatedQueryVariables>;
...
/**
 * __useGetInactiveClientsPaginatedQuery__
 *
 * To run a query within a React component, call `useGetInactiveClientsPaginatedQuery` and pass it any options that fit your needs.
 * When your component renders, `useGetInactiveClientsPaginatedQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useGetInactiveClientsPaginatedQuery({
 *   variables: {
 *      limit: // value for 'limit'
 *      offset: // value for 'offset'
 *   },
 * });
 */
export function useGetInactiveClientsPaginatedQuery(baseOptions?: Apollo.QueryHookOptions<GetInactiveClientsPaginatedQuery, GetInactiveClientsPaginatedQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GetInactiveClientsPaginatedQuery, GetInactiveClientsPaginatedQueryVariables>(GetInactiveClientsPaginatedDocument, options);
      }
export function useGetInactiveClientsPaginatedLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetInactiveClientsPaginatedQuery, GetInactiveClientsPaginatedQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GetInactiveClientsPaginatedQuery, GetInactiveClientsPaginatedQueryVariables>(GetInactiveClientsPaginatedDocument, options);
        }
export function useGetInactiveClientsPaginatedSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<GetInactiveClientsPaginatedQuery, GetInactiveClientsPaginatedQueryVariables>) {
          const options = baseOptions === Apollo.skipToken ? baseOptions : {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<GetInactiveClientsPaginatedQuery, GetInactiveClientsPaginatedQueryVariables>(GetInactiveClientsPaginatedDocument, options);
        }
export type GetInactiveClientsPaginatedQueryHookResult = ReturnType<typeof useGetInactiveClientsPaginatedQuery>;
export type GetInactiveClientsPaginatedLazyQueryHookResult = ReturnType<typeof useGetInactiveClientsPaginatedLazyQuery>;
export type GetInactiveClientsPaginatedSuspenseQueryHookResult = ReturnType<typeof useGetInactiveClientsPaginatedSuspenseQuery>;
export type GetInactiveClientsPaginatedQueryResult = Apollo.QueryResult<GetInactiveClientsPaginatedQuery, GetInactiveClientsPaginatedQueryVariables>;
...
/**
 * __useGetClientsQuickListQuery__
 *
 * To run a query within a React component, call `useGetClientsQuickListQuery` and pass it any options that fit your needs.
 * When your component renders, `useGetClientsQuickListQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useGetClientsQuickListQuery({
 *   variables: {
 *   },
 * });
 */
export function useGetClientsQuickListQuery(baseOptions?: Apollo.QueryHookOptions<GetClientsQuickListQuery, GetClientsQuickListQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GetClientsQuickListQuery, GetClientsQuickListQueryVariables>(GetClientsQuickListDocument, options);
      }
export function useGetClientsQuickListLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetClientsQuickListQuery, GetClientsQuickListQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GetClientsQuickListQuery, GetClientsQuickListQueryVariables>(GetClientsQuickListDocument, options);
        }
export function useGetClientsQuickListSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<GetClientsQuickListQuery, GetClientsQuickListQueryVariables>) {
          const options = baseOptions === Apollo.skipToken ? baseOptions : {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<GetClientsQuickListQuery, GetClientsQuickListQueryVariables>(GetClientsQuickListDocument, options);
        }
export type GetClientsQuickListQueryHookResult = ReturnType<typeof useGetClientsQuickListQuery>;
export type GetClientsQuickListLazyQueryHookResult = ReturnType<typeof useGetClientsQuickListLazyQuery>;
export type GetClientsQuickListSuspenseQueryHookResult = ReturnType<typeof useGetClientsQuickListSuspenseQuery>;
export type GetClientsQuickListQueryResult = Apollo.QueryResult<GetClientsQuickListQuery, GetClientsQuickListQueryVariables>;
...
/**
 * __useGetClientCardQuery__
 *
 * To run a query within a React component, call `useGetClientCardQuery` and pass it any options that fit your needs.
 * When your component renders, `useGetClientCardQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useGetClientCardQuery({
 *   variables: {
 *      id: // value for 'id'
 *   },
 * });
 */
export function useGetClientCardQuery(baseOptions: Apollo.QueryHookOptions<GetClientCardQuery, GetClientCardQueryVariables> & ({ variables: GetClientCardQueryVariables; skip?: boolean; } | { skip: boolean; }) ) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GetClientCardQuery, GetClientCardQueryVariables>(GetClientCardDocument, options);
      }
export function useGetClientCardLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetClientCardQuery, GetClientCardQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GetClientCardQuery, GetClientCardQueryVariables>(GetClientCardDocument, options);
        }
export function useGetClientCardSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<GetClientCardQuery, GetClientCardQueryVariables>) {
          const options = baseOptions === Apollo.skipToken ? baseOptions : {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<GetClientCardQuery, GetClientCardQueryVariables>(GetClientCardDocument, options);
        }
export type GetClientCardQueryHookResult = ReturnType<typeof useGetClientCardQuery>;
export type GetClientCardLazyQueryHookResult = ReturnType<typeof useGetClientCardLazyQuery>;
export type GetClientCardSuspenseQueryHookResult = ReturnType<typeof useGetClientCardSuspenseQuery>;
export type GetClientCardQueryResult = Apollo.QueryResult<GetClientCardQuery, GetClientCardQueryVariables>;
...
/**
 * __useClientsGetAllForDeveloperQuery__
 *
 * To run a query within a React component, call `useClientsGetAllForDeveloperQuery` and pass it any options that fit your needs.
 * When your component renders, `useClientsGetAllForDeveloperQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useClientsGetAllForDeveloperQuery({
 *   variables: {
 *   },
 * });
 */
export function useClientsGetAllForDeveloperQuery(baseOptions?: Apollo.QueryHookOptions<ClientsGetAllForDeveloperQuery, ClientsGetAllForDeveloperQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<ClientsGetAllForDeveloperQuery, ClientsGetAllForDeveloperQueryVariables>(ClientsGetAllForDeveloperDocument, options);
      }
export function useClientsGetAllForDeveloperLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<ClientsGetAllForDeveloperQuery, ClientsGetAllForDeveloperQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<ClientsGetAllForDeveloperQuery, ClientsGetAllForDeveloperQueryVariables>(ClientsGetAllForDeveloperDocument, options);
        }
export function useClientsGetAllForDeveloperSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<ClientsGetAllForDeveloperQuery, ClientsGetAllForDeveloperQueryVariables>) {
          const options = baseOptions === Apollo.skipToken ? baseOptions : {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<ClientsGetAllForDeveloperQuery, ClientsGetAllForDeveloperQueryVariables>(ClientsGetAllForDeveloperDocument, options);
        }
export type ClientsGetAllForDeveloperQueryHookResult = ReturnType<typeof useClientsGetAllForDeveloperQuery>;
export type ClientsGetAllForDeveloperLazyQueryHookResult = ReturnType<typeof useClientsGetAllForDeveloperLazyQuery>;
export type ClientsGetAllForDeveloperSuspenseQueryHookResult = ReturnType<typeof useClientsGetAllForDeveloperSuspenseQuery>;
export type ClientsGetAllForDeveloperQueryResult = Apollo.QueryResult<ClientsGetAllForDeveloperQuery, ClientsGetAllForDeveloperQueryVariables>;
export const GetClientOptionsDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"GetClientOptions"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"clients"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"where"},"value":{"kind":"ObjectValue","fields":[{"kind":"ObjectField","name":{"kind":"Name","value":"active"},"value":{"kind":"ObjectValue","fields":[{"kind":"ObjectField","name":{"kind":"Name","value":"_eq"},"value":{"kind":"BooleanValue","value":true}}]}}]}},{"kind":"Argument","name":{"kind":"Name","value":"orderBy"},"value":{"kind":"ObjectValue","fields":[{"kind":"ObjectField","name":{"kind":"Name","value":"name"},"value":{"kind":"EnumValue","value":"ASC"}}]}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"name"}}]}}]}}]} as unknown as DocumentNode;

/**
 * __useGetClientOptionsQuery__
 *
 * To run a query within a React component, call `useGetClientOptionsQuery` and pass it any options that fit your needs.
 * When your component renders, `useGetClientOptionsQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useGetClientOptionsQuery({
 *   variables: {
 *   },
 * });
 */
export function useGetClientOptionsQuery(baseOptions?: Apollo.QueryHookOptions<GetClientOptionsQuery, GetClientOptionsQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GetClientOptionsQuery, GetClientOptionsQueryVariables>(GetClientOptionsDocument, options);
      }
export function useGetClientOptionsLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetClientOptionsQuery, GetClientOptionsQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GetClientOptionsQuery, GetClientOptionsQueryVariables>(GetClientOptionsDocument, options);
        }
export function useGetClientOptionsSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<GetClientOptionsQuery, GetClientOptionsQueryVariables>) {
          const options = baseOptions === Apollo.skipToken ? baseOptions : {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<GetClientOptionsQuery, GetClientOptionsQueryVariables>(GetClientOptionsDocument, options);
        }
export type GetClientOptionsQueryHookResult = ReturnType<typeof useGetClientOptionsQuery>;
export type GetClientOptionsLazyQueryHookResult = ReturnType<typeof useGetClientOptionsLazyQuery>;
export type GetClientOptionsSuspenseQueryHookResult = ReturnType<typeof useGetClientOptionsSuspenseQuery>;
export type GetClientOptionsQueryResult = Apollo.QueryResult<GetClientOptionsQuery, GetClientOptionsQueryVariables>;
...
/**
 * __useGetClientDashboardCardsQuery__
 *
 * To run a query within a React component, call `useGetClientDashboardCardsQuery` and pass it any options that fit your needs.
 * When your component renders, `useGetClientDashboardCardsQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useGetClientDashboardCardsQuery({
 *   variables: {
 *      limit: // value for 'limit'
 *   },
 * });
 */
export function useGetClientDashboardCardsQuery(baseOptions?: Apollo.QueryHookOptions<GetClientDashboardCardsQuery, GetClientDashboardCardsQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GetClientDashboardCardsQuery, GetClientDashboardCardsQueryVariables>(GetClientDashboardCardsDocument, options);
      }
export function useGetClientDashboardCardsLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetClientDashboardCardsQuery, GetClientDashboardCardsQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GetClientDashboardCardsQuery, GetClientDashboardCardsQueryVariables>(GetClientDashboardCardsDocument, options);
        }
export function useGetClientDashboardCardsSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<GetClientDashboardCardsQuery, GetClientDashboardCardsQueryVariables>) {
          const options = baseOptions === Apollo.skipToken ? baseOptions : {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<GetClientDashboardCardsQuery, GetClientDashboardCardsQueryVariables>(GetClientDashboardCardsDocument, options);
        }
export type GetClientDashboardCardsQueryHookResult = ReturnType<typeof useGetClientDashboardCardsQuery>;
export type GetClientDashboardCardsLazyQueryHookResult = ReturnType<typeof useGetClientDashboardCardsLazyQuery>;
export type GetClientDashboardCardsSuspenseQueryHookResult = ReturnType<typeof useGetClientDashboardCardsSuspenseQuery>;
export type GetClientDashboardCardsQueryResult = Apollo.QueryResult<GetClientDashboardCardsQuery, GetClientDashboardCardsQueryVariables>;
...
/**
 * __useGetClientWithActivePayrollsQuery__
 *
 * To run a query within a React component, call `useGetClientWithActivePayrollsQuery` and pass it any options that fit your needs.
 * When your component renders, `useGetClientWithActivePayrollsQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useGetClientWithActivePayrollsQuery({
 *   variables: {
 *      id: // value for 'id'
 *   },
 * });
 */
export function useGetClientWithActivePayrollsQuery(baseOptions: Apollo.QueryHookOptions<GetClientWithActivePayrollsQuery, GetClientWithActivePayrollsQueryVariables> & ({ variables: GetClientWithActivePayrollsQueryVariables; skip?: boolean; } | { skip: boolean; }) ) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GetClientWithActivePayrollsQuery, GetClientWithActivePayrollsQueryVariables>(GetClientWithActivePayrollsDocument, options);
      }
export function useGetClientWithActivePayrollsLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetClientWithActivePayrollsQuery, GetClientWithActivePayrollsQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GetClientWithActivePayrollsQuery, GetClientWithActivePayrollsQueryVariables>(GetClientWithActivePayrollsDocument, options);
        }
export function useGetClientWithActivePayrollsSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<GetClientWithActivePayrollsQuery, GetClientWithActivePayrollsQueryVariables>) {
          const options = baseOptions === Apollo.skipToken ? baseOptions : {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<GetClientWithActivePayrollsQuery, GetClientWithActivePayrollsQueryVariables>(GetClientWithActivePayrollsDocument, options);
        }
export type GetClientWithActivePayrollsQueryHookResult = ReturnType<typeof useGetClientWithActivePayrollsQuery>;
export type GetClientWithActivePayrollsLazyQueryHookResult = ReturnType<typeof useGetClientWithActivePayrollsLazyQuery>;
export type GetClientWithActivePayrollsSuspenseQueryHookResult = ReturnType<typeof useGetClientWithActivePayrollsSuspenseQuery>;
export type GetClientWithActivePayrollsQueryResult = Apollo.QueryResult<GetClientWithActivePayrollsQuery, GetClientWithActivePayrollsQueryVariables>;
...
/**
 * __useGetAllClientsForDeveloperQuery__
 *
 * To run a query within a React component, call `useGetAllClientsForDeveloperQuery` and pass it any options that fit your needs.
 * When your component renders, `useGetAllClientsForDeveloperQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useGetAllClientsForDeveloperQuery({
 *   variables: {
 *   },
 * });
 */
export function useGetAllClientsForDeveloperQuery(baseOptions?: Apollo.QueryHookOptions<GetAllClientsForDeveloperQuery, GetAllClientsForDeveloperQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GetAllClientsForDeveloperQuery, GetAllClientsForDeveloperQueryVariables>(GetAllClientsForDeveloperDocument, options);
      }
export function useGetAllClientsForDeveloperLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetAllClientsForDeveloperQuery, GetAllClientsForDeveloperQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GetAllClientsForDeveloperQuery, GetAllClientsForDeveloperQueryVariables>(GetAllClientsForDeveloperDocument, options);
        }
export function useGetAllClientsForDeveloperSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<GetAllClientsForDeveloperQuery, GetAllClientsForDeveloperQueryVariables>) {
          const options = baseOptions === Apollo.skipToken ? baseOptions : {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<GetAllClientsForDeveloperQuery, GetAllClientsForDeveloperQueryVariables>(GetAllClientsForDeveloperDocument, options);
        }
export type GetAllClientsForDeveloperQueryHookResult = ReturnType<typeof useGetAllClientsForDeveloperQuery>;
export type GetAllClientsForDeveloperLazyQueryHookResult = ReturnType<typeof useGetAllClientsForDeveloperLazyQuery>;
export type GetAllClientsForDeveloperSuspenseQueryHookResult = ReturnType<typeof useGetAllClientsForDeveloperSuspenseQuery>;
export type GetAllClientsForDeveloperQueryResult = Apollo.QueryResult<GetAllClientsForDeveloperQuery, GetAllClientsForDeveloperQueryVariables>;
...
/**
 * __useClientsGetPayrollsDataQuery__
 *
 * To run a query within a React component, call `useClientsGetPayrollsDataQuery` and pass it any options that fit your needs.
 * When your component renders, `useClientsGetPayrollsDataQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useClientsGetPayrollsDataQuery({
 *   variables: {
 *   },
 * });
 */
export function useClientsGetPayrollsDataQuery(baseOptions?: Apollo.QueryHookOptions<ClientsGetPayrollsDataQuery, ClientsGetPayrollsDataQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<ClientsGetPayrollsDataQuery, ClientsGetPayrollsDataQueryVariables>(ClientsGetPayrollsDataDocument, options);
      }
export function useClientsGetPayrollsDataLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<ClientsGetPayrollsDataQuery, ClientsGetPayrollsDataQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<ClientsGetPayrollsDataQuery, ClientsGetPayrollsDataQueryVariables>(ClientsGetPayrollsDataDocument, options);
        }
export function useClientsGetPayrollsDataSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<ClientsGetPayrollsDataQuery, ClientsGetPayrollsDataQueryVariables>) {
          const options = baseOptions === Apollo.skipToken ? baseOptions : {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<ClientsGetPayrollsDataQuery, ClientsGetPayrollsDataQueryVariables>(ClientsGetPayrollsDataDocument, options);
        }
export type ClientsGetPayrollsDataQueryHookResult = ReturnType<typeof useClientsGetPayrollsDataQuery>;
export type ClientsGetPayrollsDataLazyQueryHookResult = ReturnType<typeof useClientsGetPayrollsDataLazyQuery>;
export type ClientsGetPayrollsDataSuspenseQueryHookResult = ReturnType<typeof useClientsGetPayrollsDataSuspenseQuery>;
export type ClientsGetPayrollsDataQueryResult = Apollo.QueryResult<ClientsGetPayrollsDataQuery, ClientsGetPayrollsDataQueryVariables>;
...
/**
 * __useClientUpdatesSubscription__
 *
 * To run a query within a React component, call `useClientUpdatesSubscription` and pass it any options that fit your needs.
 * When your component renders, `useClientUpdatesSubscription` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the subscription, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useClientUpdatesSubscription({
 *   variables: {
 *      id: // value for 'id'
 *   },
 * });
 */
export function useClientUpdatesSubscription(baseOptions: Apollo.SubscriptionHookOptions<ClientUpdatesSubscription, ClientUpdatesSubscriptionVariables> & ({ variables: ClientUpdatesSubscriptionVariables; skip?: boolean; } | { skip: boolean; }) ) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useSubscription<ClientUpdatesSubscription, ClientUpdatesSubscriptionVariables>(ClientUpdatesDocument, options);
      }
export type ClientUpdatesSubscriptionHookResult = ReturnType<typeof useClientUpdatesSubscription>;
export type ClientUpdatesSubscriptionResult = Apollo.SubscriptionResult<ClientUpdatesSubscription>;
...
/**
 * __useClientListUpdatesSubscription__
 *
 * To run a query within a React component, call `useClientListUpdatesSubscription` and pass it any options that fit your needs.
 * When your component renders, `useClientListUpdatesSubscription` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the subscription, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useClientListUpdatesSubscription({
 *   variables: {
 *   },
 * });
 */
export function useClientListUpdatesSubscription(baseOptions?: Apollo.SubscriptionHookOptions<ClientListUpdatesSubscription, ClientListUpdatesSubscriptionVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useSubscription<ClientListUpdatesSubscription, ClientListUpdatesSubscriptionVariables>(ClientListUpdatesDocument, options);
      }
export type ClientListUpdatesSubscriptionHookResult = ReturnType<typeof useClientListUpdatesSubscription>;
export type ClientListUpdatesSubscriptionResult = Apollo.SubscriptionResult<ClientListUpdatesSubscription>;
...
/**
 * __useClientStatusUpdatesSubscription__
 *
 * To run a query within a React component, call `useClientStatusUpdatesSubscription` and pass it any options that fit your needs.
 * When your component renders, `useClientStatusUpdatesSubscription` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the subscription, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useClientStatusUpdatesSubscription({
 *   variables: {
 *      id: // value for 'id'
 *   },
 * });
 */
export function useClientStatusUpdatesSubscription(baseOptions: Apollo.SubscriptionHookOptions<ClientStatusUpdatesSubscription, ClientStatusUpdatesSubscriptionVariables> & ({ variables: ClientStatusUpdatesSubscriptionVariables; skip?: boolean; } | { skip: boolean; }) ) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useSubscription<ClientStatusUpdatesSubscription, ClientStatusUpdatesSubscriptionVariables>(ClientStatusUpdatesDocument, options);
      }
export type ClientStatusUpdatesSubscriptionHookResult = ReturnType<typeof useClientStatusUpdatesSubscription>;
export type ClientStatusUpdatesSubscriptionResult = Apollo.SubscriptionResult<ClientStatusUpdatesSubscription>;
...
/**
 * __useClientPayrollUpdatesSubscription__
 *
 * To run a query within a React component, call `useClientPayrollUpdatesSubscription` and pass it any options that fit your needs.
 * When your component renders, `useClientPayrollUpdatesSubscription` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the subscription, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useClientPayrollUpdatesSubscription({
 *   variables: {
 *      clientId: // value for 'clientId'
 *   },
 * });
 */
export function useClientPayrollUpdatesSubscription(baseOptions: Apollo.SubscriptionHookOptions<ClientPayrollUpdatesSubscription, ClientPayrollUpdatesSubscriptionVariables> & ({ variables: ClientPayrollUpdatesSubscriptionVariables; skip?: boolean; } | { skip: boolean; }) ) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useSubscription<ClientPayrollUpdatesSubscription, ClientPayrollUpdatesSubscriptionVariables>(ClientPayrollUpdatesDocument, options);
      }
export type ClientPayrollUpdatesSubscriptionHookResult = ReturnType<typeof useClientPayrollUpdatesSubscription>;
export type ClientPayrollUpdatesSubscriptionResult = Apollo.SubscriptionResult<ClientPayrollUpdatesSubscription>;
...
/**
 * __useActiveClientsCountSubscription__
 *
 * To run a query within a React component, call `useActiveClientsCountSubscription` and pass it any options that fit your needs.
 * When your component renders, `useActiveClientsCountSubscription` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the subscription, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useActiveClientsCountSubscription({
 *   variables: {
 *   },
 * });
 */
export function useActiveClientsCountSubscription(baseOptions?: Apollo.SubscriptionHookOptions<ActiveClientsCountSubscription, ActiveClientsCountSubscriptionVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useSubscription<ActiveClientsCountSubscription, ActiveClientsCountSubscriptionVariables>(ActiveClientsCountDocument, options);
      }
export type ActiveClientsCountSubscriptionHookResult = ReturnType<typeof useActiveClientsCountSubscription>;
export type ActiveClientsCountSubscriptionResult = Apollo.SubscriptionResult<ActiveClientsCountSubscription>;
...
/**
 * __useClientDashboardUpdatesSubscription__
 *
 * To run a query within a React component, call `useClientDashboardUpdatesSubscription` and pass it any options that fit your needs.
 * When your component renders, `useClientDashboardUpdatesSubscription` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the subscription, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useClientDashboardUpdatesSubscription({
 *   variables: {
 *   },
 * });
 */
export function useClientDashboardUpdatesSubscription(baseOptions?: Apollo.SubscriptionHookOptions<ClientDashboardUpdatesSubscription, ClientDashboardUpdatesSubscriptionVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useSubscription<ClientDashboardUpdatesSubscription, ClientDashboardUpdatesSubscriptionVariables>(ClientDashboardUpdatesDocument, options);
      }
export type ClientDashboardUpdatesSubscriptionHookResult = ReturnType<typeof useClientDashboardUpdatesSubscription>;
export type ClientDashboardUpdatesSubscriptionResult = Apollo.SubscriptionResult<ClientDashboardUpdatesSubscription>;
...
/**
 * __useClientMetricsUpdatesSubscription__
 *
 * To run a query within a React component, call `useClientMetricsUpdatesSubscription` and pass it any options that fit your needs.
 * When your component renders, `useClientMetricsUpdatesSubscription` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the subscription, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useClientMetricsUpdatesSubscription({
 *   variables: {
 *      id: // value for 'id'
 *   },
 * });
 */
export function useClientMetricsUpdatesSubscription(baseOptions: Apollo.SubscriptionHookOptions<ClientMetricsUpdatesSubscription, ClientMetricsUpdatesSubscriptionVariables> & ({ variables: ClientMetricsUpdatesSubscriptionVariables; skip?: boolean; } | { skip: boolean; }) ) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useSubscription<ClientMetricsUpdatesSubscription, ClientMetricsUpdatesSubscriptionVariables>(ClientMetricsUpdatesDocument, options);
      }
export type ClientMetricsUpdatesSubscriptionHookResult = ReturnType<typeof useClientMetricsUpdatesSubscription>;
export type ClientMetricsUpdatesSubscriptionResult = Apollo.SubscriptionResult<ClientMetricsUpdatesSubscription>;