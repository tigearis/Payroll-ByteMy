 ...
 * 
 * Generated: 2025-06-24T02:30:55.150Z
...
export type ClientBasicInfoFragment = { __typename: 'clients', id: string, name: string } & { ' $fragmentName'?: 'ClientBasicInfoFragment' };

export type ClientWithContactFragment = (
  { __typename: 'clients', contactEmail: string | null, contactPhone: string | null }
  & { ' $fragmentRefs'?: { 'ClientBasicInfoFragment': ClientBasicInfoFragment } }
) & { ' $fragmentName'?: 'ClientWithContactFragment' };

export type ClientForBillingFragment = { __typename: 'clients', id: string, name: string, billing_contactPerson: string | null, billing_contact_email: string | null } & { ' $fragmentName'?: 'ClientForBillingFragment' };

export type ClientForAuditFragment = { __typename: 'clients', id: string, name: string } & { ' $fragmentName'?: 'ClientForAuditFragment' };

export type ClientWithRelationsFragment = (
  { __typename: 'clients', active: boolean | null, payrolls: Array<{ __typename: 'payrolls', id: string, name: string }>, notes: Array<{ __typename: 'client_external_systems', id: string, system_id: string }> }
  & { ' $fragmentRefs'?: { 'ClientWithContactFragment': ClientWithContactFragment } }
) & { ' $fragmentName'?: 'ClientWithRelationsFragment' };

export type ClientSummaryFragment = { __typename: 'clients', id: string, name: string, active: boolean | null } & { ' $fragmentName'?: 'ClientSummaryFragment' };

export type ClientListItemFragment = (
  { __typename: 'clients', contactEmail: string | null, contactPhone: string | null, payrollCount: { __typename: 'payrolls_aggregate', aggregate: { __typename: 'payrolls_aggregate_fields', count: number } | null } }
  & { ' $fragmentRefs'?: { 'ClientSummaryFragment': ClientSummaryFragment } }
) & { ' $fragmentName'?: 'ClientListItemFragment' };

export type ClientDashboardCardFragment = (
  { __typename: 'clients', activePayrolls: { __typename: 'payrolls_aggregate', aggregate: { __typename: 'payrolls_aggregate_fields', count: number } | null } }
  & { ' $fragmentRefs'?: { 'ClientSummaryFragment': ClientSummaryFragment } }
) & { ' $fragmentName'?: 'ClientDashboardCardFragment' };

export type ClientTableRowFragment = (
  { __typename: 'clients', contactPerson: string | null, updatedAt: string | null }
  & { ' $fragmentRefs'?: { 'ClientListItemFragment': ClientListItemFragment } }
) & { ' $fragmentName'?: 'ClientTableRowFragment' };

export type ClientMinimalFragment = { __typename: 'clients', id: string, name: string } & { ' $fragmentName'?: 'ClientMinimalFragment' };

export type ClientWithMetricsFragment = (
  { __typename: 'clients', totalPayrolls: { __typename: 'payrolls_aggregate', aggregate: { __typename: 'payrolls_aggregate_fields', count: number } | null }, activePayrolls: { __typename: 'payrolls_aggregate', aggregate: { __typename: 'payrolls_aggregate_fields', count: number } | null }, recentPayrolls: Array<{ __typename: 'payrolls', id: string, name: string, status: string, updatedAt: string | null }> }
  & { ' $fragmentRefs'?: { 'ClientSummaryFragment': ClientSummaryFragment } }
) & { ' $fragmentName'?: 'ClientWithMetricsFragment' };
...
export type CreateClientMutation = { __typename: 'mutation_root', insertClient: (
    { __typename: 'clients' }
    & { ' $fragmentRefs'?: { 'ClientWithContactFragment': ClientWithContactFragment } }
  ) | null };
...
export type UpdateClientMutation = { __typename: 'mutation_root', updateClient: (
    { __typename: 'clients' }
    & { ' $fragmentRefs'?: { 'ClientWithContactFragment': ClientWithContactFragment } }
  ) | null };
...
export type UpdateClientStatusMutation = { __typename: 'mutation_root', updateClient: (
    { __typename: 'clients' }
    & { ' $fragmentRefs'?: { 'ClientBasicInfoFragment': ClientBasicInfoFragment } }
  ) | null };
...
export type DeactivateClientMutation = { __typename: 'mutation_root', updateClient: (
    { __typename: 'clients' }
    & { ' $fragmentRefs'?: { 'ClientBasicInfoFragment': ClientBasicInfoFragment } }
  ) | null };
...
export type ActivateClientMutation = { __typename: 'mutation_root', updateClient: (
    { __typename: 'clients' }
    & { ' $fragmentRefs'?: { 'ClientBasicInfoFragment': ClientBasicInfoFragment } }
  ) | null };
...
export type ArchiveClientMutation = { __typename: 'mutation_root', updateClient: { __typename: 'clients', id: string, name: string } | null };
...
export type BulkUpdateClientStatusMutation = { __typename: 'mutation_root', updateClients: { __typename: 'clients_mutation_response', affected_rows: number, returning: Array<(
      { __typename: 'clients' }
      & { ' $fragmentRefs'?: { 'ClientBasicInfoFragment': ClientBasicInfoFragment } }
    )> } | null };
...
export type GetClientsQuery = { __typename: 'query_root', clients: Array<(
    { __typename: 'clients' }
    & { ' $fragmentRefs'?: { 'ClientBasicInfoFragment': ClientBasicInfoFragment } }
  )> };
...
export type GetClientsWithContactQuery = { __typename: 'query_root', clients: Array<(
    { __typename: 'clients' }
    & { ' $fragmentRefs'?: { 'ClientWithContactFragment': ClientWithContactFragment } }
  )> };
...
export type GetClientByIdQuery = { __typename: 'query_root', client: (
    { __typename: 'clients' }
    & { ' $fragmentRefs'?: { 'ClientWithRelationsFragment': ClientWithRelationsFragment } }
  ) | null };
...
export type GetClientBasicByIdQuery = { __typename: 'query_root', client: (
    { __typename: 'clients' }
    & { ' $fragmentRefs'?: { 'ClientBasicInfoFragment': ClientBasicInfoFragment } }
  ) | null };
...
export type GetActiveClientsQuery = { __typename: 'query_root', clients: Array<(
    { __typename: 'clients' }
    & { ' $fragmentRefs'?: { 'ClientBasicInfoFragment': ClientBasicInfoFragment } }
  )> };
...
export type GetClientsForBillingQuery = { __typename: 'query_root', clients: Array<(
    { __typename: 'clients' }
    & { ' $fragmentRefs'?: { 'ClientForBillingFragment': ClientForBillingFragment } }
  )> };
...
export type SearchClientsQuery = { __typename: 'query_root', clients: Array<(
    { __typename: 'clients' }
    & { ' $fragmentRefs'?: { 'ClientWithContactFragment': ClientWithContactFragment } }
  )> };
...
export type GetClientsForAuditQuery = { __typename: 'query_root', clients: Array<(
    { __typename: 'clients' }
    & { ' $fragmentRefs'?: { 'ClientForAuditFragment': ClientForAuditFragment } }
  )> };

export type GetClientStatsQueryVariables = Exact<{ [key: string]: never; }>;


export type GetClientStatsQuery = { __typename: 'query_root', clientsAggregate: { __typename: 'clients_aggregate', aggregate: { __typename: 'clients_aggregate_fields', count: number } | null }, active_clients: { __typename: 'clients_aggregate', aggregate: { __typename: 'clients_aggregate_fields', count: number } | null }, inactive_clients: { __typename: 'clients_aggregate', aggregate: { __typename: 'clients_aggregate_fields', count: number } | null } };
...
export type GetClientsPaginatedQuery = { __typename: 'query_root', clients: Array<(
    { __typename: 'clients' }
    & { ' $fragmentRefs'?: { 'ClientListItemFragment': ClientListItemFragment } }
  )>, clientsAggregate: { __typename: 'clients_aggregate', aggregate: { __typename: 'clients_aggregate_fields', count: number } | null } };
...
export type GetAllClientsPaginatedQuery = { __typename: 'query_root', clients: Array<(
    { __typename: 'clients' }
    & { ' $fragmentRefs'?: { 'ClientTableRowFragment': ClientTableRowFragment } }
  )>, allClientsAggregate: { __typename: 'clients_aggregate', aggregate: { __typename: 'clients_aggregate_fields', count: number } | null } };
...
export type SearchClientsPaginatedQuery = { __typename: 'query_root', clients: Array<(
    { __typename: 'clients' }
    & { ' $fragmentRefs'?: { 'ClientListItemFragment': ClientListItemFragment } }
  )>, searchAggregate: { __typename: 'clients_aggregate', aggregate: { __typename: 'clients_aggregate_fields', count: number } | null } };
...
export type GetInactiveClientsPaginatedQuery = { __typename: 'query_root', clients: Array<(
    { __typename: 'clients' }
    & { ' $fragmentRefs'?: { 'ClientTableRowFragment': ClientTableRowFragment } }
  )>, inactiveAggregate: { __typename: 'clients_aggregate', aggregate: { __typename: 'clients_aggregate_fields', count: number } | null } };

export type GetClientsQuickListQueryVariables = Exact<{ [key: string]: never; }>;


export type GetClientsQuickListQuery = { __typename: 'query_root', clients: Array<(
    { __typename: 'clients' }
    & { ' $fragmentRefs'?: { 'ClientMinimalFragment': ClientMinimalFragment } }
  )> };
...
export type GetClientCardQuery = { __typename: 'query_root', client: (
    { __typename: 'clients', contactEmail: string | null, payrollCount: { __typename: 'payrolls_aggregate', aggregate: { __typename: 'payrolls_aggregate_fields', count: number } | null } }
    & { ' $fragmentRefs'?: { 'ClientSummaryFragment': ClientSummaryFragment } }
  ) | null };
...
export type GetClientDashboardCardsQuery = { __typename: 'query_root', clients: Array<(
    { __typename: 'clients' }
    & { ' $fragmentRefs'?: { 'ClientDashboardCardFragment': ClientDashboardCardFragment } }
  )> };
...
export type GetClientWithActivePayrollsQuery = { __typename: 'query_root', client: (
    { __typename: 'clients', contactEmail: string | null, contactPhone: string | null, contactPerson: string | null, activePayrolls: Array<{ __typename: 'payrolls', id: string, name: string, status: string, primaryConsultant: { __typename: 'users', name: string } | null }> }
    & { ' $fragmentRefs'?: { 'ClientSummaryFragment': ClientSummaryFragment } }
  ) | null };
...
export type ClientUpdatesSubscription = { __typename: 'subscription_root', client: (
    { __typename: 'clients' }
    & { ' $fragmentRefs'?: { 'ClientWithRelationsFragment': ClientWithRelationsFragment } }
  ) | null };
...
export type ClientListUpdatesSubscription = { __typename: 'subscription_root', clients: Array<(
    { __typename: 'clients' }
    & { ' $fragmentRefs'?: { 'ClientBasicInfoFragment': ClientBasicInfoFragment } }
  )> };
...
export type ClientStatusUpdatesSubscription = { __typename: 'subscription_root', client: { __typename: 'clients', id: string, name: string, active: boolean | null, updatedAt: string | null } | null };
...
export type ActiveClientsCountSubscription = { __typename: 'subscription_root', clientsAggregate: { __typename: 'clients_aggregate', aggregate: { __typename: 'clients_aggregate_fields', count: number } | null } };

export type ClientDashboardUpdatesSubscriptionVariables = Exact<{ [key: string]: never; }>;


export type ClientDashboardUpdatesSubscription = { __typename: 'subscription_root', clients: Array<(
    { __typename: 'clients' }
    & { ' $fragmentRefs'?: { 'ClientDashboardCardFragment': ClientDashboardCardFragment } }
  )> };
...
export type ClientMetricsUpdatesSubscription = { __typename: 'subscription_root', client: (
    { __typename: 'clients' }
    & { ' $fragmentRefs'?: { 'ClientWithMetricsFragment': ClientWithMetricsFragment } }
  ) | null };
...
export const GetClientCardDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"GetClientCard"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"id"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"uuid"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"client"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"id"},"value":{"kind":"Variable","name":{"kind":"Name","value":"id"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"FragmentSpread","name":{"kind":"Name","value":"ClientSummary"}},{"kind":"Field","name":{"kind":"Name","value":"contactEmail"}},{"kind":"Field","alias":{"kind":"Name","value":"payrollCount"},"name":{"kind":"Name","value":"payrolls_aggregate"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"where"},"value":{"kind":"ObjectValue","fields":[{"kind":"ObjectField","name":{"kind":"Name","value":"supersededDate"},"value":{"kind":"ObjectValue","fields":[{"kind":"ObjectField","name":{"kind":"Name","value":"_is_null"},"value":{"kind":"BooleanValue","value":true}}]}}]}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"aggregate"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"count"}}]}}]}}]}}]}},{"kind":"FragmentDefinition","name":{"kind":"Name","value":"ClientSummary"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"clients"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"name"}},{"kind":"Field","name":{"kind":"Name","value":"active"}}]}}]} as unknown as DocumentNode<GetClientCardQuery, GetClientCardQueryVariables>;
