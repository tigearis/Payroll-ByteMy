...
export type ClientWithRelationsFragment = (
  { __typename: 'clients', active: boolean | null, contactPerson: string | null, createdAt: string | null, updatedAt: string | null, payrolls: Array<{ __typename: 'payrolls', id: string, name: string, status: string, employeeCount: number | null, createdAt: string | null, updatedAt: string | null, supersededDate: string | null, primaryConsultant: { __typename: 'users', id: string, name: string } | null, manager: { __typename: 'users', id: string, name: string } | null, payrollCycle: { __typename: 'payroll_cycles', id: string, name: string } }> }
