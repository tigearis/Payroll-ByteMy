...
// Define locally to avoid dependency on external package
export type ResultOf<T> = T extends (...args: any[]) => infer R ? R : T;
export interface DocumentTypeDecoration<Result, Variables> {
