 ...
 * 
 * Generated: 2025-06-23T11:53:31.297Z
...
export type PayrollBasicInfoFragment = { __typename: 'payrolls', id: string, name: string, clientId: string, cycleId: string, dateTypeId: string, primaryConsultantUserId: string | null, backupConsultantUserId: string | null, managerUserId: string | null, employeeCount: number | null, goLiveDate: string | null } & { ' $fragmentName'?: 'PayrollBasicInfoFragment' };

export type PayrollFullDetailsFragment = { __typename: 'payrolls', id: string, name: string, employeeCount: number | null, processingTime: number, processingDaysBeforeEft: number, payrollSystem: string | null, dateValue: number | null, versionNumber: number | null, parentPayrollId: string | null, goLiveDate: string | null, supersededDate: string | null, versionReason: string | null, createdByUserId: string | null } & { ' $fragmentName'?: 'PayrollFullDetailsFragment' };

export type PayrollWithRelationsFragment = (
  { __typename: 'payrolls', client: { __typename: 'clients', id: string, name: string }, payrollCycle: { __typename: 'payroll_cycles', id: string, name: string }, payrollDateType: { __typename: 'payroll_date_types', id: string, name: string }, primaryConsultant: { __typename: 'users', id: string, name: string, email: string } | null, backupConsultant: { __typename: 'users', id: string, name: string, email: string } | null, manager: { __typename: 'users', id: string, name: string, email: string } | null }
...
export type PayrollDateFragment = { __typename: 'payroll_dates', id: string, payrollId: string, originalEftDate: string, adjustedEftDate: string, processingDate: string } & { ' $fragmentName'?: 'PayrollDateFragment' };

export type PayrollWithDatesFragment = (
  { __typename: 'payrolls', payrollDates: Array<(
    { __typename: 'payroll_dates' }
...
export type CreatePayrollMutation = { __typename: 'mutation_root', insertPayroll: { __typename: 'payrolls', id: string, name: string, clientId: string, cycleId: string, dateTypeId: string, primaryConsultantUserId: string | null, employeeCount: number | null } | null };
...
export type UpdatePayrollMutation = { __typename: 'mutation_root', updatePayroll: { __typename: 'payrolls', id: string, name: string, clientId: string, cycleId: string, dateTypeId: string, primaryConsultantUserId: string | null, employeeCount: number | null } | null };
...
export type DeletePayrollMutation = { __typename: 'mutation_root', deletePayroll: { __typename: 'payrolls', id: string, name: string } | null };
...
export type UpdatePayrollStatusMutation = { __typename: 'mutation_root', updatePayroll: { __typename: 'payrolls', id: string, name: string } | null };
...
export type UpdatePayrollDateNotesMutation = { __typename: 'mutation_root', updatePayrollDate: { __typename: 'payroll_dates', id: string, notes: string | null, payrollId: string, originalEftDate: string, adjustedEftDate: string, processingDate: string } | null };

export type DeletePayrollDatesMutationVariables = Exact<{
  payrollId: Scalars['uuid']['input'];
}>;


export type DeletePayrollDatesMutation = { __typename: 'mutation_root', deletePayrollDates: { __typename: 'payroll_dates_mutation_response', affected_rows: number } | null };

export type GetPayrollsQueryVariables = Exact<{ [key: string]: never; }>;


export type GetPayrollsQuery = { __typename: 'query_root', payrolls: Array<{ __typename: 'payrolls', id: string, name: string, clientId: string, cycleId: string, dateTypeId: string, primaryConsultantUserId: string | null, backupConsultantUserId: string | null, managerUserId: string | null, employeeCount: number | null, goLiveDate: string | null, status: string, client: { __typename: 'clients', id: string, name: string }, payrollCycle: { __typename: 'payroll_cycles', id: string, name: string }, payrollDateType: { __typename: 'payroll_date_types', id: string, name: string }, primaryConsultant: { __typename: 'users', id: string, name: string } | null, backupConsultant: { __typename: 'users', id: string, name: string } | null, manager: { __typename: 'users', id: string, name: string } | null, payrollDates: Array<{ __typename: 'payroll_dates', id: string, originalEftDate: string, adjustedEftDate: string, processingDate: string }> }> };
...
export type GetPayrollByIdQuery = { __typename: 'query_root', payroll: { __typename: 'payrolls', id: string, clientId: string, cycleId: string, dateTypeId: string, primaryConsultantUserId: string | null, backupConsultantUserId: string | null, managerUserId: string | null, employeeCount: number | null, goLiveDate: string | null, client: { __typename: 'clients', id: string }, payrollCycle: { __typename: 'payroll_cycles', id: string }, payrollDateType: { __typename: 'payroll_date_types', id: string }, payrollDates: Array<{ __typename: 'payroll_dates', id: string, originalEftDate: string, adjustedEftDate: string, processingDate: string }> } | null };
...
export type GetPayrollsByClientQuery = { __typename: 'query_root', payrolls: Array<{ __typename: 'payrolls', id: string, clientId: string, employeeCount: number | null, goLiveDate: string | null }> };
...
export type GetPayrollDatesQuery = { __typename: 'query_root', payrollDates: Array<{ __typename: 'payroll_dates', id: string, payrollId: string, originalEftDate: string, adjustedEftDate: string, processingDate: string }> };
...
export type GetPayrollFamilyDatesQuery = { __typename: 'query_root', payrolls: Array<{ __typename: 'payrolls', id: string, versionNumber: number | null, payrollDates: Array<(
      { __typename: 'payroll_dates' }
      & { ' $fragmentRefs'?: { 'PayrollDateFragment': PayrollDateFragment } }
    )> }> };
...
export type GetPayrollsMissingDatesQuery = { __typename: 'query_root', payrolls: Array<{ __typename: 'payrolls', id: string, name: string, status: string, client: { __typename: 'clients', id: string, name: string }, payrollDates_aggregate: { __typename: 'payroll_dates_aggregate', aggregate: { __typename: 'payroll_dates_aggregate_fields', count: number } | null } }> };

export type GetPayrollsSimpleQueryVariables = Exact<{ [key: string]: never; }>;


export type GetPayrollsSimpleQuery = { __typename: 'query_root', payrolls: Array<{ __typename: 'payrolls', id: string, client: { __typename: 'clients', id: string } }> };
...
export type CheckPayrollVersionQuery = { __typename: 'query_root', payroll: { __typename: 'payrolls', id: string, supersededDate: string | null, versionNumber: number | null } | null, latest: Array<{ __typename: 'payrolls', id: string }> };
...
export type GetPayrollDatesByIdQuery = { __typename: 'query_root', payrollDates: Array<{ __typename: 'payroll_dates', id: string, originalEftDate: string, adjustedEftDate: string, processingDate: string }> };
...
export type GetPayrollVersionHistoryQuery = { __typename: 'query_root', payrolls: Array<{ __typename: 'payrolls', id: string, versionNumber: number | null, supersededDate: string | null, goLiveDate: string | null }> };
...
export type GetLatestPayrollVersionQuery = { __typename: 'query_root', payrolls: Array<{ __typename: 'payrolls', id: string, versionNumber: number | null, parentPayrollId: string | null }> };
...
export type GeneratePayrollDatesQueryQuery = { __typename: 'query_root', generatePayrollDates: Array<{ __typename: 'payroll_dates', id: string, payrollId: string, originalEftDate: string, adjustedEftDate: string, processingDate: string, notes: string | null }> };
...
export type GetUserUpcomingPayrollsQuery = { __typename: 'query_root', payrolls: Array<{ __typename: 'payrolls', id: string, name: string, status: string, client: { __typename: 'clients', id: string, name: string }, payrollDates: Array<{ __typename: 'payroll_dates', id: string, adjustedEftDate: string, processingDate: string, originalEftDate: string }>, primaryConsultant: { __typename: 'users', id: string, name: string } | null, backupConsultant: { __typename: 'users', id: string, name: string } | null, manager: { __typename: 'users', id: string, name: string } | null }> };

export type GetPayrollCyclesQueryVariables = Exact<{ [key: string]: never; }>;


export type GetPayrollCyclesQuery = { __typename: 'query_root', payroll_cycles: Array<{ __typename: 'payroll_cycles', id: string, name: string, description: string | null }> };

export type GetPayrollDateTypesQueryVariables = Exact<{ [key: string]: never; }>;


export type GetPayrollDateTypesQuery = { __typename: 'query_root', payroll_date_types: Array<{ __typename: 'payroll_date_types', id: string, name: string, description: string | null }> };
...
export type PayrollUpdatesSubscription = { __typename: 'subscription_root', payroll: (
    { __typename: 'payrolls' }
    & { ' $fragmentRefs'?: { 'PayrollWithDatesFragment': PayrollWithDatesFragment } }
  ) | null };
...
export type PayrollDateUpdatesSubscription = { __typename: 'subscription_root', payrollDates: Array<(
    { __typename: 'payroll_dates' }
    & { ' $fragmentRefs'?: { 'PayrollDateFragment': PayrollDateFragment } }
  )> };
...
export type PayrollSubscriptionSubscription = { __typename: 'subscription_root', payrolls: Array<{ __typename: 'payrolls', id: string, name: string, status: string, updatedAt: string | null }> };

export type TestSubscriptionSubscriptionVariables = Exact<{ [key: string]: never; }>;


export type TestSubscriptionSubscription = { __typename: 'subscription_root', payrolls: Array<{ __typename: 'payrolls', id: string, name: string }> };
...
export const CheckPayrollVersionDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"CheckPayrollVersion"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"id"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"uuid"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"payroll"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"id"},"value":{"kind":"Variable","name":{"kind":"Name","value":"id"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"supersededDate"}},{"kind":"Field","name":{"kind":"Name","value":"versionNumber"}}]}},{"kind":"Field","alias":{"kind":"Name","value":"latest"},"name":{"kind":"Name","value":"payrolls"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"where"},"value":{"kind":"ObjectValue","fields":[{"kind":"ObjectField","name":{"kind":"Name","value":"parentPayrollId"},"value":{"kind":"ObjectValue","fields":[{"kind":"ObjectField","name":{"kind":"Name","value":"_eq"},"value":{"kind":"Variable","name":{"kind":"Name","value":"id"}}}]}},{"kind":"ObjectField","name":{"kind":"Name","value":"supersededDate"},"value":{"kind":"ObjectValue","fields":[{"kind":"ObjectField","name":{"kind":"Name","value":"_is_null"},"value":{"kind":"BooleanValue","value":true}}]}}]}},{"kind":"Argument","name":{"kind":"Name","value":"limit"},"value":{"kind":"IntValue","value":"1"}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}}]}}]}}]} as unknown as DocumentNode<CheckPayrollVersionQuery, CheckPayrollVersionQueryVariables>;
export const GetPayrollDatesByIdDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"GetPayrollDatesById"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"id"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"uuid"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"payrollDates"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"where"},"value":{"kind":"ObjectValue","fields":[{"kind":"ObjectField","name":{"kind":"Name","value":"payrollId"},"value":{"kind":"ObjectValue","fields":[{"kind":"ObjectField","name":{"kind":"Name","value":"_eq"},"value":{"kind":"Variable","name":{"kind":"Name","value":"id"}}}]}}]}},{"kind":"Argument","name":{"kind":"Name","value":"order_by"},"value":{"kind":"ObjectValue","fields":[{"kind":"ObjectField","name":{"kind":"Name","value":"adjustedEftDate"},"value":{"kind":"EnumValue","value":"asc"}}]}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"originalEftDate"}},{"kind":"Field","name":{"kind":"Name","value":"adjustedEftDate"}},{"kind":"Field","name":{"kind":"Name","value":"processingDate"}}]}}]}}]} as unknown as DocumentNode<GetPayrollDatesByIdQuery, GetPayrollDatesByIdQueryVariables>;
export const GetPayrollVersionHistoryDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"GetPayrollVersionHistory"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"payrollId"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"uuid"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"payrolls"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"where"},"value":{"kind":"ObjectValue","fields":[{"kind":"ObjectField","name":{"kind":"Name","value":"_or"},"value":{"kind":"ListValue","values":[{"kind":"ObjectValue","fields":[{"kind":"ObjectField","name":{"kind":"Name","value":"id"},"value":{"kind":"ObjectValue","fields":[{"kind":"ObjectField","name":{"kind":"Name","value":"_eq"},"value":{"kind":"Variable","name":{"kind":"Name","value":"payrollId"}}}]}}]},{"kind":"ObjectValue","fields":[{"kind":"ObjectField","name":{"kind":"Name","value":"parentPayrollId"},"value":{"kind":"ObjectValue","fields":[{"kind":"ObjectField","name":{"kind":"Name","value":"_eq"},"value":{"kind":"Variable","name":{"kind":"Name","value":"payrollId"}}}]}}]}]}}]}},{"kind":"Argument","name":{"kind":"Name","value":"order_by"},"value":{"kind":"ObjectValue","fields":[{"kind":"ObjectField","name":{"kind":"Name","value":"versionNumber"},"value":{"kind":"EnumValue","value":"desc"}}]}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"versionNumber"}},{"kind":"Field","name":{"kind":"Name","value":"supersededDate"}},{"kind":"Field","name":{"kind":"Name","value":"goLiveDate"}}]}}]}}]} as unknown as DocumentNode<GetPayrollVersionHistoryQuery, GetPayrollVersionHistoryQueryVariables>;
export const GetLatestPayrollVersionDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"GetLatestPayrollVersion"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"payrollId"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"uuid"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"payrolls"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"where"},"value":{"kind":"ObjectValue","fields":[{"kind":"ObjectField","name":{"kind":"Name","value":"_or"},"value":{"kind":"ListValue","values":[{"kind":"ObjectValue","fields":[{"kind":"ObjectField","name":{"kind":"Name","value":"id"},"value":{"kind":"ObjectValue","fields":[{"kind":"ObjectField","name":{"kind":"Name","value":"_eq"},"value":{"kind":"Variable","name":{"kind":"Name","value":"payrollId"}}}]}}]},{"kind":"ObjectValue","fields":[{"kind":"ObjectField","name":{"kind":"Name","value":"parentPayrollId"},"value":{"kind":"ObjectValue","fields":[{"kind":"ObjectField","name":{"kind":"Name","value":"_eq"},"value":{"kind":"Variable","name":{"kind":"Name","value":"payrollId"}}}]}}]}]}},{"kind":"ObjectField","name":{"kind":"Name","value":"supersededDate"},"value":{"kind":"ObjectValue","fields":[{"kind":"ObjectField","name":{"kind":"Name","value":"_is_null"},"value":{"kind":"BooleanValue","value":true}}]}}]}},{"kind":"Argument","name":{"kind":"Name","value":"limit"},"value":{"kind":"IntValue","value":"1"}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"versionNumber"}},{"kind":"Field","name":{"kind":"Name","value":"parentPayrollId"}}]}}]}}]} as unknown as DocumentNode<GetLatestPayrollVersionQuery, GetLatestPayrollVersionQueryVariables>;
export const GeneratePayrollDatesQueryDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"GeneratePayrollDatesQuery"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"payrollId"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"uuid"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"startDate"}},"type":{"kind":"NamedType","name":{"kind":"Name","value":"date"}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"endDate"}},"type":{"kind":"NamedType","name":{"kind":"Name","value":"date"}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"maxDates"}},"type":{"kind":"NamedType","name":{"kind":"Name","value":"Int"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"generatePayrollDates"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"args"},"value":{"kind":"ObjectValue","fields":[{"kind":"ObjectField","name":{"kind":"Name","value":"p_payroll_id"},"value":{"kind":"Variable","name":{"kind":"Name","value":"payrollId"}}},{"kind":"ObjectField","name":{"kind":"Name","value":"p_start_date"},"value":{"kind":"Variable","name":{"kind":"Name","value":"startDate"}}},{"kind":"ObjectField","name":{"kind":"Name","value":"p_end_date"},"value":{"kind":"Variable","name":{"kind":"Name","value":"endDate"}}},{"kind":"ObjectField","name":{"kind":"Name","value":"p_max_dates"},"value":{"kind":"Variable","name":{"kind":"Name","value":"maxDates"}}}]}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"payrollId"}},{"kind":"Field","name":{"kind":"Name","value":"originalEftDate"}},{"kind":"Field","name":{"kind":"Name","value":"adjustedEftDate"}},{"kind":"Field","name":{"kind":"Name","value":"processingDate"}},{"kind":"Field","name":{"kind":"Name","value":"notes"}}]}}]}}]} as unknown as DocumentNode<GeneratePayrollDatesQueryQuery, GeneratePayrollDatesQueryQueryVariables>;
export const GetUserUpcomingPayrollsDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"GetUserUpcomingPayrolls"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"userId"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"uuid"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"from_date"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"date"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"limit"}},"type":{"kind":"NamedType","name":{"kind":"Name","value":"Int"}},"defaultValue":{"kind":"IntValue","value":"10"}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"payrolls"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"where"},"value":{"kind":"ObjectValue","fields":[{"kind":"ObjectField","name":{"kind":"Name","value":"_and"},"value":{"kind":"ListValue","values":[{"kind":"ObjectValue","fields":[{"kind":"ObjectField","name":{"kind":"Name","value":"supersededDate"},"value":{"kind":"ObjectValue","fields":[{"kind":"ObjectField","name":{"kind":"Name","value":"_is_null"},"value":{"kind":"BooleanValue","value":true}}]}}]},{"kind":"ObjectValue","fields":[{"kind":"ObjectField","name":{"kind":"Name","value":"_or"},"value":{"kind":"ListValue","values":[{"kind":"ObjectValue","fields":[{"kind":"ObjectField","name":{"kind":"Name","value":"primaryConsultantUserId"},"value":{"kind":"ObjectValue","fields":[{"kind":"ObjectField","name":{"kind":"Name","value":"_eq"},"value":{"kind":"Variable","name":{"kind":"Name","value":"userId"}}}]}}]},{"kind":"ObjectValue","fields":[{"kind":"ObjectField","name":{"kind":"Name","value":"backupConsultantUserId"},"value":{"kind":"ObjectValue","fields":[{"kind":"ObjectField","name":{"kind":"Name","value":"_eq"},"value":{"kind":"Variable","name":{"kind":"Name","value":"userId"}}}]}}]},{"kind":"ObjectValue","fields":[{"kind":"ObjectField","name":{"kind":"Name","value":"managerUserId"},"value":{"kind":"ObjectValue","fields":[{"kind":"ObjectField","name":{"kind":"Name","value":"_eq"},"value":{"kind":"Variable","name":{"kind":"Name","value":"userId"}}}]}}]}]}}]},{"kind":"ObjectValue","fields":[{"kind":"ObjectField","name":{"kind":"Name","value":"payrollDates"},"value":{"kind":"ObjectValue","fields":[{"kind":"ObjectField","name":{"kind":"Name","value":"adjustedEftDate"},"value":{"kind":"ObjectValue","fields":[{"kind":"ObjectField","name":{"kind":"Name","value":"_gte"},"value":{"kind":"Variable","name":{"kind":"Name","value":"from_date"}}}]}}]}}]}]}}]}},{"kind":"Argument","name":{"kind":"Name","value":"order_by"},"value":{"kind":"ObjectValue","fields":[{"kind":"ObjectField","name":{"kind":"Name","value":"payrollDates_aggregate"},"value":{"kind":"ObjectValue","fields":[{"kind":"ObjectField","name":{"kind":"Name","value":"min"},"value":{"kind":"ObjectValue","fields":[{"kind":"ObjectField","name":{"kind":"Name","value":"adjustedEftDate"},"value":{"kind":"EnumValue","value":"asc"}}]}}]}}]}},{"kind":"Argument","name":{"kind":"Name","value":"limit"},"value":{"kind":"Variable","name":{"kind":"Name","value":"limit"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"name"}},{"kind":"Field","name":{"kind":"Name","value":"status"}},{"kind":"Field","name":{"kind":"Name","value":"client"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"name"}}]}},{"kind":"Field","name":{"kind":"Name","value":"payrollDates"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"where"},"value":{"kind":"ObjectValue","fields":[{"kind":"ObjectField","name":{"kind":"Name","value":"adjustedEftDate"},"value":{"kind":"ObjectValue","fields":[{"kind":"ObjectField","name":{"kind":"Name","value":"_gte"},"value":{"kind":"Variable","name":{"kind":"Name","value":"from_date"}}}]}}]}},{"kind":"Argument","name":{"kind":"Name","value":"order_by"},"value":{"kind":"ObjectValue","fields":[{"kind":"ObjectField","name":{"kind":"Name","value":"adjustedEftDate"},"value":{"kind":"EnumValue","value":"asc"}}]}},{"kind":"Argument","name":{"kind":"Name","value":"limit"},"value":{"kind":"IntValue","value":"3"}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"adjustedEftDate"}},{"kind":"Field","name":{"kind":"Name","value":"processingDate"}},{"kind":"Field","name":{"kind":"Name","value":"originalEftDate"}}]}},{"kind":"Field","name":{"kind":"Name","value":"primaryConsultant"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"name"}}]}},{"kind":"Field","name":{"kind":"Name","value":"backupConsultant"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"name"}}]}},{"kind":"Field","name":{"kind":"Name","value":"manager"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"name"}}]}}]}}]}}]} as unknown as DocumentNode<GetUserUpcomingPayrollsQuery, GetUserUpcomingPayrollsQueryVariables>;
export const GetPayrollCyclesDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"GetPayrollCycles"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"payroll_cycles"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"name"}},{"kind":"Field","name":{"kind":"Name","value":"description"}}]}}]}}]} as unknown as DocumentNode<GetPayrollCyclesQuery, GetPayrollCyclesQueryVariables>;
export const GetPayrollDateTypesDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"GetPayrollDateTypes"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"payroll_date_types"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"name"}},{"kind":"Field","name":{"kind":"Name","value":"description"}}]}}]}}]} as unknown as DocumentNode<GetPayrollDateTypesQuery, GetPayrollDateTypesQueryVariables>;
export const PayrollUpdatesDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"subscription","name":{"kind":"Name","value":"PayrollUpdates"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"id"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"uuid"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"payroll"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"id"},"value":{"kind":"Variable","name":{"kind":"Name","value":"id"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"FragmentSpread","name":{"kind":"Name","value":"PayrollWithDates"}}]}}]}},{"kind":"FragmentDefinition","name":{"kind":"Name","value":"PayrollFullDetails"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"payrolls"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"name"}},{"kind":"Field","name":{"kind":"Name","value":"employeeCount"}},{"kind":"Field","name":{"kind":"Name","value":"processingTime"}},{"kind":"Field","name":{"kind":"Name","value":"processingDaysBeforeEft"}},{"kind":"Field","name":{"kind":"Name","value":"payrollSystem"}},{"kind":"Field","name":{"kind":"Name","value":"dateValue"}},{"kind":"Field","name":{"kind":"Name","value":"versionNumber"}},{"kind":"Field","name":{"kind":"Name","value":"parentPayrollId"}},{"kind":"Field","name":{"kind":"Name","value":"goLiveDate"}},{"kind":"Field","name":{"kind":"Name","value":"supersededDate"}},{"kind":"Field","name":{"kind":"Name","value":"versionReason"}},{"kind":"Field","name":{"kind":"Name","value":"createdByUserId"}}]}},{"kind":"FragmentDefinition","name":{"kind":"Name","value":"PayrollWithRelations"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"payrolls"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"FragmentSpread","name":{"kind":"Name","value":"PayrollFullDetails"}},{"kind":"Field","name":{"kind":"Name","value":"client"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"name"}}]}},{"kind":"Field","name":{"kind":"Name","value":"payrollCycle"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"name"}}]}},{"kind":"Field","name":{"kind":"Name","value":"payrollDateType"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"name"}}]}},{"kind":"Field","name":{"kind":"Name","value":"primaryConsultant"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"name"}},{"kind":"Field","name":{"kind":"Name","value":"email"}}]}},{"kind":"Field","name":{"kind":"Name","value":"backupConsultant"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"name"}},{"kind":"Field","name":{"kind":"Name","value":"email"}}]}},{"kind":"Field","name":{"kind":"Name","value":"manager"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"name"}},{"kind":"Field","name":{"kind":"Name","value":"email"}}]}}]}},{"kind":"FragmentDefinition","name":{"kind":"Name","value":"PayrollDate"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"payroll_dates"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"payrollId"}},{"kind":"Field","name":{"kind":"Name","value":"originalEftDate"}},{"kind":"Field","name":{"kind":"Name","value":"adjustedEftDate"}},{"kind":"Field","name":{"kind":"Name","value":"processingDate"}}]}},{"kind":"FragmentDefinition","name":{"kind":"Name","value":"PayrollWithDates"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"payrolls"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"FragmentSpread","name":{"kind":"Name","value":"PayrollWithRelations"}},{"kind":"Field","name":{"kind":"Name","value":"payrollDates"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"order_by"},"value":{"kind":"ObjectValue","fields":[{"kind":"ObjectField","name":{"kind":"Name","value":"adjustedEftDate"},"value":{"kind":"EnumValue","value":"asc"}}]}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"FragmentSpread","name":{"kind":"Name","value":"PayrollDate"}}]}}]}}]} as unknown as DocumentNode<PayrollUpdatesSubscription, PayrollUpdatesSubscriptionVariables>;
export const PayrollListUpdatesDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"subscription","name":{"kind":"Name","value":"PayrollListUpdates"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"payrolls"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"where"},"value":{"kind":"ObjectValue","fields":[{"kind":"ObjectField","name":{"kind":"Name","value":"supersededDate"},"value":{"kind":"ObjectValue","fields":[{"kind":"ObjectField","name":{"kind":"Name","value":"_is_null"},"value":{"kind":"BooleanValue","value":true}}]}}]}},{"kind":"Argument","name":{"kind":"Name","value":"order_by"},"value":{"kind":"ObjectValue","fields":[{"kind":"ObjectField","name":{"kind":"Name","value":"updatedAt"},"value":{"kind":"EnumValue","value":"desc"}}]}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"FragmentSpread","name":{"kind":"Name","value":"PayrollBasicInfo"}}]}}]}},{"kind":"FragmentDefinition","name":{"kind":"Name","value":"PayrollBasicInfo"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"payrolls"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"name"}},{"kind":"Field","name":{"kind":"Name","value":"clientId"}},{"kind":"Field","name":{"kind":"Name","value":"cycleId"}},{"kind":"Field","name":{"kind":"Name","value":"dateTypeId"}},{"kind":"Field","name":{"kind":"Name","value":"primaryConsultantUserId"}},{"kind":"Field","name":{"kind":"Name","value":"backupConsultantUserId"}},{"kind":"Field","name":{"kind":"Name","value":"managerUserId"}},{"kind":"Field","name":{"kind":"Name","value":"employeeCount"}},{"kind":"Field","name":{"kind":"Name","value":"goLiveDate"}}]}}]} as unknown as DocumentNode<PayrollListUpdatesSubscription, PayrollListUpdatesSubscriptionVariables>;
