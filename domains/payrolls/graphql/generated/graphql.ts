 ...
 * 
 * Generated: 2025-06-25T09:22:09.015Z
...
export type PayrollCoreFragment = { __typename: 'payrolls', id: string, name: string, status: string, clientId: string, employeeCount: number | null, goLiveDate: string | null, payrollSystem: string | null, processingTime: number, processingDaysBeforeEft: number, createdAt: string | null, updatedAt: string | null, versionNumber: number | null, supersededDate: string | null } & { ' $fragmentName'?: 'PayrollCoreFragment' };

export type PayrollBasicFragment = (
  { __typename: 'payrolls', primaryConsultantUserId: string | null, backupConsultantUserId: string | null, managerUserId: string | null, cycleId: string, dateTypeId: string, dateValue: number | null }
  & { ' $fragmentRefs'?: { 'PayrollCoreFragment': PayrollCoreFragment } }
) & { ' $fragmentName'?: 'PayrollBasicFragment' };

export type PayrollDetailedFragment = (
  { __typename: 'payrolls', parentPayrollId: string | null, versionReason: string | null, createdByUserId: string | null }
  & { ' $fragmentRefs'?: { 'PayrollBasicFragment': PayrollBasicFragment } }
) & { ' $fragmentName'?: 'PayrollDetailedFragment' };

export type PayrollWithClientFragment = (
  { __typename: 'payrolls', client: { __typename: 'clients', id: string, name: string, contactPerson: string | null, contactEmail: string | null, active: boolean | null } }
  & { ' $fragmentRefs'?: { 'PayrollBasicFragment': PayrollBasicFragment } }
) & { ' $fragmentName'?: 'PayrollWithClientFragment' };

export type PayrollWithUsersFragment = (
  { __typename: 'payrolls', primaryConsultant: { __typename: 'users', id: string, name: string, email: string, role: string, isActive: boolean | null } | null, backupConsultant: { __typename: 'users', id: string, name: string, email: string, role: string, isActive: boolean | null } | null, manager: { __typename: 'users', id: string, name: string, email: string, role: string, isActive: boolean | null } | null }
  & { ' $fragmentRefs'?: { 'PayrollBasicFragment': PayrollBasicFragment } }
) & { ' $fragmentName'?: 'PayrollWithUsersFragment' };

export type PayrollWithCycleFragment = (
  { __typename: 'payrolls', payrollCycle: { __typename: 'payrollCycles', id: string, name: string, description: string | null }, payrollDateType: { __typename: 'payrollDateTypes', id: string, name: string, description: string | null } }
  & { ' $fragmentRefs'?: { 'PayrollBasicFragment': PayrollBasicFragment } }
) & { ' $fragmentName'?: 'PayrollWithCycleFragment' };

export type PayrollWithAllRelationsFragment = (
  { __typename: 'payrolls', createdByUserId: string | null, client: { __typename: 'clients', id: string, name: string, contactPerson: string | null, contactEmail: string | null, active: boolean | null }, primaryConsultant: { __typename: 'users', id: string, name: string, email: string, role: string, isActive: boolean | null } | null, backupConsultant: { __typename: 'users', id: string, name: string, email: string, role: string, isActive: boolean | null } | null, manager: { __typename: 'users', id: string, name: string, email: string, role: string, isActive: boolean | null } | null, payrollCycle: { __typename: 'payrollCycles', id: string, name: string, description: string | null }, payrollDateType: { __typename: 'payrollDateTypes', id: string, name: string, description: string | null }, parentPayroll: { __typename: 'payrolls', id: string, name: string, versionNumber: number | null, status: string } | null }
  & { ' $fragmentRefs'?: { 'PayrollDetailedFragment': PayrollDetailedFragment } }
) & { ' $fragmentName'?: 'PayrollWithAllRelationsFragment' };

export type PayrollSummaryFragment = { __typename: 'payrolls', id: string, name: string, status: string, clientId: string, employeeCount: number | null, supersededDate: string | null } & { ' $fragmentName'?: 'PayrollSummaryFragment' };

export type PayrollListItemFragment = (
  { __typename: 'payrolls', goLiveDate: string | null, primaryConsultantUserId: string | null, backupConsultantUserId: string | null, managerUserId: string | null, createdAt: string | null, updatedAt: string | null, client: { __typename: 'clients', id: string, name: string } }
  & { ' $fragmentRefs'?: { 'PayrollSummaryFragment': PayrollSummaryFragment } }
) & { ' $fragmentName'?: 'PayrollListItemFragment' };

export type PayrollTableRowFragment = (
  { __typename: 'payrolls', payrollSystem: string | null, processingTime: number, versionNumber: number | null, primaryConsultant: { __typename: 'users', id: string, name: string } | null, backupConsultant: { __typename: 'users', id: string, name: string } | null, manager: { __typename: 'users', id: string, name: string } | null }
  & { ' $fragmentRefs'?: { 'PayrollListItemFragment': PayrollListItemFragment } }
) & { ' $fragmentName'?: 'PayrollTableRowFragment' };

export type PayrollDashboardCardFragment = (
  { __typename: 'payrolls', goLiveDate: string | null, primaryConsultant: { __typename: 'users', id: string, name: string } | null, client: { __typename: 'clients', id: string, name: string }, payrollCycle: { __typename: 'payrollCycles', id: string, name: string, description: string | null } }
  & { ' $fragmentRefs'?: { 'PayrollSummaryFragment': PayrollSummaryFragment } }
) & { ' $fragmentName'?: 'PayrollDashboardCardFragment' };

export type PayrollMinimalFragment = { __typename: 'payrolls', id: string, name: string, status: string, clientId: string } & { ' $fragmentName'?: 'PayrollMinimalFragment' };

export type PayrollForAssignmentFragment = { __typename: 'payrolls', id: string, name: string, status: string, employeeCount: number | null, goLiveDate: string | null, primaryConsultantUserId: string | null, backupConsultantUserId: string | null, managerUserId: string | null, client: { __typename: 'clients', id: string, name: string } } & { ' $fragmentName'?: 'PayrollForAssignmentFragment' };

export type PayrollForAuditFragment = { __typename: 'payrolls', id: string, name: string, status: string, clientId: string, employeeCount: number | null, goLiveDate: string | null, versionNumber: number | null, createdAt: string | null, updatedAt: string | null } & { ' $fragmentName'?: 'PayrollForAuditFragment' };

export type PayrollVersionInfoFragment = { __typename: 'payrolls', id: string, name: string, versionNumber: number | null, versionReason: string | null, parentPayrollId: string | null, supersededDate: string | null, createdAt: string | null, createdByUserId: string | null } & { ' $fragmentName'?: 'PayrollVersionInfoFragment' };

export type PayrollWithDatesFragment = (
  { __typename: 'payrolls', payrollDates: Array<{ __typename: 'payrollDates', id: string, originalEftDate: string, adjustedEftDate: string, processingDate: string, notes: string | null, createdAt: string | null, updatedAt: string | null }> }
  & { ' $fragmentRefs'?: { 'PayrollCoreFragment': PayrollCoreFragment } }
) & { ' $fragmentName'?: 'PayrollWithDatesFragment' };

export type PayrollProcessingInfoFragment = { __typename: 'payrolls', id: string, name: string, status: string, payrollSystem: string | null, processingTime: number, processingDaysBeforeEft: number, goLiveDate: string | null, employeeCount: number | null, client: { __typename: 'clients', id: string, name: string }, payrollCycle: { __typename: 'payrollCycles', id: string, name: string, description: string | null } } & { ' $fragmentName'?: 'PayrollProcessingInfoFragment' };

export type PayrollWorkloadFragment = { __typename: 'payrolls', id: string, name: string, status: string, employeeCount: number | null, client: { __typename: 'clients', id: string, name: string }, payrollCycle: { __typename: 'payrollCycles', id: string, name: string, description: string | null } } & { ' $fragmentName'?: 'PayrollWorkloadFragment' };

export type PayrollDateFragment = { __typename: 'payrollDates', id: string, originalEftDate: string, adjustedEftDate: string, processingDate: string, notes: string | null, payrollId: string, createdAt: string | null, updatedAt: string | null } & { ' $fragmentName'?: 'PayrollDateFragment' };
...
export type CreatePayrollMutation = { __typename: 'mutation_root', insertPayroll: (
    { __typename: 'payrolls', client: { __typename: 'clients', id: string, name: string }, primaryConsultant: { __typename: 'users', id: string, name: string } | null, manager: { __typename: 'users', id: string, name: string } | null }
    & { ' $fragmentRefs'?: { 'PayrollDetailedFragment': PayrollDetailedFragment } }
  ) | null };
...
export type UpdatePayrollMutation = { __typename: 'mutation_root', updatePayrollById: (
    { __typename: 'payrolls', client: { __typename: 'clients', id: string, name: string }, primaryConsultant: { __typename: 'users', id: string, name: string } | null, backupConsultant: { __typename: 'users', id: string, name: string } | null, manager: { __typename: 'users', id: string, name: string } | null }
    & { ' $fragmentRefs'?: { 'PayrollDetailedFragment': PayrollDetailedFragment } }
  ) | null };
...
export type ReactivatePayrollMutation = { __typename: 'mutation_root', updatePayrollById: (
    { __typename: 'payrolls' }
    & { ' $fragmentRefs'?: { 'PayrollBasicFragment': PayrollBasicFragment } }
  ) | null };
...
export type UpdatePayrollStatusMutation = { __typename: 'mutation_root', updatePayrollById: (
    { __typename: 'payrolls', client: { __typename: 'clients', id: string, name: string } }
    & { ' $fragmentRefs'?: { 'PayrollBasicFragment': PayrollBasicFragment } }
  ) | null };
...
export type AssignPrimaryConsultantMutation = { __typename: 'mutation_root', updatePayrollById: (
    { __typename: 'payrolls', primaryConsultant: { __typename: 'users', id: string, name: string, email: string } | null }
    & { ' $fragmentRefs'?: { 'PayrollBasicFragment': PayrollBasicFragment } }
  ) | null };
...
export type AssignBackupConsultantMutation = { __typename: 'mutation_root', updatePayrollById: (
    { __typename: 'payrolls', backupConsultant: { __typename: 'users', id: string, name: string, email: string } | null }
    & { ' $fragmentRefs'?: { 'PayrollBasicFragment': PayrollBasicFragment } }
  ) | null };
...
export type AssignManagerMutation = { __typename: 'mutation_root', updatePayrollById: (
    { __typename: 'payrolls', manager: { __typename: 'users', id: string, name: string, email: string } | null }
    & { ' $fragmentRefs'?: { 'PayrollBasicFragment': PayrollBasicFragment } }
  ) | null };
...
export type UpdatePayrollAssignmentsMutation = { __typename: 'mutation_root', updatePayrollById: (
    { __typename: 'payrolls', primaryConsultant: { __typename: 'users', id: string, name: string, email: string } | null, backupConsultant: { __typename: 'users', id: string, name: string, email: string } | null, manager: { __typename: 'users', id: string, name: string, email: string } | null }
    & { ' $fragmentRefs'?: { 'PayrollBasicFragment': PayrollBasicFragment } }
  ) | null };
...
export type CreatePayrollVersionMutation = { __typename: 'mutation_root', updatePayrollById: { __typename: 'payrolls', id: string, supersededDate: string | null } | null, insertPayroll: (
    { __typename: 'payrolls' }
    & { ' $fragmentRefs'?: { 'PayrollWithAllRelationsFragment': PayrollWithAllRelationsFragment } }
  ) | null };
...
export type BulkUpdatePayrollsMutation = { __typename: 'mutation_root', bulkUpdatePayrolls: { __typename: 'payrollsMutationResponse', affectedRows: number, returning: Array<(
      { __typename: 'payrolls' }
      & { ' $fragmentRefs'?: { 'PayrollBasicFragment': PayrollBasicFragment } }
    )> } | null };
...
export type BulkAssignConsultantMutation = { __typename: 'mutation_root', bulkUpdatePayrolls: { __typename: 'payrollsMutationResponse', affectedRows: number, returning: Array<(
      { __typename: 'payrolls', primaryConsultant: { __typename: 'users', id: string, name: string } | null }
      & { ' $fragmentRefs'?: { 'PayrollBasicFragment': PayrollBasicFragment } }
    )> } | null };
...
export type BulkAssignManagerMutation = { __typename: 'mutation_root', bulkUpdatePayrolls: { __typename: 'payrollsMutationResponse', affectedRows: number, returning: Array<(
      { __typename: 'payrolls', manager: { __typename: 'users', id: string, name: string } | null }
      & { ' $fragmentRefs'?: { 'PayrollBasicFragment': PayrollBasicFragment } }
    )> } | null };
...
export type BulkUpdatePayrollStatusMutation = { __typename: 'mutation_root', bulkUpdatePayrolls: { __typename: 'payrollsMutationResponse', affectedRows: number, returning: Array<(
      { __typename: 'payrolls' }
      & { ' $fragmentRefs'?: { 'PayrollBasicFragment': PayrollBasicFragment } }
    )> } | null };
...
export type UpdatePayrollConfigurationMutation = { __typename: 'mutation_root', updatePayrollById: (
    { __typename: 'payrolls' }
    & { ' $fragmentRefs'?: { 'PayrollWithCycleFragment': PayrollWithCycleFragment } }
  ) | null };
...
export type CreatePayrollCycleMutation = { __typename: 'mutation_root', insertPayrollCycle: { __typename: 'payrollCycles', id: string, name: string, description: string | null, createdAt: string | null } | null };
...
export type UpdatePayrollCycleMutation = { __typename: 'mutation_root', updatePayrollCycleById: { __typename: 'payrollCycles', id: string, name: string, description: string | null, updatedAt: string | null } | null };
...
export type DeletePayrollCycleMutation = { __typename: 'mutation_root', deletePayrollCycleById: { __typename: 'payrollCycles', id: string, name: string } | null };
...
export type CreatePayrollDateTypeMutation = { __typename: 'mutation_root', insertPayrollDateType: { __typename: 'payrollDateTypes', id: string, name: string, description: string | null, createdAt: string | null } | null };
...
export type UpdatePayrollDateTypeMutation = { __typename: 'mutation_root', updatePayrollDateTypeById: { __typename: 'payrollDateTypes', id: string, name: string, description: string | null, updatedAt: string | null } | null };
...
export type DeletePayrollDateTypeMutation = { __typename: 'mutation_root', deletePayrollDateTypeById: { __typename: 'payrollDateTypes', id: string, name: string } | null };
...
export type GetPayrollsQuery = { __typename: 'query_root', payrolls: Array<(
    { __typename: 'payrolls' }
    & { ' $fragmentRefs'?: { 'PayrollListItemFragment': PayrollListItemFragment } }
  )>, payrollsAggregate: { __typename: 'payrollsAggregate', aggregate: { __typename: 'payrollsAggregateFields', count: number } | null } };
...
export type GetPayrollByIdQuery = { __typename: 'query_root', payrollById: (
    { __typename: 'payrolls' }
    & { ' $fragmentRefs'?: { 'PayrollWithAllRelationsFragment': PayrollWithAllRelationsFragment } }
  ) | null };
...
export type GetPayrollBasicQuery = { __typename: 'query_root', payrollById: (
    { __typename: 'payrolls' }
    & { ' $fragmentRefs'?: { 'PayrollBasicFragment': PayrollBasicFragment } }
  ) | null };
...
export type GetPayrollForEditQuery = { __typename: 'query_root', payrollById: (
    { __typename: 'payrolls', client: { __typename: 'clients', id: string, name: string }, payrollCycle: { __typename: 'payrollCycles', id: string, name: string, description: string | null }, payrollDateType: { __typename: 'payrollDateTypes', id: string, name: string } }
    & { ' $fragmentRefs'?: { 'PayrollDetailedFragment': PayrollDetailedFragment } }
  ) | null };
...
export type GetPayrollsSimpleQuery = { __typename: 'query_root', payrolls: Array<(
    { __typename: 'payrolls' }
    & { ' $fragmentRefs'?: { 'PayrollMinimalFragment': PayrollMinimalFragment } }
  )> };

export type GetActivePayrollsQueryVariables = Exact<{ [key: string]: never; }>;


export type GetActivePayrollsQuery = { __typename: 'query_root', payrolls: Array<(
    { __typename: 'payrolls', client: { __typename: 'clients', id: string, name: string } }
    & { ' $fragmentRefs'?: { 'PayrollSummaryFragment': PayrollSummaryFragment } }
  )> };
...
export type GetPayrollsByClientQuery = { __typename: 'query_root', payrolls: Array<(
    { __typename: 'payrolls' }
    & { ' $fragmentRefs'?: { 'PayrollListItemFragment': PayrollListItemFragment } }
  )> };
...
export type GetPayrollsByUserQuery = { __typename: 'query_root', primaryPayrolls: Array<(
    { __typename: 'payrolls' }
    & { ' $fragmentRefs'?: { 'PayrollWorkloadFragment': PayrollWorkloadFragment } }
  )>, backupPayrolls: Array<(
    { __typename: 'payrolls' }
    & { ' $fragmentRefs'?: { 'PayrollWorkloadFragment': PayrollWorkloadFragment } }
  )>, managedPayrolls: Array<(
    { __typename: 'payrolls' }
    & { ' $fragmentRefs'?: { 'PayrollWorkloadFragment': PayrollWorkloadFragment } }
  )> };
...
export type GetUpcomingPayrollsQuery = { __typename: 'query_root', payrolls: Array<(
    { __typename: 'payrolls', nextPayDate: Array<{ __typename: 'payrollDates', originalEftDate: string, adjustedEftDate: string, processingDate: string }> }
    & { ' $fragmentRefs'?: { 'PayrollDashboardCardFragment': PayrollDashboardCardFragment } }
  )> };
...
export type SearchPayrollsQuery = { __typename: 'query_root', payrolls: Array<(
    { __typename: 'payrolls' }
    & { ' $fragmentRefs'?: { 'PayrollTableRowFragment': PayrollTableRowFragment } }
  )> };
...
export type GetPayrollsByStatusQuery = { __typename: 'query_root', payrolls: Array<(
    { __typename: 'payrolls' }
    & { ' $fragmentRefs'?: { 'PayrollListItemFragment': PayrollListItemFragment } }
  )> };
...
export type GetPayrollsByProcessingTimeQuery = { __typename: 'query_root', payrolls: Array<(
    { __typename: 'payrolls' }
    & { ' $fragmentRefs'?: { 'PayrollProcessingInfoFragment': PayrollProcessingInfoFragment } }
  )> };
...
export type GetPayrollVersionsQuery = { __typename: 'query_root', payrolls: Array<(
    { __typename: 'payrolls' }
    & { ' $fragmentRefs'?: { 'PayrollVersionInfoFragment': PayrollVersionInfoFragment } }
  )> };
...
export type GetPayrollHistoryQuery = { __typename: 'query_root', payrolls: Array<(
    { __typename: 'payrolls', status: string, supersededDate: string | null }
    & { ' $fragmentRefs'?: { 'PayrollVersionInfoFragment': PayrollVersionInfoFragment } }
  )> };
...
export type GetLatestPayrollVersionQuery = { __typename: 'query_root', payrolls: Array<(
    { __typename: 'payrolls' }
    & { ' $fragmentRefs'?: { 'PayrollWithAllRelationsFragment': PayrollWithAllRelationsFragment } }
  )> };
...
export type GetPayrollCyclesQuery = { __typename: 'query_root', payrollCycles: Array<{ __typename: 'payrollCycles', id: string, name: string, description: string | null, createdAt: string | null, updatedAt: string | null }> };

export type GetPayrollDateTypesQueryVariables = Exact<{ [key: string]: never; }>;


export type GetPayrollDateTypesQuery = { __typename: 'query_root', payrollDateTypes: Array<{ __typename: 'payrollDateTypes', id: string, name: string, description: string | null, createdAt: string | null, updatedAt: string | null }> };
...
export type GetUnassignedPayrollsQuery = { __typename: 'query_root', payrolls: Array<(
    { __typename: 'payrolls' }
    & { ' $fragmentRefs'?: { 'PayrollForAssignmentFragment': PayrollForAssignmentFragment } }
  )> };

export type GetPayrollsNeedingAttentionQueryVariables = Exact<{ [key: string]: never; }>;


export type GetPayrollsNeedingAttentionQuery = { __typename: 'query_root', payrolls: Array<(
    { __typename: 'payrolls', primaryConsultant: { __typename: 'users', id: string, name: string } | null, manager: { __typename: 'users', id: string, name: string } | null }
    & { ' $fragmentRefs'?: { 'PayrollListItemFragment': PayrollListItemFragment } }
  )> };
...
export type GetPayrollsForBulkUpdateQuery = { __typename: 'query_root', payrolls: Array<(
    { __typename: 'payrolls' }
    & { ' $fragmentRefs'?: { 'PayrollBasicFragment': PayrollBasicFragment } }
  )> };
...
export type GetPayrollsForBulkAssignmentQuery = { __typename: 'query_root', payrolls: Array<(
    { __typename: 'payrolls' }
    & { ' $fragmentRefs'?: { 'PayrollForAssignmentFragment': PayrollForAssignmentFragment } }
  )> };
...
export type GetPayrollsForAuditQuery = { __typename: 'query_root', payrolls: Array<(
    { __typename: 'payrolls' }
    & { ' $fragmentRefs'?: { 'PayrollForAuditFragment': PayrollForAuditFragment } }
  )> };
...
export type GetPayrollActivityQuery = { __typename: 'query_root', payrolls: Array<(
    { __typename: 'payrolls', status: string, supersededDate: string | null }
    & { ' $fragmentRefs'?: { 'PayrollVersionInfoFragment': PayrollVersionInfoFragment } }
  )> };
...
export type GetPayrollsPaginatedQuery = { __typename: 'query_root', payrolls: Array<(
    { __typename: 'payrolls' }
    & { ' $fragmentRefs'?: { 'PayrollTableRowFragment': PayrollTableRowFragment } }
  )>, payrollsAggregate: { __typename: 'payrollsAggregate', aggregate: { __typename: 'payrollsAggregateFields', count: number } | null } };
...
export type SearchPayrollsPaginatedQuery = { __typename: 'query_root', payrolls: Array<(
    { __typename: 'payrolls' }
    & { ' $fragmentRefs'?: { 'PayrollTableRowFragment': PayrollTableRowFragment } }
  )>, searchAggregate: { __typename: 'payrollsAggregate', aggregate: { __typename: 'payrollsAggregateFields', count: number } | null } };

export type GetPayrollsQuickListQueryVariables = Exact<{ [key: string]: never; }>;


export type GetPayrollsQuickListQuery = { __typename: 'query_root', payrolls: Array<(
    { __typename: 'payrolls' }
    & { ' $fragmentRefs'?: { 'PayrollMinimalFragment': PayrollMinimalFragment } }
  )> };
...
export type GetActivePayrollsQuickListQuery = { __typename: 'query_root', payrolls: Array<(
    { __typename: 'payrolls' }
    & { ' $fragmentRefs'?: { 'PayrollMinimalFragment': PayrollMinimalFragment } }
  )> };
...
export type GetClientPayrollsQuickListQuery = { __typename: 'query_root', payrolls: Array<(
    { __typename: 'payrolls' }
    & { ' $fragmentRefs'?: { 'PayrollMinimalFragment': PayrollMinimalFragment } }
  )> };
...
export type GetUserUpcomingPayrollsQuery = { __typename: 'query_root', payrolls: Array<(
    { __typename: 'payrolls', nextPayDate: Array<{ __typename: 'payrollDates', originalEftDate: string, adjustedEftDate: string, processingDate: string }> }
    & { ' $fragmentRefs'?: { 'PayrollDashboardCardFragment': PayrollDashboardCardFragment } }
  )> };
...
export type GetPayrollsByMonthQuery = { __typename: 'query_root', payrolls: Array<(
    { __typename: 'payrolls', client: { __typename: 'clients', id: string, name: string } }
...
export type GetPayrollFamilyDatesQuery = { __typename: 'query_root', payrolls: Array<{ __typename: 'payrolls', id: string, name: string, versionNumber: number | null, status: string, payrollDates: Array<(
...
export type GetPayrollsMissingDatesQuery = { __typename: 'query_root', payrolls: Array<(
    { __typename: 'payrolls', payrollCycle: { __typename: 'payrollCycles', id: string, name: string, description: string | null }, payrollDateType: { __typename: 'payrollDateTypes', id: string, name: string, description: string | null } }
    & { ' $fragmentRefs'?: { 'PayrollListItemFragment': PayrollListItemFragment } }
  )> };
...
export type PayrollsUpdatesSubscription = { __typename: 'subscription_root', payrolls: Array<(
    { __typename: 'payrolls' }
    & { ' $fragmentRefs'?: { 'PayrollListItemFragment': PayrollListItemFragment } }
  )> };
...
export type PayrollUpdatesSubscription = { __typename: 'subscription_root', payrolls: Array<(
    { __typename: 'payrolls' }
    & { ' $fragmentRefs'?: { 'PayrollDetailedFragment': PayrollDetailedFragment } }
  )> };
...
export type ActivePayrollsUpdatesSubscription = { __typename: 'subscription_root', payrolls: Array<(
    { __typename: 'payrolls', client: { __typename: 'clients', id: string, name: string } }
    & { ' $fragmentRefs'?: { 'PayrollSummaryFragment': PayrollSummaryFragment } }
  )> };
...
export type UnassignedPayrollsUpdatesSubscription = { __typename: 'subscription_root', payrolls: Array<(
    { __typename: 'payrolls' }
    & { ' $fragmentRefs'?: { 'PayrollForAssignmentFragment': PayrollForAssignmentFragment } }
  )> };
...
export type PayrollSystemHealthUpdatesSubscription = { __typename: 'subscription_root', payrolls: Array<(
    { __typename: 'payrolls', primaryConsultant: { __typename: 'users', id: string, name: string } | null, manager: { __typename: 'users', id: string, name: string } | null }
    & { ' $fragmentRefs'?: { 'PayrollListItemFragment': PayrollListItemFragment } }
  )> };
...
export type PayrollSubscriptionSubscription = { __typename: 'subscription_root', payrolls: Array<(
    { __typename: 'payrolls' }
    & { ' $fragmentRefs'?: { 'PayrollListItemFragment': PayrollListItemFragment } }
  )> };
