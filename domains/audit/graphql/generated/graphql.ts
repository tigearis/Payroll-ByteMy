 ...
 * 
 * Generated: 2025-06-24T11:35:03.183Z
...
export type AuditLogCoreFragment = { __typename: 'audit_audit_log', id: string, userId: string | null, eventTime: string, userEmail: string | null, userRole: string | null, action: string, resourceType: string, resourceId: string | null, success: boolean | null, ipAddress: string | null, userAgent: string | null, sessionId: string | null, metadata: any | null } & { ' $fragmentName'?: 'AuditLogCoreFragment' };
...
export type SecurityOverviewQuery = { __typename: 'query_root', recent_audit_logs: Array<{ __typename: 'audit_audit_log', id: string, eventTime: string, userId: string | null, userEmail: string | null, userRole: string | null, action: string, resourceType: string, resourceId: string | null, success: boolean | null, error_message: string | null, ipAddress: string | null, metadata: any | null }>, audit_log_count: { __typename: 'audit_audit_log_aggregate', aggregate: { __typename: 'audit_audit_log_aggregate_fields', count: number } | null }, failed_operations: Array<{ __typename: 'audit_audit_log', id: string, eventTime: string, userId: string | null, userEmail: string | null, userRole: string | null, action: string, resourceType: string, error_message: string | null, ipAddress: string | null }>, data_access_summary: Array<{ __typename: 'audit_data_access_log', id: string, accessedAt: string, userId: string, resourceType: string, accessType: string, dataClassification: string | null, rowCount: number | null, ipAddress: string | null }>, auth_events_summary: Array<{ __typename: 'audit_auth_events', id: string, eventTime: string, eventType: string, userId: string | null, userEmail: string | null, success: boolean | null, failureReason: string | null, ipAddress: string | null }> };
...
export type AuditLogQuery = { __typename: 'query_root', auditLogs: Array<{ __typename: 'audit_audit_log', id: string, userId: string | null, userEmail: string | null, userRole: string | null, action: string, resourceType: string, resourceId: string | null, success: boolean | null, error_message: string | null, ipAddress: string | null, eventTime: string }>, auditLogsAggregate: { __typename: 'audit_audit_log_aggregate', aggregate: { __typename: 'audit_audit_log_aggregate_fields', count: number } | null } };
...
export type SecurityEventsStreamSubscription = { __typename: 'subscription_root', auditLogs: Array<{ __typename: 'audit_audit_log', id: string, eventTime: string, userId: string | null, userEmail: string | null, userRole: string | null, action: string, resourceType: string, resourceId: string | null, success: boolean | null, error_message: string | null, ipAddress: string | null, metadata: any | null }> };
...
export type FailedOperationsStreamSubscription = { __typename: 'subscription_root', auditLogs: Array<{ __typename: 'audit_audit_log', id: string, eventTime: string, userId: string | null, userEmail: string | null, userRole: string | null, action: string, resourceType: string, error_message: string | null, ipAddress: string | null }> };
