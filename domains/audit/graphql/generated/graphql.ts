 ...
 * 
 * Generated: 2025-06-25T09:22:09.010Z
...
export type AuditLogCoreFragment = { __typename: 'auditLogs', id: string, userId: string | null, eventTime: string, userEmail: string | null, userRole: string | null, action: string, resourceType: string, resourceId: string | null, success: boolean | null, ipAddress: string | null, userAgent: string | null, sessionId: string | null, metadata: any | null } & { ' $fragmentName'?: 'AuditLogCoreFragment' };

export type AuditLogWithUserFragment = (
  { __typename: 'auditLogs', oldValues: any | null, newValues: any | null, errorMessage: string | null, requestId: string | null }
...
export type AuthEventCoreFragment = { __typename: 'authEvents', id: string, eventTime: string, eventType: string, userId: string | null, userEmail: string | null, ipAddress: string | null, userAgent: string | null, success: boolean | null, failureReason: string | null, metadata: any | null } & { ' $fragmentName'?: 'AuthEventCoreFragment' };
...
export type BulkCreateAuditLogsMutation = { __typename: 'mutation_root', bulkInsertAuditLogs: { __typename: 'auditLogsMutationResponse', affectedRows: number, returning: Array<(
      { __typename: 'auditLogs' }
      & { ' $fragmentRefs'?: { 'AuditLogCoreFragment': AuditLogCoreFragment } }
    )> } | null };
...
export type UpdateAuditLogMutation = { __typename: 'mutation_root', updateAuditLogById: (
    { __typename: 'auditLogs' }
...
export type CreateMultipleAuditLogsMutation = { __typename: 'mutation_root', bulkInsertAuditLogs: { __typename: 'auditLogsMutationResponse', affectedRows: number, returning: Array<(
      { __typename: 'auditLogs' }
      & { ' $fragmentRefs'?: { 'AuditLogCoreFragment': AuditLogCoreFragment } }
    )> } | null };
...
export type CreateMultipleDataAccessLogsMutation = { __typename: 'mutation_root', bulkInsertDataAccessLogs: { __typename: 'dataAccessLogsMutationResponse', affectedRows: number, returning: Array<(
      { __typename: 'dataAccessLogs' }
      & { ' $fragmentRefs'?: { 'DataAccessLogCoreFragment': DataAccessLogCoreFragment } }
    )> } | null };
...
export type GetAuditLogsQuery = { __typename: 'query_root', auditLogs: Array<(
    { __typename: 'auditLogs' }
    & { ' $fragmentRefs'?: { 'AuditLogWithUserFragment': AuditLogWithUserFragment } }
  )>, auditLogsAggregate: { __typename: 'auditLogsAggregate', aggregate: { __typename: 'auditLogsAggregateFields', count: number } | null } };
...
export type GetDataAccessLogsQuery = { __typename: 'query_root', dataAccessLogs: Array<(
    { __typename: 'dataAccessLogs' }
    & { ' $fragmentRefs'?: { 'DataAccessLogCoreFragment': DataAccessLogCoreFragment } }
  )>, dataAccessLogsAggregate: { __typename: 'dataAccessLogsAggregate', aggregate: { __typename: 'dataAccessLogsAggregateFields', count: number, sum: { __typename: 'dataAccessLogsSumFields', rowCount: number | null } | null } | null } };
