...
export type GetExpiredInvitationsQuery = { __typename?: 'query_root', userInvitations: Array<{ __typename?: 'userInvitations', id: string, email: string, firstName: string, lastName: string, invitedRole: string, invitedAt: string, expiresAt: string }> };
