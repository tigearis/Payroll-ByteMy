...
export type AuthUserCoreFragment = { __typename: 'users', id: string, name: string, email: string, role: string, isActive: boolean | null, clerkUserId: string | null, createdAt: string | null, updatedAt: string | null } & { ' $fragmentName'?: 'AuthUserCoreFragment' };

export type AuthUserWithRolesFragment = (
  { __typename: 'users', assignedRoles: Array<{ __typename: 'userRoles', id: string, roleId: string, assignedRole: { __typename: 'roles', id: string, name: string, displayName: string, description: string | null, priority: number, isSystemRole: boolean } }> }
  & { ' $fragmentRefs'?: { 'AuthUserCoreFragment': AuthUserCoreFragment } }
) & { ' $fragmentName'?: 'AuthUserWithRolesFragment' };
...
export type AuthPermissionCoreFragment = { __typename: 'permissions', id: string, resourceId: string, action: string, description: string | null, legacyPermissionName: string | null, createdAt: string, updatedAt: string } & { ' $fragmentName'?: 'AuthPermissionCoreFragment' };

export type AuthUserRoleWithDetailsFragment = { __typename: 'userRoles', id: string, userId: string, roleId: string, createdAt: string, updatedAt: string, roleUser: { __typename: 'users', id: string, name: string, email: string, isActive: boolean | null }, assignedRole: { __typename: 'roles', id: string, name: string, displayName: string, description: string | null, priority: number } } & { ' $fragmentName'?: 'AuthUserRoleWithDetailsFragment' };

export type PermissionOverrideCoreFragment = { __typename: 'permissionOverrides', id: string, userId: string | null, role: string | null, resource: string, operation: string, granted: boolean, conditions: any | null, createdBy: string | null, expiresAt: string | null, createdAt: string, updatedAt: string } & { ' $fragmentName'?: 'PermissionOverrideCoreFragment' };

export type UserInvitationCoreFragment = { __typename: 'userInvitations', id: string, email: string, firstName: string, lastName: string, invitedRole: string, managerId: string | null, clerkInvitationId: string | null, clerkTicket: string | null, invitationMetadata: any | null, invitedBy: string, invitedAt: string, acceptedAt: string | null, acceptedBy: string | null, expiresAt: string, status: string, createdAt: string, updatedAt: string } & { ' $fragmentName'?: 'UserInvitationCoreFragment' };

export type UserInvitationWithDetailsFragment = (
  { __typename: 'userInvitations', invitedByUser: { __typename: 'users', id: string, name: string, email: string, role: string } | null, managerUser: { __typename: 'users', id: string, name: string, email: string, role: string } | null, acceptedByUser: { __typename: 'users', id: string, name: string, email: string, clerkUserId: string | null, isActive: boolean | null } | null }
  & { ' $fragmentRefs'?: { 'UserInvitationCoreFragment': UserInvitationCoreFragment } }
) & { ' $fragmentName'?: 'UserInvitationWithDetailsFragment' };
...
export type ValidateInvitationRolePermissionsQuery = { __typename: 'query_root', users: Array<{ __typename: 'users', id: string, role: string, assignedRoles: Array<{ __typename: 'userRoles', assignedRole: { __typename: 'roles', name: string, priority: number, assignedPermissions: Array<{ __typename: 'rolePermissions', grantedPermission: { __typename: 'permissions', action: string, relatedResource: { __typename: 'resources', name: string } } }> } }> }>, roles: Array<{ __typename: 'roles', id: string, name: string, priority: number, isSystemRole: boolean }> };
