 ...
 * 
 * Generated: 2025-06-22T06:34:07.538Z
...
export type UserCoreFragment = { __typename: 'users', id: string, name: string, email: string, isActive: boolean | null, isStaff: boolean | null, role: string, clerkUserId: string | null, createdAt: string | null, updatedAt: string | null } & { ' $fragmentName'?: 'UserCoreFragment' };
...
export type AssignRoleToUserMutation = { __typename: 'mutation_root', insertUserRole: { __typename: 'user_roles', id: string, roleId: string, role: { __typename: 'roles', name: string, displayName: string, priority: number } } | null };
...
export type RestoreUserAccessMutation = { __typename: 'mutation_root', deletePermissionOverrides: { __typename: 'permission_overrides_mutation_response', affected_rows: number } | null, insertUserRole: { __typename: 'user_roles', id: string, role: { __typename: 'roles', name: string, displayName: string } } | null };
