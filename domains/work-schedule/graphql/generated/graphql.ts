...
export type WorkScheduleCoreFragment = { __typename: 'work_schedule', id: string, user_id: string, work_day: string, work_hours: number, created_at: string | null, updated_at: string | null } & { ' $fragmentName'?: 'WorkScheduleCoreFragment' };

export type WorkScheduleWithUserFragment = (
  { __typename: 'work_schedule', user: { __typename: 'users', id: string, name: string, email: string, is_staff: boolean | null } }
...
export type CreateWorkScheduleMutation = { __typename: 'mutation_root', insert_work_schedule_one: (
    { __typename: 'work_schedule' }
    & { ' $fragmentRefs'?: { 'WorkScheduleCoreFragment': WorkScheduleCoreFragment } }
  ) | null };

export type CreateWorkSchedulesMutationVariables = Exact<{
  objects: Array<Work_Schedule_Insert_Input> | Work_Schedule_Insert_Input;
}>;


export type CreateWorkSchedulesMutation = { __typename: 'mutation_root', insert_work_schedule: { __typename: 'work_schedule_mutation_response', affected_rows: number, returning: Array<(
      { __typename: 'work_schedule' }
      & { ' $fragmentRefs'?: { 'WorkScheduleCoreFragment': WorkScheduleCoreFragment } }
    )> } | null };
...
export type UpdateWorkScheduleMutation = { __typename: 'mutation_root', update_work_schedule_by_pk: (
    { __typename: 'work_schedule' }
    & { ' $fragmentRefs'?: { 'WorkScheduleCoreFragment': WorkScheduleCoreFragment } }
  ) | null };

export type UpdateUserWorkScheduleMutationVariables = Exact<{
  user_id: Scalars['uuid']['input'];
  work_day: Scalars['String']['input'];
  work_hours: Scalars['numeric']['input'];
}>;


export type UpdateUserWorkScheduleMutation = { __typename: 'mutation_root', update_work_schedule: { __typename: 'work_schedule_mutation_response', affected_rows: number, returning: Array<(
      { __typename: 'work_schedule' }
      & { ' $fragmentRefs'?: { 'WorkScheduleCoreFragment': WorkScheduleCoreFragment } }
    )> } | null };
...
export type DeleteWorkScheduleMutation = { __typename: 'mutation_root', delete_work_schedule_by_pk: { __typename: 'work_schedule', id: string } | null };

export type DeleteUserWorkScheduleMutationVariables = Exact<{
  user_id: Scalars['uuid']['input'];
  work_day: Scalars['String']['input'];
}>;


export type DeleteUserWorkScheduleMutation = { __typename: 'mutation_root', delete_work_schedule: { __typename: 'work_schedule_mutation_response', affected_rows: number } | null };

export type ReplaceUserWorkScheduleMutationVariables = Exact<{
  user_id: Scalars['uuid']['input'];
  schedules: Array<Work_Schedule_Insert_Input> | Work_Schedule_Insert_Input;
}>;


export type ReplaceUserWorkScheduleMutation = { __typename: 'mutation_root', delete_work_schedule: { __typename: 'work_schedule_mutation_response', affected_rows: number } | null, insert_work_schedule: { __typename: 'work_schedule_mutation_response', affected_rows: number, returning: Array<(
      { __typename: 'work_schedule' }
      & { ' $fragmentRefs'?: { 'WorkScheduleCoreFragment': WorkScheduleCoreFragment } }
    )> } | null };
...
export type GetWorkSchedulesQueryVariables = Exact<{
  where?: InputMaybe<Work_Schedule_Bool_Exp>;
  order_by?: InputMaybe<Array<Work_Schedule_Order_By> | Work_Schedule_Order_By>;
}>;


export type GetWorkSchedulesQuery = { __typename: 'query_root', work_schedule: Array<(
    { __typename: 'work_schedule' }
...
export type GetWorkScheduleByUserQuery = { __typename: 'query_root', work_schedule: Array<(
    { __typename: 'work_schedule' }
    & { ' $fragmentRefs'?: { 'WorkScheduleCoreFragment': WorkScheduleCoreFragment } }
  )> };
...
export type GetWorkScheduleByIdQuery = { __typename: 'query_root', work_schedule_by_pk: (
    { __typename: 'work_schedule' }
    & { ' $fragmentRefs'?: { 'WorkScheduleWithUserFragment': WorkScheduleWithUserFragment } }
  ) | null };
...
export type GetTeamWorkSchedulesQuery = { __typename: 'query_root', work_schedule: Array<(
    { __typename: 'work_schedule' }
    & { ' $fragmentRefs'?: { 'WorkScheduleWithUserFragment': WorkScheduleWithUserFragment } }
  )> };
...
export type GetWorkScheduleAnalyticsQuery = { __typename: 'query_root', total_hours_by_day: { __typename: 'work_schedule_aggregate', nodes: Array<{ __typename: 'work_schedule', work_day: string }>, aggregate: { __typename: 'work_schedule_aggregate_fields', count: number, sum: { __typename: 'work_schedule_sum_fields', work_hours: number | null } | null, avg: { __typename: 'work_schedule_avg_fields', work_hours: number | null } | null } | null }, users_by_work_day: Array<{ __typename: 'work_schedule', work_day: string, work_hours: number, user: { __typename: 'users', id: string, name: string } }>, average_hours_per_user: { __typename: 'work_schedule_aggregate', aggregate: { __typename: 'work_schedule_aggregate_fields', sum: { __typename: 'work_schedule_sum_fields', work_hours: number | null } | null, avg: { __typename: 'work_schedule_avg_fields', work_hours: number | null } | null } | null, nodes: Array<{ __typename: 'work_schedule', user: { __typename: 'users', id: string, name: string } }> } };
...
export type SubscribeToWorkScheduleSubscription = { __typename: 'subscription_root', work_schedule: Array<(
    { __typename: 'work_schedule' }
    & { ' $fragmentRefs'?: { 'WorkScheduleCoreFragment': WorkScheduleCoreFragment } }
  )> };
...
export type SubscribeToTeamWorkSchedulesSubscription = { __typename: 'subscription_root', work_schedule: Array<(
    { __typename: 'work_schedule' }
    & { ' $fragmentRefs'?: { 'WorkScheduleWithUserFragment': WorkScheduleWithUserFragment } }
  )> };
...
export const WorkScheduleWithUserFragmentDoc = {"kind":"Document","definitions":[{"kind":"FragmentDefinition","name":{"kind":"Name","value":"WorkScheduleWithUser"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"work_schedule"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"FragmentSpread","name":{"kind":"Name","value":"WorkScheduleCore"}},{"kind":"Field","name":{"kind":"Name","value":"user"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"name"}},{"kind":"Field","name":{"kind":"Name","value":"email"}},{"kind":"Field","name":{"kind":"Name","value":"is_staff"}}]}}]}},{"kind":"FragmentDefinition","name":{"kind":"Name","value":"WorkScheduleCore"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"work_schedule"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"user_id"}},{"kind":"Field","name":{"kind":"Name","value":"work_day"}},{"kind":"Field","name":{"kind":"Name","value":"work_hours"}},{"kind":"Field","name":{"kind":"Name","value":"created_at"}},{"kind":"Field","name":{"kind":"Name","value":"updated_at"}}]}}]} as unknown as DocumentNode<WorkScheduleWithUserFragment, unknown>;
export const CreateWorkScheduleDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"CreateWorkSchedule"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"object"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"work_schedule_insert_input"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"insert_work_schedule_one"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"object"},"value":{"kind":"Variable","name":{"kind":"Name","value":"object"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"FragmentSpread","name":{"kind":"Name","value":"WorkScheduleCore"}}]}}]}},{"kind":"FragmentDefinition","name":{"kind":"Name","value":"WorkScheduleCore"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"work_schedule"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"user_id"}},{"kind":"Field","name":{"kind":"Name","value":"work_day"}},{"kind":"Field","name":{"kind":"Name","value":"work_hours"}},{"kind":"Field","name":{"kind":"Name","value":"created_at"}},{"kind":"Field","name":{"kind":"Name","value":"updated_at"}}]}}]} as unknown as DocumentNode<CreateWorkScheduleMutation, CreateWorkScheduleMutationVariables>;
export const CreateWorkSchedulesDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"CreateWorkSchedules"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"objects"}},"type":{"kind":"NonNullType","type":{"kind":"ListType","type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"work_schedule_insert_input"}}}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"insert_work_schedule"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"objects"},"value":{"kind":"Variable","name":{"kind":"Name","value":"objects"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"returning"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"FragmentSpread","name":{"kind":"Name","value":"WorkScheduleCore"}}]}},{"kind":"Field","name":{"kind":"Name","value":"affected_rows"}}]}}]}},{"kind":"FragmentDefinition","name":{"kind":"Name","value":"WorkScheduleCore"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"work_schedule"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"user_id"}},{"kind":"Field","name":{"kind":"Name","value":"work_day"}},{"kind":"Field","name":{"kind":"Name","value":"work_hours"}},{"kind":"Field","name":{"kind":"Name","value":"created_at"}},{"kind":"Field","name":{"kind":"Name","value":"updated_at"}}]}}]} as unknown as DocumentNode<CreateWorkSchedulesMutation, CreateWorkSchedulesMutationVariables>;
export const UpdateWorkScheduleDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"UpdateWorkSchedule"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"id"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"uuid"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"set"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"work_schedule_set_input"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"update_work_schedule_by_pk"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"pk_columns"},"value":{"kind":"ObjectValue","fields":[{"kind":"ObjectField","name":{"kind":"Name","value":"id"},"value":{"kind":"Variable","name":{"kind":"Name","value":"id"}}}]}},{"kind":"Argument","name":{"kind":"Name","value":"_set"},"value":{"kind":"Variable","name":{"kind":"Name","value":"set"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"FragmentSpread","name":{"kind":"Name","value":"WorkScheduleCore"}}]}}]}},{"kind":"FragmentDefinition","name":{"kind":"Name","value":"WorkScheduleCore"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"work_schedule"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"user_id"}},{"kind":"Field","name":{"kind":"Name","value":"work_day"}},{"kind":"Field","name":{"kind":"Name","value":"work_hours"}},{"kind":"Field","name":{"kind":"Name","value":"created_at"}},{"kind":"Field","name":{"kind":"Name","value":"updated_at"}}]}}]} as unknown as DocumentNode<UpdateWorkScheduleMutation, UpdateWorkScheduleMutationVariables>;
export const UpdateUserWorkScheduleDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"UpdateUserWorkSchedule"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"user_id"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"uuid"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"work_day"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"work_hours"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"numeric"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"update_work_schedule"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"where"},"value":{"kind":"ObjectValue","fields":[{"kind":"ObjectField","name":{"kind":"Name","value":"user_id"},"value":{"kind":"ObjectValue","fields":[{"kind":"ObjectField","name":{"kind":"Name","value":"_eq"},"value":{"kind":"Variable","name":{"kind":"Name","value":"user_id"}}}]}},{"kind":"ObjectField","name":{"kind":"Name","value":"work_day"},"value":{"kind":"ObjectValue","fields":[{"kind":"ObjectField","name":{"kind":"Name","value":"_eq"},"value":{"kind":"Variable","name":{"kind":"Name","value":"work_day"}}}]}}]}},{"kind":"Argument","name":{"kind":"Name","value":"_set"},"value":{"kind":"ObjectValue","fields":[{"kind":"ObjectField","name":{"kind":"Name","value":"work_hours"},"value":{"kind":"Variable","name":{"kind":"Name","value":"work_hours"}}}]}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"affected_rows"}},{"kind":"Field","name":{"kind":"Name","value":"returning"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"FragmentSpread","name":{"kind":"Name","value":"WorkScheduleCore"}}]}}]}}]}},{"kind":"FragmentDefinition","name":{"kind":"Name","value":"WorkScheduleCore"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"work_schedule"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"user_id"}},{"kind":"Field","name":{"kind":"Name","value":"work_day"}},{"kind":"Field","name":{"kind":"Name","value":"work_hours"}},{"kind":"Field","name":{"kind":"Name","value":"created_at"}},{"kind":"Field","name":{"kind":"Name","value":"updated_at"}}]}}]} as unknown as DocumentNode<UpdateUserWorkScheduleMutation, UpdateUserWorkScheduleMutationVariables>;
export const DeleteWorkScheduleDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"DeleteWorkSchedule"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"id"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"uuid"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"delete_work_schedule_by_pk"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"id"},"value":{"kind":"Variable","name":{"kind":"Name","value":"id"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}}]}}]}}]} as unknown as DocumentNode<DeleteWorkScheduleMutation, DeleteWorkScheduleMutationVariables>;
export const DeleteUserWorkScheduleDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"DeleteUserWorkSchedule"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"user_id"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"uuid"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"work_day"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"delete_work_schedule"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"where"},"value":{"kind":"ObjectValue","fields":[{"kind":"ObjectField","name":{"kind":"Name","value":"user_id"},"value":{"kind":"ObjectValue","fields":[{"kind":"ObjectField","name":{"kind":"Name","value":"_eq"},"value":{"kind":"Variable","name":{"kind":"Name","value":"user_id"}}}]}},{"kind":"ObjectField","name":{"kind":"Name","value":"work_day"},"value":{"kind":"ObjectValue","fields":[{"kind":"ObjectField","name":{"kind":"Name","value":"_eq"},"value":{"kind":"Variable","name":{"kind":"Name","value":"work_day"}}}]}}]}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"affected_rows"}}]}}]}}]} as unknown as DocumentNode<DeleteUserWorkScheduleMutation, DeleteUserWorkScheduleMutationVariables>;
export const ReplaceUserWorkScheduleDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"ReplaceUserWorkSchedule"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"user_id"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"uuid"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"schedules"}},"type":{"kind":"NonNullType","type":{"kind":"ListType","type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"work_schedule_insert_input"}}}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"delete_work_schedule"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"where"},"value":{"kind":"ObjectValue","fields":[{"kind":"ObjectField","name":{"kind":"Name","value":"user_id"},"value":{"kind":"ObjectValue","fields":[{"kind":"ObjectField","name":{"kind":"Name","value":"_eq"},"value":{"kind":"Variable","name":{"kind":"Name","value":"user_id"}}}]}}]}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"affected_rows"}}]}},{"kind":"Field","name":{"kind":"Name","value":"insert_work_schedule"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"objects"},"value":{"kind":"Variable","name":{"kind":"Name","value":"schedules"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"returning"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"FragmentSpread","name":{"kind":"Name","value":"WorkScheduleCore"}}]}},{"kind":"Field","name":{"kind":"Name","value":"affected_rows"}}]}}]}},{"kind":"FragmentDefinition","name":{"kind":"Name","value":"WorkScheduleCore"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"work_schedule"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"user_id"}},{"kind":"Field","name":{"kind":"Name","value":"work_day"}},{"kind":"Field","name":{"kind":"Name","value":"work_hours"}},{"kind":"Field","name":{"kind":"Name","value":"created_at"}},{"kind":"Field","name":{"kind":"Name","value":"updated_at"}}]}}]} as unknown as DocumentNode<ReplaceUserWorkScheduleMutation, ReplaceUserWorkScheduleMutationVariables>;
export const GetWorkSchedulesDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"GetWorkSchedules"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"where"}},"type":{"kind":"NamedType","name":{"kind":"Name","value":"work_schedule_bool_exp"}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"order_by"}},"type":{"kind":"ListType","type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"work_schedule_order_by"}}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"work_schedule"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"where"},"value":{"kind":"Variable","name":{"kind":"Name","value":"where"}}},{"kind":"Argument","name":{"kind":"Name","value":"order_by"},"value":{"kind":"Variable","name":{"kind":"Name","value":"order_by"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"FragmentSpread","name":{"kind":"Name","value":"WorkScheduleWithUser"}}]}}]}},{"kind":"FragmentDefinition","name":{"kind":"Name","value":"WorkScheduleCore"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"work_schedule"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"user_id"}},{"kind":"Field","name":{"kind":"Name","value":"work_day"}},{"kind":"Field","name":{"kind":"Name","value":"work_hours"}},{"kind":"Field","name":{"kind":"Name","value":"created_at"}},{"kind":"Field","name":{"kind":"Name","value":"updated_at"}}]}},{"kind":"FragmentDefinition","name":{"kind":"Name","value":"WorkScheduleWithUser"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"work_schedule"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"FragmentSpread","name":{"kind":"Name","value":"WorkScheduleCore"}},{"kind":"Field","name":{"kind":"Name","value":"user"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"name"}},{"kind":"Field","name":{"kind":"Name","value":"email"}},{"kind":"Field","name":{"kind":"Name","value":"is_staff"}}]}}]}}]} as unknown as DocumentNode<GetWorkSchedulesQuery, GetWorkSchedulesQueryVariables>;
export const GetWorkScheduleByUserDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"GetWorkScheduleByUser"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"user_id"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"uuid"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"work_schedule"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"where"},"value":{"kind":"ObjectValue","fields":[{"kind":"ObjectField","name":{"kind":"Name","value":"user_id"},"value":{"kind":"ObjectValue","fields":[{"kind":"ObjectField","name":{"kind":"Name","value":"_eq"},"value":{"kind":"Variable","name":{"kind":"Name","value":"user_id"}}}]}}]}},{"kind":"Argument","name":{"kind":"Name","value":"order_by"},"value":{"kind":"ObjectValue","fields":[{"kind":"ObjectField","name":{"kind":"Name","value":"work_day"},"value":{"kind":"EnumValue","value":"asc"}}]}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"FragmentSpread","name":{"kind":"Name","value":"WorkScheduleCore"}}]}}]}},{"kind":"FragmentDefinition","name":{"kind":"Name","value":"WorkScheduleCore"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"work_schedule"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"user_id"}},{"kind":"Field","name":{"kind":"Name","value":"work_day"}},{"kind":"Field","name":{"kind":"Name","value":"work_hours"}},{"kind":"Field","name":{"kind":"Name","value":"created_at"}},{"kind":"Field","name":{"kind":"Name","value":"updated_at"}}]}}]} as unknown as DocumentNode<GetWorkScheduleByUserQuery, GetWorkScheduleByUserQueryVariables>;
export const GetWorkScheduleByIdDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"GetWorkScheduleById"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"id"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"uuid"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"work_schedule_by_pk"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"id"},"value":{"kind":"Variable","name":{"kind":"Name","value":"id"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"FragmentSpread","name":{"kind":"Name","value":"WorkScheduleWithUser"}}]}}]}},{"kind":"FragmentDefinition","name":{"kind":"Name","value":"WorkScheduleCore"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"work_schedule"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"user_id"}},{"kind":"Field","name":{"kind":"Name","value":"work_day"}},{"kind":"Field","name":{"kind":"Name","value":"work_hours"}},{"kind":"Field","name":{"kind":"Name","value":"created_at"}},{"kind":"Field","name":{"kind":"Name","value":"updated_at"}}]}},{"kind":"FragmentDefinition","name":{"kind":"Name","value":"WorkScheduleWithUser"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"work_schedule"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"FragmentSpread","name":{"kind":"Name","value":"WorkScheduleCore"}},{"kind":"Field","name":{"kind":"Name","value":"user"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"name"}},{"kind":"Field","name":{"kind":"Name","value":"email"}},{"kind":"Field","name":{"kind":"Name","value":"is_staff"}}]}}]}}]} as unknown as DocumentNode<GetWorkScheduleByIdQuery, GetWorkScheduleByIdQueryVariables>;
export const GetTeamWorkSchedulesDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"GetTeamWorkSchedules"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"user_ids"}},"type":{"kind":"NonNullType","type":{"kind":"ListType","type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"uuid"}}}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"work_schedule"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"where"},"value":{"kind":"ObjectValue","fields":[{"kind":"ObjectField","name":{"kind":"Name","value":"user_id"},"value":{"kind":"ObjectValue","fields":[{"kind":"ObjectField","name":{"kind":"Name","value":"_in"},"value":{"kind":"Variable","name":{"kind":"Name","value":"user_ids"}}}]}}]}},{"kind":"Argument","name":{"kind":"Name","value":"order_by"},"value":{"kind":"ListValue","values":[{"kind":"ObjectValue","fields":[{"kind":"ObjectField","name":{"kind":"Name","value":"user_id"},"value":{"kind":"EnumValue","value":"asc"}}]},{"kind":"ObjectValue","fields":[{"kind":"ObjectField","name":{"kind":"Name","value":"work_day"},"value":{"kind":"EnumValue","value":"asc"}}]}]}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"FragmentSpread","name":{"kind":"Name","value":"WorkScheduleWithUser"}}]}}]}},{"kind":"FragmentDefinition","name":{"kind":"Name","value":"WorkScheduleCore"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"work_schedule"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"user_id"}},{"kind":"Field","name":{"kind":"Name","value":"work_day"}},{"kind":"Field","name":{"kind":"Name","value":"work_hours"}},{"kind":"Field","name":{"kind":"Name","value":"created_at"}},{"kind":"Field","name":{"kind":"Name","value":"updated_at"}}]}},{"kind":"FragmentDefinition","name":{"kind":"Name","value":"WorkScheduleWithUser"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"work_schedule"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"FragmentSpread","name":{"kind":"Name","value":"WorkScheduleCore"}},{"kind":"Field","name":{"kind":"Name","value":"user"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"name"}},{"kind":"Field","name":{"kind":"Name","value":"email"}},{"kind":"Field","name":{"kind":"Name","value":"is_staff"}}]}}]}}]} as unknown as DocumentNode<GetTeamWorkSchedulesQuery, GetTeamWorkSchedulesQueryVariables>;
export const GetWorkScheduleAnalyticsDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"GetWorkScheduleAnalytics"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","alias":{"kind":"Name","value":"total_hours_by_day"},"name":{"kind":"Name","value":"work_schedule_aggregate"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"nodes"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"work_day"}}]}},{"kind":"Field","name":{"kind":"Name","value":"aggregate"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"sum"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"work_hours"}}]}},{"kind":"Field","name":{"kind":"Name","value":"avg"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"work_hours"}}]}},{"kind":"Field","name":{"kind":"Name","value":"count"}}]}}]}},{"kind":"Field","alias":{"kind":"Name","value":"users_by_work_day"},"name":{"kind":"Name","value":"work_schedule"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"work_day"}},{"kind":"Field","name":{"kind":"Name","value":"user"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"name"}}]}},{"kind":"Field","name":{"kind":"Name","value":"work_hours"}}]}},{"kind":"Field","alias":{"kind":"Name","value":"average_hours_per_user"},"name":{"kind":"Name","value":"work_schedule_aggregate"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"aggregate"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"sum"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"work_hours"}}]}},{"kind":"Field","name":{"kind":"Name","value":"avg"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"work_hours"}}]}}]}},{"kind":"Field","name":{"kind":"Name","value":"nodes"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"user"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"name"}}]}}]}}]}}]}}]} as unknown as DocumentNode<GetWorkScheduleAnalyticsQuery, GetWorkScheduleAnalyticsQueryVariables>;
