 ...
 * 
 * Generated: 2025-06-23T07:04:53.151Z
...
export type PermissionCoreFragment = { __typename: 'permissions', id: string, resourceId: string, action: string, description: string | null, legacy_permission_name: string | null, createdAt: string, updatedAt: string } & { ' $fragmentName'?: 'PermissionCoreFragment' };
...
export type RoleCoreFragment = { __typename: 'roles', id: string, name: string, displayName: string, description: string | null, priority: number, isSystemRole: boolean, createdAt: string, updatedAt: string } & { ' $fragmentName'?: 'RoleCoreFragment' };
...
export type RoleWithPermissionsFragment = (
  { __typename: 'roles', rolePermissions: Array<{ __typename: 'role_permissions', id: string, conditions: any | null, permission: (
      { __typename: 'permissions' }
      & { ' $fragmentRefs'?: { 'PermissionWithResourceFragment': PermissionWithResourceFragment } }
