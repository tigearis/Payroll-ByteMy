 ...
 * 
 * Generated: 2025-06-26T06:06:24.031Z
 * Schema Version: Latest from Hasura
 * CodeGen Version: Unified v3.0
 */

/* DOMAIN: PERMISSIONS | SECURITY: CRITICAL | ACCESS: Admin + MFA + Full Audit */
...
export type RoleWithPermissionsFragment = { __typename?: 'roles', id: string, name: string, description?: string | null, displayName: string, priority: number, isSystemRole: boolean, createdAt: string, assignedPermissions: Array<{ __typename?: 'rolePermissions', id: string, conditions?: any | null, grantedPermission: { __typename?: 'permissions', id: string, action: string, description?: string | null, resourceId: string, createdAt: string, updatedAt: string, relatedResource: { __typename?: 'resources', id: string, name: string, description?: string | null } } }>, assignedPermissionsAggregate: { __typename?: 'rolePermissionsAggregate', aggregate?: { __typename?: 'rolePermissionsAggregateFields', count: number } | null } };

export type RolePermissionWithDetailsFragment = { __typename?: 'rolePermissions', id: string, roleId: string, permissionId: string, conditions?: any | null, createdAt: string, updatedAt: string, grantedToRole: { __typename?: 'roles', id: string, name: string, description?: string | null, displayName: string, priority: number, isSystemRole: boolean, createdAt: string }, grantedPermission: { __typename?: 'permissions', id: string, action: string, description?: string | null, resourceId: string, createdAt: string, updatedAt: string } };
...
export type CreateSystemPermissionMutation = { __typename?: 'mutation_root', insertPermission?: { __typename?: 'permissions', id: string, action: string, description?: string | null, resourceId: string, createdAt: string, updatedAt: string } | null };
...
export type UpdateSystemPermissionMutation = { __typename?: 'mutation_root', updatePermissionById?: { __typename?: 'permissions', id: string, action: string, description?: string | null, resourceId: string, createdAt: string, updatedAt: string } | null };
...
export type DeleteSystemPermissionMutation = { __typename?: 'mutation_root', deletePermissionById?: { __typename?: 'permissions', id: string, action: string } | null };
...
export type AssignPermissionToRoleMutation = { __typename?: 'mutation_root', insertRolePermission?: { __typename?: 'rolePermissions', id: string, roleId: string, permissionId: string, conditions?: any | null, createdAt: string, updatedAt: string, grantedToRole: { __typename?: 'roles', id: string, name: string, description?: string | null, displayName: string, priority: number, isSystemRole: boolean, createdAt: string }, grantedPermission: { __typename?: 'permissions', id: string, action: string, description?: string | null, resourceId: string, createdAt: string, updatedAt: string } } | null };
...
export type UpdateSystemRolePermissionMutation = { __typename?: 'mutation_root', updateRolePermissionById?: { __typename?: 'rolePermissions', id: string, roleId: string, permissionId: string, conditions?: any | null, createdAt: string, updatedAt: string, grantedToRole: { __typename?: 'roles', id: string, name: string, description?: string | null, displayName: string, priority: number, isSystemRole: boolean, createdAt: string }, grantedPermission: { __typename?: 'permissions', id: string, action: string, description?: string | null, resourceId: string, createdAt: string, updatedAt: string } } | null };
...
export type GetPermissionsQuery = { __typename?: 'query_root', permissions: Array<{ __typename?: 'permissions', id: string, action: string, description?: string | null, resourceId: string, createdAt: string, updatedAt: string, relatedResource: { __typename?: 'resources', id: string, name: string, description?: string | null } }> };
...
export type GetPermissionByIdQuery = { __typename?: 'query_root', permissionById?: { __typename?: 'permissions', id: string, action: string, description?: string | null, resourceId: string, createdAt: string, updatedAt: string, relatedResource: { __typename?: 'resources', id: string, name: string, description?: string | null } } | null };
...
export type GetRoleByIdQuery = { __typename?: 'query_root', roleById?: { __typename?: 'roles', id: string, name: string, description?: string | null, displayName: string, priority: number, isSystemRole: boolean, createdAt: string, assignedPermissions: Array<{ __typename?: 'rolePermissions', id: string, roleId: string, permissionId: string, conditions?: any | null, createdAt: string, updatedAt: string, grantedToRole: { __typename?: 'roles', id: string, name: string, description?: string | null, displayName: string, priority: number, isSystemRole: boolean, createdAt: string }, grantedPermission: { __typename?: 'permissions', id: string, action: string, description?: string | null, resourceId: string, createdAt: string, updatedAt: string } }> } | null };
...
export type GetRolePermissionsQuery = { __typename?: 'query_root', rolePermissions: Array<{ __typename?: 'rolePermissions', id: string, roleId: string, permissionId: string, conditions?: any | null, createdAt: string, updatedAt: string, grantedToRole: { __typename?: 'roles', id: string, name: string, description?: string | null, displayName: string, priority: number, isSystemRole: boolean, createdAt: string }, grantedPermission: { __typename?: 'permissions', id: string, action: string, description?: string | null, resourceId: string, createdAt: string, updatedAt: string } }> };
...
export type GetPermissionsByResourceQuery = { __typename?: 'query_root', permissions: Array<{ __typename?: 'permissions', id: string, action: string, description?: string | null, legacyPermissionName?: string | null, resourceId: string, createdAt: string, updatedAt: string }> };
...
export type RolePermissionsUpdatedSubscription = { __typename?: 'subscription_root', rolePermissions: Array<{ __typename?: 'rolePermissions', id: string, roleId: string, permissionId: string, conditions?: any | null, createdAt: string, updatedAt: string, grantedToRole: { __typename?: 'roles', id: string, name: string, description?: string | null, displayName: string, priority: number, isSystemRole: boolean, createdAt: string }, grantedPermission: { __typename?: 'permissions', id: string, action: string, description?: string | null, resourceId: string, createdAt: string, updatedAt: string } }> };

export type PermissionsUpdatedSubscriptionVariables = Exact<{ [key: string]: never; }>;


export type PermissionsUpdatedSubscription = { __typename?: 'subscription_root', permissions: Array<{ __typename?: 'permissions', id: string, action: string, description?: string | null, resourceId: string, createdAt: string, updatedAt: string, relatedResource: { __typename?: 'resources', id: string, name: string, description?: string | null } }> };
