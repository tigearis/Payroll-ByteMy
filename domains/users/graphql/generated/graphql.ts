...
export type GetCurrentUserQuery = { __typename: 'query_root', user: { __typename: 'users', id: string, name: string, role: string, isStaff: boolean | null, isActive: boolean | null, managerId: string | null, clerkUserId: string | null } | null };
