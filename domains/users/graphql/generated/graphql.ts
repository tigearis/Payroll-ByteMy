...
export type UserWithPayrollsFragment = ({ __typename: "users" } & {
  " $fragmentRefs"?: { UserCoreFragment: UserCoreFragment };
...
export type UserForAuthFragment = {
  ...
  isActive: boolean | null;
  clerkUserId: string | null;
} & { " $fragmentName"?: "UserForAuthFragment" };

export type UserForAuditFragment = {
  __typename: "users";
  id: string;
  name: string;
  email: string;
  role: string;
  isActive: boolean | null;
} & { " $fragmentName"?: "UserForAuditFragment" };

export type UserRoleInfoFragment = {
  __typename: "users";
  id: string;
  name: string;
  email: string;
  ...
  userRoles: Array<{
    __typename: "user_roles";
    role: { __typename: "roles"; name: string; description: string | null };
  }>;
} & { " $fragmentName"?: "UserRoleInfoFragment" };

export type UserPermissionsInfoFragment = {
  __typename: "users";
  id: string;
  name: string;
  role: string;
    ...
    role: {
      ...
      rolePermissions: Array<{
        ...
        permission: {
          ...
          action: string;
          description: string | null;
          resource: { __typename: "resources"; name: string };
        };
      }>;
    };
  }>;
} & { " $fragmentName"?: "UserPermissionsInfoFragment" };
...
export type UpdateUserRoleFromClerkMutation = {
  __typename: "mutation_root";
  updateUsers: {
    __typename: "users_mutation_response";
...
export type GetUserPermissionsQuery = {
  ...
  user:
    | ({ __typename: "users" } & {
        " $fragmentRefs"?: {
          UserPermissionsInfoFragment: UserPermissionsInfoFragment;
        };
      })
    | null;
};
...
export type GetUsersForAuditQuery = {
  __typename: "query_root";
  users: Array<
    { __typename: "users" } & {
...
export type GetUserStatsQuery = {
  ...
  byRole: {
    __typename: "users_aggregate";
    nodes: Array<{ __typename: "users"; role: string }>;
    aggregate: { __typename: "users_aggregate_fields"; count: number } | null;
  };
};
...
export type GetUserSessionInfoQuery = {
  __typename: "query_root";
  user: {
    __typename: "users";
    id: string;
...
export type GetUserRoleFallbackQuery = {
  __typename: "query_root";
  user: {
    __typename: "users";
    id: string;
...
export type GetUsersWithLimitQuery = {
  __typename: "query_root";
  users: Array<{
    __typename: "users";
    id: string;
...
export type GetUserProfileSettingsQuery = {
  __typename: "query_root";
  user: {
    __typename: "users";
    id: string;
...
export type GetUsersWithFilteringQuery = {
  __typename: "query_root";
  users: Array<{
    __typename: "users";
    id: string;
...
export type GetUserRoleSecureQuery = {
  __typename: "query_root";
  user: {
    __typename: "users";
    id: string;
...
export type GetUserRoleFallbackSecureQuery = {
  __typename: "query_root";
  user: {
    __typename: "users";
    id: string;
...
export type StaffSubscriptionSubscriptionVariables = Exact<{
  [key: string]: never;
}>;

export type StaffSubscriptionSubscription = {
  __typename: "subscription_root";
  users: Array<{
    __typename: "users";
    id: string;
...
export type StaffListUpdatesSubscriptionVariables = Exact<{
  [key: string]: never;
}>;

export type StaffListUpdatesSubscription = {
  __typename: "subscription_root";
  users: Array<
    { __typename: "users" } & {
      " $fragmentRefs"?: { UserBasicInfoFragment: UserBasicInfoFragment };
...
export const UserWithRolesFragmentDoc = {
  kind: "Document",
  definitions: [
    {
      kind: "FragmentDefinition",
      name: { kind: "Name", value: "UserWithRoles" },
      typeCondition: {
        kind: "NamedType",
        name: { kind: "Name", value: "users" },
      },
      selectionSet: {
        kind: "SelectionSet",
        selections: [
          { kind: "FragmentSpread", name: { kind: "Name", value: "UserCore" } },
          {
            kind: "Field",
...
} as unknown as DocumentNode<UserWithRolesFragment, unknown>;
export const UserWithTeamFragmentDoc = {
  kind: "Document",
  definitions: [
    {
      kind: "FragmentDefinition",
      name: { kind: "Name", value: "UserWithTeam" },
      typeCondition: {
        kind: "NamedType",
        name: { kind: "Name", value: "users" },
      },
...
} as unknown as DocumentNode<UserWithTeamFragment, unknown>;
export const UserWithWorkScheduleFragmentDoc = {
  kind: "Document",
  definitions: [
    {
      kind: "FragmentDefinition",
      name: { kind: "Name", value: "UserWithWorkSchedule" },
      typeCondition: {
        kind: "NamedType",
        name: { kind: "Name", value: "users" },
      },
      selectionSet: {
        ...
        selections: [
          ...
          {
            kind: "Field",
            name: { kind: "Name", value: "workSchedules" },
            selectionSet: {
              kind: "SelectionSet",
              selections: [
                { kind: "Field", name: { kind: "Name", value: "id" } },
...
} as unknown as DocumentNode<UserWithWorkScheduleFragment, unknown>;
export const UserWithPayrollsFragmentDoc = {
  kind: "Document",
  definitions: [
    {
      kind: "FragmentDefinition",
      name: { kind: "Name", value: "UserWithPayrolls" },
      typeCondition: {
        kind: "NamedType",
        name: { kind: "Name", value: "users" },
      },
...
} as unknown as DocumentNode<UserWithPayrollsFragment, unknown>;
...
} as unknown as DocumentNode<UserWithProfileFragment, unknown>;
export const UserWithAllRelationsFragmentDoc = {
  kind: "Document",
  definitions: [
    {
      kind: "FragmentDefinition",
      name: { kind: "Name", value: "UserWithAllRelations" },
      typeCondition: {
        kind: "NamedType",
        name: { kind: "Name", value: "users" },
      },
...
} as unknown as DocumentNode<UserWithAllRelationsFragment, unknown>;
...
export const UserWithManagerFragmentDoc = {
  kind: "Document",
  definitions: [
    {
      kind: "FragmentDefinition",
      name: { kind: "Name", value: "UserWithManager" },
      typeCondition: {
        kind: "NamedType",
        name: { kind: "Name", value: "users" },
      },
...
} as unknown as DocumentNode<UserWithManagerFragment, unknown>;
export const UserForStaffFragmentDoc = {
  kind: "Document",
  definitions: [
    {
      kind: "FragmentDefinition",
      name: { kind: "Name", value: "UserForStaff" },
      typeCondition: {
        kind: "NamedType",
        name: { kind: "Name", value: "users" },
      },
...
} as unknown as DocumentNode<UserForStaffFragment, unknown>;
export const UserForAuthFragmentDoc = {
  kind: "Document",
  definitions: [
    {
      kind: "FragmentDefinition",
      name: { kind: "Name", value: "UserForAuth" },
      typeCondition: {
        kind: "NamedType",
        name: { kind: "Name", value: "users" },
      },
...
} as unknown as DocumentNode<UserForAuthFragment, unknown>;
export const UserForAuditFragmentDoc = {
  kind: "Document",
  definitions: [
    {
      kind: "FragmentDefinition",
...
} as unknown as DocumentNode<UserForAuditFragment, unknown>;
export const UserRoleInfoFragmentDoc = {
  kind: "Document",
  definitions: [
    {
      kind: "FragmentDefinition",
      name: { kind: "Name", value: "UserRoleInfo" },
      typeCondition: {
        kind: "NamedType",
        name: { kind: "Name", value: "users" },
      },
...
} as unknown as DocumentNode<UserRoleInfoFragment, unknown>;
export const UserPermissionsInfoFragmentDoc = {
  kind: "Document",
  definitions: [
    {
      kind: "FragmentDefinition",
      name: { kind: "Name", value: "UserPermissionsInfo" },
      typeCondition: {
        kind: "NamedType",
        name: { kind: "Name", value: "users" },
      },
...
} as unknown as DocumentNode<UserPermissionsInfoFragment, unknown>;
  ...
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "mutation",
      name: { kind: "Name", value: "UpdateStaff" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: { kind: "Variable", name: { kind: "Name", value: "id" } },
...
} as unknown as DocumentNode<UpdateStaffMutation, UpdateStaffMutationVariables>;
  ...
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "mutation",
      name: { kind: "Name", value: "DeleteStaff" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: { kind: "Variable", name: { kind: "Name", value: "id" } },
...
} as unknown as DocumentNode<DeleteStaffMutation, DeleteStaffMutationVariables>;
export const UpdateUserRoleFromClerkDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "mutation",
      name: { kind: "Name", value: "UpdateUserRoleFromClerk" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: {
  ...
  UpdateUserRoleFromClerkMutation,
  UpdateUserRoleFromClerkMutationVariables
>;
export const CreateUserInDatabaseDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "mutation",
      name: { kind: "Name", value: "CreateUserInDatabase" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: {
        ...
        },
        {
          ...
          defaultValue: { kind: "EnumValue", value: "viewer" },
        },
        {
          kind: "VariableDefinition",
          variable: {
...
export const GetStaffByIdDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "GetStaffById" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: { kind: "Variable", name: { kind: "Name", value: "id" } },
...
} as unknown as DocumentNode<GetStaffByIdQuery, GetStaffByIdQueryVariables>;
export const GetAllUsersListDocument = {
  ...
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "GetAllUsersList" },
      selectionSet: {
        kind: "SelectionSet",
        selections: [
          {
  ...
  GetAllUsersListQuery,
  GetAllUsersListQueryVariables
>;
...
export const GetUsersForAuditDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "GetUsersForAudit" },
      selectionSet: {
        kind: "SelectionSet",
        selections: [
          {
  ...
  GetUsersForAuditQuery,
  GetUsersForAuditQueryVariables
>;
  ...
  definitions: [
    {
      ...
      selectionSet: {
        ...
        selections: [
          {
            kind: "Field",
            name: { kind: "Name", value: "usersAggregate" },
            selectionSet: {
              kind: "SelectionSet",
              selections: [
                {
          ...
          {
            kind: "Field",
            alias: { kind: "Name", value: "activeUsers" },
            name: { kind: "Name", value: "usersAggregate" },
            arguments: [
              {
                kind: "Argument",
...
export const GetUserSessionInfoDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "GetUserSessionInfo" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: { kind: "Variable", name: { kind: "Name", value: "id" } },
  ...
  GetUserSessionInfoQueryVariables
>;
...
export const GetUserRoleFallbackDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "GetUserRoleFallback" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: {
  ...
  GetUserRoleFallbackQuery,
  GetUserRoleFallbackQueryVariables
>;
export const GetUsersWithLimitDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "GetUsersWithLimit" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: {
  ...
  GetUsersWithLimitQuery,
  GetUsersWithLimitQueryVariables
>;
export const GetUserProfileSettingsDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "GetUserProfileSettings" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: { kind: "Variable", name: { kind: "Name", value: "id" } },
  ...
  GetUserProfileSettingsQueryVariables
>;
export const GetUsersWithFilteringDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "GetUsersWithFiltering" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: {
  ...
  GetUsersWithFilteringQuery,
  GetUsersWithFilteringQueryVariables
>;
export const GetManagersDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "GetManagers" },
      selectionSet: {
        kind: "SelectionSet",
        selections: [
          {
                        ...
                        fields: [
                          {
                            ...
                            value: {
                              kind: "ListValue",
                              values: [
                                { kind: "EnumValue", value: "developer" },
                                { kind: "EnumValue", value: "manager" },
                              ],
                            },
                          },
                        ],
...
} as unknown as DocumentNode<GetManagersQuery, GetManagersQueryVariables>;
export const GetUserRoleSecureDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
  ...
  GetUserRoleSecureQuery,
  GetUserRoleSecureQueryVariables
>;
export const GetUserRoleFallbackSecureDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "GetUserRoleFallbackSecure" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: {
  ...
  GetUserRoleFallbackSecureQuery,
  GetUserRoleFallbackSecureQueryVariables
>;
export const StaffSubscriptionDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "subscription",
      name: { kind: "Name", value: "StaffSubscription" },
      selectionSet: {
        kind: "SelectionSet",
        selections: [
          {
  ...
  StaffSubscriptionSubscription,
  StaffSubscriptionSubscriptionVariables
>;
...
>;
export const StaffListUpdatesDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "subscription",
      name: { kind: "Name", value: "StaffListUpdates" },
      selectionSet: {
        kind: "SelectionSet",
        selections: [
          {
  ...
  StaffListUpdatesSubscription,
  StaffListUpdatesSubscriptionVariables
>;
