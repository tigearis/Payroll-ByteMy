 ...
 * 
 * Generated: 2025-06-25T10:56:21.983Z
...
export type UsersUserCoreFragment = { __typename: 'users', id: string, name: string, email: string, isActive: boolean | null, isStaff: boolean | null, role: string, clerkUserId: string | null, createdAt: string | null, updatedAt: string | null } & { ' $fragmentName'?: 'UsersUserCoreFragment' };

export type UserWithProfileFragment = (
  { __typename: 'users', username: string | null, image: string | null }
  & { ' $fragmentRefs'?: { 'UsersUserCoreFragment': UsersUserCoreFragment } }
) & { ' $fragmentName'?: 'UserWithProfileFragment' };

export type UserWithRolesFragment = (
  { __typename: 'users', assignedRoles: Array<{ __typename: 'userRoles', id: string, roleId: string, assignedRole: { __typename: 'roles', id: string, name: string, displayName: string, description: string | null, priority: number, isSystemRole: boolean, assignedPermissions: Array<{ __typename: 'rolePermissions', id: string, conditions: any | null, permissionId: string, grantedPermission: { __typename: 'permissions', id: string, action: string, description: string | null, relatedResource: { __typename: 'resources', id: string, name: string, displayName: string, description: string | null } } }> } }> }
  & { ' $fragmentRefs'?: { 'UsersUserCoreFragment': UsersUserCoreFragment } }
) & { ' $fragmentName'?: 'UserWithRolesFragment' };

export type UserWithTeamFragment = (
  { __typename: 'users' }
  & { ' $fragmentRefs'?: { 'UsersUserCoreFragment': UsersUserCoreFragment } }
) & { ' $fragmentName'?: 'UserWithTeamFragment' };

export type UserWithWorkScheduleFragment = (
  { __typename: 'users', userWorkSchedules: Array<{ __typename: 'workSchedules', id: string, workDay: string, workHours: number, createdAt: string | null, updatedAt: string | null }> }
  & { ' $fragmentRefs'?: { 'UsersUserCoreFragment': UsersUserCoreFragment } }
) & { ' $fragmentName'?: 'UserWithWorkScheduleFragment' };

export type UserWithPayrollsFragment = (
  { __typename: 'users' }
  & { ' $fragmentRefs'?: { 'UsersUserCoreFragment': UsersUserCoreFragment } }
) & { ' $fragmentName'?: 'UserWithPayrollsFragment' };

export type UserWithAllRelationsFragment = (
  { __typename: 'users', assignedRoles: Array<{ __typename: 'userRoles', id: string, roleId: string, assignedRole: { __typename: 'roles', id: string, name: string, displayName: string, description: string | null, priority: number } }>, userWorkSchedules: Array<{ __typename: 'workSchedules', id: string, workDay: string, workHours: number, createdAt: string | null, updatedAt: string | null }> }
  & { ' $fragmentRefs'?: { 'UserWithProfileFragment': UserWithProfileFragment } }
) & { ' $fragmentName'?: 'UserWithAllRelationsFragment' };

export type UserBasicInfoFragment = { __typename: 'users', id: string, name: string, email: string, role: string, username: string | null, image: string | null, isStaff: boolean | null, isActive: boolean | null, managerId: string | null, clerkUserId: string | null } & { ' $fragmentName'?: 'UserBasicInfoFragment' };

export type UserForStaffFragment = (
  { __typename: 'users' }
  & { ' $fragmentRefs'?: { 'UserWithProfileFragment': UserWithProfileFragment } }
) & { ' $fragmentName'?: 'UserForStaffFragment' };

export type UserForAuthFragment = { __typename: 'users', id: string, name: string, email: string, role: string, isActive: boolean | null, clerkUserId: string | null } & { ' $fragmentName'?: 'UserForAuthFragment' };

export type UserForAuditFragment = { __typename: 'users', id: string, name: string, email: string, role: string, isActive: boolean | null } & { ' $fragmentName'?: 'UserForAuditFragment' };

export type UserRoleInfoFragment = { __typename: 'users', id: string, name: string, email: string, role: string, isActive: boolean | null, assignedRoles: Array<{ __typename: 'userRoles', roleId: string, assignedRole: { __typename: 'roles', name: string, description: string | null } }> } & { ' $fragmentName'?: 'UserRoleInfoFragment' };

export type UserPermissionsInfoFragment = { __typename: 'users', id: string, name: string, role: string, assignedRoles: Array<{ __typename: 'userRoles', roleId: string, assignedRole: { __typename: 'roles', name: string, assignedPermissions: Array<{ __typename: 'rolePermissions', permissionId: string, grantedPermission: { __typename: 'permissions', action: string, description: string | null, relatedResource: { __typename: 'resources', name: string } } }> } }> } & { ' $fragmentName'?: 'UserPermissionsInfoFragment' };

export type UserSummaryFragment = { __typename: 'users', id: string, name: string, role: string, isActive: boolean | null, isStaff: boolean | null } & { ' $fragmentName'?: 'UserSummaryFragment' };

export type UserListItemFragment = (
  { __typename: 'users', email: string, managerId: string | null, clerkUserId: string | null, updatedAt: string | null }
  & { ' $fragmentRefs'?: { 'UserSummaryFragment': UserSummaryFragment } }
) & { ' $fragmentName'?: 'UserListItemFragment' };

export type UserDashboardCardFragment = (
  { __typename: 'users', managerUser: { __typename: 'users', id: string, name: string } | null }
  & { ' $fragmentRefs'?: { 'UserSummaryFragment': UserSummaryFragment } }
) & { ' $fragmentName'?: 'UserDashboardCardFragment' };

export type UserTeamSummaryFragment = (
  { __typename: 'users', email: string, managerUser: { __typename: 'users', id: string, name: string } | null }
  & { ' $fragmentRefs'?: { 'UserSummaryFragment': UserSummaryFragment } }
) & { ' $fragmentName'?: 'UserTeamSummaryFragment' };

export type UserMinimalFragment = { __typename: 'users', id: string, name: string, role: string } & { ' $fragmentName'?: 'UserMinimalFragment' };

export type UserTableRowFragment = (
  { __typename: 'users', managerUser: { __typename: 'users', id: string, name: string } | null }
  & { ' $fragmentRefs'?: { 'UserListItemFragment': UserListItemFragment } }
) & { ' $fragmentName'?: 'UserTableRowFragment' };
...
export type CreateUserMutation = { __typename: 'mutation_root', insertUser: (
    { __typename: 'users', username: string | null, image: string | null, managerId: string | null }
    & { ' $fragmentRefs'?: { 'UsersUserCoreFragment': UsersUserCoreFragment } }
  ) | null };
...
export type UpdateUserMutation = { __typename: 'mutation_root', updateUserById: (
    { __typename: 'users', username: string | null, image: string | null, managerId: string | null }
    & { ' $fragmentRefs'?: { 'UsersUserCoreFragment': UsersUserCoreFragment } }
  ) | null };
...
export type DeleteUserMutation = { __typename: 'mutation_root', updateUserById: (
    { __typename: 'users' }
...
export type UpdateUserRoleMutation = { __typename: 'mutation_root', updateUserById: (
    { __typename: 'users' }
    & { ' $fragmentRefs'?: { 'UserCoreFragment': UserCoreFragment } }
  ) | null };
...
export type BulkUpdateUsersMutation = { __typename: 'mutation_root', bulkUpdateUsers: { __typename: 'usersMutationResponse', affectedRows: number, returning: Array<(
      { __typename: 'users' }
      & { ' $fragmentRefs'?: { 'UserCoreFragment': UserCoreFragment } }
    )> } | null };
...
export type CreateUserFromClerkMutation = { __typename: 'mutation_root', insertUser: (
    { __typename: 'users' }
    & { ' $fragmentRefs'?: { 'UserCoreFragment': UserCoreFragment } }
  ) | null };
...
export type CreateUserByEmailMutation = { __typename: 'mutation_root', insertUser: (
    { __typename: 'users' }
    & { ' $fragmentRefs'?: { 'UserCoreFragment': UserCoreFragment } }
  ) | null };
...
export type UpdateUserProfileMutation = { __typename: 'mutation_root', updateUserById: (
    { __typename: 'users' }
    & { ' $fragmentRefs'?: { 'UserWithProfileFragment': UserWithProfileFragment } }
  ) | null };
...
export type DeactivateUserMutation = { __typename: 'mutation_root', updateUserById: (
    { __typename: 'users' }
    & { ' $fragmentRefs'?: { 'UserCoreFragment': UserCoreFragment } }
  ) | null };
...
export type ReactivateUserMutation = { __typename: 'mutation_root', updateUserById: (
    { __typename: 'users' }
    & { ' $fragmentRefs'?: { 'UserCoreFragment': UserCoreFragment } }
  ) | null };
...
export type UpdateStaffRoleMutation = { __typename: 'mutation_root', updateUserById: (
    { __typename: 'users' }
    & { ' $fragmentRefs'?: { 'UserCoreFragment': UserCoreFragment } }
  ) | null };
...
export type UpdateUserRoleFromClerkMutation = { __typename: 'mutation_root', bulkUpdateUsers: { __typename: 'usersMutationResponse', affectedRows: number, returning: Array<(
      { __typename: 'users' }
      & { ' $fragmentRefs'?: { 'UserCoreFragment': UserCoreFragment } }
    )> } | null };
...
export type GetUsersForDropdownQuery = { __typename: 'query_root', users: Array<{ __typename: 'users', id: string, name: string, email: string, role: string }> };

export type GetManagersQueryVariables = Exact<{ [key: string]: never; }>;


export type GetManagersQuery = { __typename: 'query_root', users: Array<(
    { __typename: 'users', username: string | null, image: string | null, managerId: string | null }
    & { ' $fragmentRefs'?: { 'UsersUserCoreFragment': UsersUserCoreFragment } }
  )> };
...
export type GetActiveUsersQuery = { __typename: 'query_root', users: Array<(
    { __typename: 'users' }
    & { ' $fragmentRefs'?: { 'UserBasicInfoFragment': UserBasicInfoFragment } }
  )> };
...
export type GetUserByClerkIdQuery = { __typename: 'query_root', users: Array<{ __typename: 'users', id: string, name: string, email: string, role: string, username: string | null, image: string | null, isStaff: boolean | null, isActive: boolean | null, managerId: string | null, clerkUserId: string | null }> };
...
export type GetStaffByIdQuery = { __typename: 'query_root', userById: { __typename: 'users', id: string, name: string, email: string, role: string, username: string | null, image: string | null, isStaff: boolean | null, isActive: boolean | null, clerkUserId: string | null, createdAt: string | null, updatedAt: string | null } | null };

export type GetAllUsersListQueryVariables = Exact<{ [key: string]: never; }>;


export type GetAllUsersListQuery = { __typename: 'query_root', users: Array<{ __typename: 'users', id: string, name: string, email: string, role: string, username: string | null, image: string | null, isStaff: boolean | null, isActive: boolean | null, managerId: string | null, clerkUserId: string | null }> };
...
export type GetUserProfileQuery = { __typename: 'query_root', userById: (
    { __typename: 'users' }
    & { ' $fragmentRefs'?: { 'UserWithProfileFragment': UserWithProfileFragment } }
  ) | null };
...
export type GetUsersWithRolesQuery = { __typename: 'query_root', users: Array<(
    { __typename: 'users' }
...
export type GetUserPermissionsQuery = { __typename: 'query_root', userById: (
    { __typename: 'users' }
    & { ' $fragmentRefs'?: { 'UserPermissionsInfoFragment': UserPermissionsInfoFragment } }
  ) | null };
...
export type SearchUsersQuery = { __typename: 'query_root', users: Array<(
    { __typename: 'users' }
    & { ' $fragmentRefs'?: { 'UserWithProfileFragment': UserWithProfileFragment } }
  )> };
...
export type GetUserSessionInfoQuery = { __typename: 'query_root', userById: { __typename: 'users', id: string, name: string, email: string, role: string, isActive: boolean | null } | null };
...
export type GetCurrentUserQuery = { __typename: 'query_root', userById: { __typename: 'users', id: string, name: string, role: string, isStaff: boolean | null, isActive: boolean | null, managerId: string | null, clerkUserId: string | null, createdAt: string | null, updatedAt: string | null } | null };
...
export type GetUserRoleQuery = { __typename: 'query_root', userById: { __typename: 'users', id: string, role: string, isStaff: boolean | null, isActive: boolean | null } | null };
...
export type GetUserRoleFallbackQuery = { __typename: 'query_root', userById: { __typename: 'users', id: string, role: string, isStaff: boolean | null, isActive: boolean | null, clerkUserId: string | null } | null };
...
export type GetUsersWithLimitQuery = { __typename: 'query_root', users: Array<{ __typename: 'users', id: string, name: string, email: string, role: string, isStaff: boolean | null, clerkUserId: string | null }> };
...
export type GetUserProfileSettingsQuery = { __typename: 'query_root', userById: { __typename: 'users', id: string, name: string, email: string, role: string, isStaff: boolean | null, isActive: boolean | null, clerkUserId: string | null, managerUser: { __typename: 'users', id: string, name: string, email: string } | null } | null };
...
export type GetUsersWithFilteringQuery = { __typename: 'query_root', users: Array<{ __typename: 'users', id: string, name: string, email: string, role: string, createdAt: string | null, updatedAt: string | null, isStaff: boolean | null, isActive: boolean | null, managerId: string | null, clerkUserId: string | null, managerUser: { __typename: 'users', id: string, name: string, email: string } | null }>, usersAggregate: { __typename: 'usersAggregate', aggregate: { __typename: 'usersAggregateFields', count: number } | null } };

export type GetDeveloperManagersQueryVariables = Exact<{ [key: string]: never; }>;


export type GetDeveloperManagersQuery = { __typename: 'query_root', users: Array<{ __typename: 'users', id: string, name: string, email: string, role: string }> };
...
export type GetUserRoleSecureQuery = { __typename: 'query_root', userById: { __typename: 'users', id: string, role: string, isStaff: boolean | null, isActive: boolean | null } | null };
...
export type GetUserRoleFallbackSecureQuery = { __typename: 'query_root', userById: { __typename: 'users', id: string, role: string, isStaff: boolean | null, isActive: boolean | null, clerkUserId: string | null } | null };
...
export type GetUserProfileCompleteQuery = { __typename: 'query_root', userById: { __typename: 'users', id: string, name: string, email: string, username: string | null, image: string | null, role: string, isStaff: boolean | null, isActive: boolean | null, createdAt: string | null, updatedAt: string | null, clerkUserId: string | null, managerUser: { __typename: 'users', id: string, name: string, email: string, image: string | null } | null, primaryConsultantPayrolls: Array<{ __typename: 'payrolls', id: string, name: string, status: string, employeeCount: number | null, client: { __typename: 'clients', name: string } }>, backupConsultantPayrolls: Array<{ __typename: 'payrolls', id: string, name: string, status: string, client: { __typename: 'clients', name: string } }>, managedPayrolls: Array<{ __typename: 'payrolls', id: string, name: string, status: string, client: { __typename: 'clients', name: string } }> } | null };
...
export type GetUserForDeletionQuery = { __typename: 'query_root', userById: { __typename: 'users', id: string, name: string, email: string, role: string, clerkUserId: string | null, isStaff: boolean | null, isActive: boolean | null, createdAt: string | null, managerUser: { __typename: 'users', id: string, name: string, email: string } | null } | null, payrolls: Array<{ __typename: 'payrolls', id: string, name: string, status: string }>, subordinates: Array<{ __typename: 'users', id: string, name: string, email: string }> };
...
export type GetCurrentUserRoleQuery = { __typename: 'query_root', users: Array<{ __typename: 'users', id: string, role: string, isStaff: boolean | null, isActive: boolean | null }> };
...
export type GetUsersPaginatedQuery = { __typename: 'query_root', users: Array<(
    { __typename: 'users' }
    & { ' $fragmentRefs'?: { 'UserListItemFragment': UserListItemFragment } }
  )>, usersAggregate: { __typename: 'usersAggregate', aggregate: { __typename: 'usersAggregateFields', count: number } | null } };
...
export type GetAllUsersPaginatedQuery = { __typename: 'query_root', users: Array<(
    { __typename: 'users' }
    & { ' $fragmentRefs'?: { 'UserTableRowFragment': UserTableRowFragment } }
  )>, allUsersAggregate: { __typename: 'usersAggregate', aggregate: { __typename: 'usersAggregateFields', count: number } | null } };
...
export type GetStaffPaginatedQuery = { __typename: 'query_root', users: Array<(
    { __typename: 'users', managerUser: (
      { __typename: 'users' }
      & { ' $fragmentRefs'?: { 'UserMinimalFragment': UserMinimalFragment } }
    ) | null }
    & { ' $fragmentRefs'?: { 'UserListItemFragment': UserListItemFragment } }
  )>, staffAggregate: { __typename: 'usersAggregate', aggregate: { __typename: 'usersAggregateFields', count: number } | null } };
...
export type SearchUsersPaginatedQuery = { __typename: 'query_root', users: Array<(
    { __typename: 'users' }
    & { ' $fragmentRefs'?: { 'UserListItemFragment': UserListItemFragment } }
  )>, searchAggregate: { __typename: 'usersAggregate', aggregate: { __typename: 'usersAggregateFields', count: number } | null } };
...
export type GetUserByIdCompleteQuery = { __typename: 'query_root', userById: { __typename: 'users', id: string, name: string, email: string, role: string, createdAt: string | null, updatedAt: string | null, isStaff: boolean | null, managerId: string | null, clerkUserId: string | null, managerUser: { __typename: 'users', id: string, name: string, email: string, role: string } | null } | null };
...
export type GetUserClerkIdQuery = { __typename: 'query_root', userById: { __typename: 'users', id: string, name: string, email: string, role: string, clerkUserId: string | null } | null };

export type GetUsersQuickListQueryVariables = Exact<{ [key: string]: never; }>;


export type GetUsersQuickListQuery = { __typename: 'query_root', users: Array<(
    { __typename: 'users' }
    & { ' $fragmentRefs'?: { 'UserMinimalFragment': UserMinimalFragment } }
  )> };
...
export type GetStaffQuickListQuery = { __typename: 'query_root', users: Array<(
    { __typename: 'users' }
    & { ' $fragmentRefs'?: { 'UserMinimalFragment': UserMinimalFragment } }
  )> };
...
export type GetManagersQuickListQuery = { __typename: 'query_root', users: Array<(
    { __typename: 'users' }
    & { ' $fragmentRefs'?: { 'UserMinimalFragment': UserMinimalFragment } }
  )> };
...
export type GetUserCardQuery = { __typename: 'query_root', userById: (
    { __typename: 'users', email: string, managerUser: (
      { __typename: 'users' }
      & { ' $fragmentRefs'?: { 'UserMinimalFragment': UserMinimalFragment } }
    ) | null }
    & { ' $fragmentRefs'?: { 'UserSummaryFragment': UserSummaryFragment } }
...
export type GetUserAssignmentDataQuery = { __typename: 'query_root', userById: (
    { __typename: 'users', email: string, activePayrollCount: { __typename: 'payrollsAggregate', aggregate: { __typename: 'payrollsAggregateFields', count: number } | null }, backupPayrollCount: { __typename: 'payrollsAggregate', aggregate: { __typename: 'payrollsAggregateFields', count: number } | null } }
    & { ' $fragmentRefs'?: { 'UserSummaryFragment': UserSummaryFragment } }
  ) | null };
...
export type GetUserWorkloadQuery = { __typename: 'query_root', userById: (
    { __typename: 'users', primaryPayrolls: Array<{ __typename: 'payrolls', id: string, name: string, status: string, client: { __typename: 'clients', name: string } }>, backupPayrolls: Array<{ __typename: 'payrolls', id: string, name: string, status: string, client: { __typename: 'clients', name: string } }> }
    & { ' $fragmentRefs'?: { 'UserSummaryFragment': UserSummaryFragment } }
  ) | null };
...
export type StaffSubscriptionSubscription = { __typename: 'subscription_root', users: Array<{ __typename: 'users', id: string, name: string, role: string, updatedAt: string | null }> };
...
export type UserUpdatesSubscription = { __typename: 'subscription_root', users: Array<(
    { __typename: 'users' }
    & { ' $fragmentRefs'?: { 'UserBasicInfoFragment': UserBasicInfoFragment } }
  )> };
...
export type StaffListUpdatesSubscription = { __typename: 'subscription_root', users: Array<(
    { __typename: 'users' }
    & { ' $fragmentRefs'?: { 'UserBasicInfoFragment': UserBasicInfoFragment } }
  )> };
...
export type UserRoleChangesSubscription = { __typename: 'subscription_root', users: Array<{ __typename: 'users', id: string, role: string, isActive: boolean | null, isStaff: boolean | null, updatedAt: string | null, managerId: string | null }> };
...
export type UserStatusUpdatesSubscription = { __typename: 'subscription_root', users: Array<{ __typename: 'users', id: string, name: string, role: string, isActive: boolean | null, isStaff: boolean | null, deactivatedAt: string | null, deactivatedBy: string | null, updatedAt: string | null }> };
...
export type UserSessionStatusSubscription = { __typename: 'subscription_root', users: Array<{ __typename: 'users', id: string, role: string, isActive: boolean | null, updatedAt: string | null }> };
...
export type TeamMemberUpdatesSubscription = { __typename: 'subscription_root', users: Array<{ __typename: 'users', id: string, name: string, role: string, isActive: boolean | null, updatedAt: string | null }> };
...
export type UserPermissionUpdatesSubscription = { __typename: 'subscription_root', users: Array<{ __typename: 'users', id: string, role: string, isActive: boolean | null, assignedRoles: Array<{ __typename: 'userRoles', roleId: string, assignedRole: { __typename: 'roles', name: string, assignedPermissions: Array<{ __typename: 'rolePermissions', permissionId: string, grantedPermission: { __typename: 'permissions', action: string, description: string | null, relatedResource: { __typename: 'resources', name: string } } }> } }> }> };
