 ...
 * 
 * Generated: 2025-06-22T05:39:22.810Z
...
export type BillingEventLogWithRelationsFragment = (
  { __typename: 'billing_event_log', billing_invoice: { __typename: 'billing_invoice', id: string } | null, user: { __typename: 'users', id: string, name: string, email: string } | null }
...
export type SubscribeToInvoiceStatusSubscription = { __typename: 'subscription_root', billing_invoice_by_pk: { __typename: 'billing_invoice', id: string, billing_event_logs: Array<(
      { __typename: 'billing_event_log' }
      & { ' $fragmentRefs'?: { 'BillingEventLogWithRelationsFragment': BillingEventLogWithRelationsFragment } }
    )> } | null };
