...
export type TempBillingPlaceholderFragment = { __typename?: 'billingInvoice', id: string, createdAt?: string | null };

export type PlaceholderBillingMutationMutationVariables = Exact<{
  id: Scalars['uuid']['input'];
}>;


export type PlaceholderBillingMutationMutation = { __typename?: 'mutation_root', deleteBillingInvoiceById?: { __typename?: 'billingInvoice', id: string } | null };

export type PlaceholderBillingQueryQueryVariables = Exact<{ [key: string]: never; }>;


export type PlaceholderBillingQueryQuery = { __typename?: 'query_root', billingInvoice: Array<{ __typename?: 'billingInvoice', id: string }> };

export type PlaceholderBillingSubscriptionSubscriptionVariables = Exact<{ [key: string]: never; }>;


export type PlaceholderBillingSubscriptionSubscription = { __typename?: 'subscription_root', billingInvoice: Array<{ __typename?: 'billingInvoice', id: string }> };
...
export const TempBillingPlaceholderFragmentDoc = {"kind":"Document","definitions":[{"kind":"FragmentDefinition","name":{"kind":"Name","value":"TempBillingPlaceholder"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"billingInvoice"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"createdAt"}}]}}]} as unknown as DocumentNode<TempBillingPlaceholderFragment, unknown>;
...
export const PlaceholderBillingMutationDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"PlaceholderBillingMutation"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"id"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"uuid"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"deleteBillingInvoiceById"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"id"},"value":{"kind":"Variable","name":{"kind":"Name","value":"id"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}}]}}]}}]} as unknown as DocumentNode<PlaceholderBillingMutationMutation, PlaceholderBillingMutationMutationVariables>;
export const PlaceholderBillingQueryDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"PlaceholderBillingQuery"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"billingInvoice"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"limit"},"value":{"kind":"IntValue","value":"1"}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}}]}}]}}]} as unknown as DocumentNode<PlaceholderBillingQueryQuery, PlaceholderBillingQueryQueryVariables>;
export const PlaceholderBillingSubscriptionDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"subscription","name":{"kind":"Name","value":"PlaceholderBillingSubscription"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"billingInvoice"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"limit"},"value":{"kind":"IntValue","value":"1"}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}}]}}]}}]} as unknown as DocumentNode<PlaceholderBillingSubscriptionSubscription, PlaceholderBillingSubscriptionSubscriptionVariables>;
