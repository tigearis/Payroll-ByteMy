 ...
 * 
 * Generated: 2025-06-26T08:26:40.476Z
 * Schema Version: Latest from Hasura
 * CodeGen Version: Unified v3.0
 */

/* DOMAIN: BILLING | SECURITY: HIGH | ACCESS: Role-based + Audit Logging */
...
export type PlaceholderBillingMutationMutationVariables = Exact<{ [key: string]: never; }>;


export type PlaceholderBillingMutationMutation = { __typename: 'mutation_root' };

export type PlaceholderBillingQueryQueryVariables = Exact<{ [key: string]: never; }>;


export type PlaceholderBillingQueryQuery = { __typename: 'query_root' };
...
export const PlaceholderBillingMutationDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"PlaceholderBillingMutation"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"__typename"}}]}}]} as unknown as DocumentNode;
export type PlaceholderBillingMutationMutationFn = Apollo.MutationFunction<PlaceholderBillingMutationMutation, PlaceholderBillingMutationMutationVariables>;

/**
 * __usePlaceholderBillingMutationMutation__
 *
 * To run a mutation, you first call `usePlaceholderBillingMutationMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `usePlaceholderBillingMutationMutation` returns a tuple that includes:
 ...
 *
 * @example
 * const [placeholderBillingMutationMutation, { data, loading, error }] = usePlaceholderBillingMutationMutation({
 *   variables: {
 *   },
 * });
 */
export function usePlaceholderBillingMutationMutation(baseOptions?: Apollo.MutationHookOptions<PlaceholderBillingMutationMutation, PlaceholderBillingMutationMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<PlaceholderBillingMutationMutation, PlaceholderBillingMutationMutationVariables>(PlaceholderBillingMutationDocument, options);
      }
export type PlaceholderBillingMutationMutationHookResult = ReturnType<typeof usePlaceholderBillingMutationMutation>;
export type PlaceholderBillingMutationMutationResult = Apollo.MutationResult<PlaceholderBillingMutationMutation>;
export type PlaceholderBillingMutationMutationOptions = Apollo.BaseMutationOptions<PlaceholderBillingMutationMutation, PlaceholderBillingMutationMutationVariables>;
export const PlaceholderBillingQueryDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"PlaceholderBillingQuery"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"__typename"}}]}}]} as unknown as DocumentNode;

/**
 * __usePlaceholderBillingQueryQuery__
 *
 * To run a query within a React component, call `usePlaceholderBillingQueryQuery` and pass it any options that fit your needs.
 * When your component renders, `usePlaceholderBillingQueryQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = usePlaceholderBillingQueryQuery({
 *   variables: {
 *   },
 * });
 */
export function usePlaceholderBillingQueryQuery(baseOptions?: Apollo.QueryHookOptions<PlaceholderBillingQueryQuery, PlaceholderBillingQueryQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<PlaceholderBillingQueryQuery, PlaceholderBillingQueryQueryVariables>(PlaceholderBillingQueryDocument, options);
      }
export function usePlaceholderBillingQueryLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<PlaceholderBillingQueryQuery, PlaceholderBillingQueryQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<PlaceholderBillingQueryQuery, PlaceholderBillingQueryQueryVariables>(PlaceholderBillingQueryDocument, options);
        }
export function usePlaceholderBillingQuerySuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<PlaceholderBillingQueryQuery, PlaceholderBillingQueryQueryVariables>) {
          const options = baseOptions === Apollo.skipToken ? baseOptions : {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<PlaceholderBillingQueryQuery, PlaceholderBillingQueryQueryVariables>(PlaceholderBillingQueryDocument, options);
        }
export type PlaceholderBillingQueryQueryHookResult = ReturnType<typeof usePlaceholderBillingQueryQuery>;
export type PlaceholderBillingQueryLazyQueryHookResult = ReturnType<typeof usePlaceholderBillingQueryLazyQuery>;
export type PlaceholderBillingQuerySuspenseQueryHookResult = ReturnType<typeof usePlaceholderBillingQuerySuspenseQuery>;
export type PlaceholderBillingQueryQueryResult = Apollo.QueryResult<PlaceholderBillingQueryQuery, PlaceholderBillingQueryQueryVariables>;