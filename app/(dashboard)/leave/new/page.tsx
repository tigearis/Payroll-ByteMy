      ...
      <div className="container mx-auto py-6">
        <Card>
          <CardContent className="p-12 text-center">
            ...
            <p className="text-gray-500">You must be signed in to request leave.</p>
          </CardContent>
        </Card>
      </div>
    );
    ...
    <div className="container mx-auto py-6 space-y-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="space-y-6">
          ...
          <Card>
            <CardHeader>
              <CardTitle className="text-sm font-medium">Leave Request Guidelines</CardTitle>
            </CardHeader>
            <CardContent className="space-y-3">
              <div className="text-sm space-y-2">
                ...
                <div className="flex items-start space-x-2">
                  <div className="w-2 h-2 bg-blue-500 rounded-full mt-1.5 flex-shrink-0"></div>
                  <span>Sick leave over 3 days may require medical certificate</span>
                </div>
                <div className="flex items-start space-x-2">
                  <div className="w-2 h-2 bg-blue-500 rounded-full mt-1.5 flex-shrink-0"></div>
            ...
            <CardContent className="space-y-3">
              <div className="space-y-3">
                <div className="border-l-4 border-blue-500 pl-3">
                  ...
                  <p className="text-xs text-gray-600">Paid vacation time and holiday leave</p>
                </div>
                <div className="border-l-4 border-orange-500 pl-3">
                  <h4 className="font-medium text-sm">Sick Leave</h4>
                  <p className="text-xs text-gray-600">Medical leave for illness or injury</p>
                </div>
                <div className="border-l-4 border-gray-500 pl-3">
                  <h4 className="font-medium text-sm">Unpaid Leave</h4>
                  <p className="text-xs text-gray-600">Extended leave without pay</p>
                </div>
                <div className="border-l-4 border-purple-500 pl-3">
                  <h4 className="font-medium text-sm">Other</h4>
                  <p className="text-xs text-gray-600">Emergency, bereavement, or special circumstances</p>
                </div>
              </div>
            </CardContent>
          </Card>
