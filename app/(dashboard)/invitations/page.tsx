...
function InvitationsPage() {
  ...
  const filterCount =
    statusFilter.length + roleFilter.length + urgencyFilter.length;
    ...
    <PermissionGuard action="read">
      <div className="container mx-auto py-6 space-y-6">
        <PageHeader
          ...
          description="Monitor and manage staff invitations and their status"
          breadcrumbs={[
            { label: "Dashboard", href: "/dashboard" },
            { label: "Invitations" },
          ]}
          actions={[
            { label: "Refresh", icon: RefreshCw, onClick: fetchInvitations },
            {
    ...
    <Card className="hover:shadow-md transition-shadow">
                ...
                <>
                  ...
                  <DropdownMenuItem
                    ...
                    onClick={() =>
                      onRevoke(
                        invitation.id,
                        "Revoked via invitation management"
                      )
                    }
                  >
      ...
      <CardContent>
        <div className="space-y-3">
          ...
          {invitation.invitedByUser && (
            <div className="flex items-center justify-between">
              ...
              <span className="text-sm font-medium">
                {invitation.invitedByUser?.computedName || "System"}
              </span>
            </div>
          )}
          <div className="flex items-center justify-between">
          ...
          {invitation.daysUntilExpiry !== null &&
            invitation.daysUntilExpiry >= 0 && (
              <div className="flex items-center justify-between">
                <span className="text-sm text-gray-500">Days left</span>
                <span
                  className={`text-sm font-medium ${
                    invitation.daysUntilExpiry <= 1
                      ? "text-red-600"
                      : invitation.daysUntilExpiry <= 3
                        ? "text-orange-600"
                        : invitation.daysUntilExpiry <= 7
                          ? "text-yellow-600"
                          : "text-green-600"
                  }`}
                >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              {invitation.managerId && (
                <div>
                  ...
                  <p>
                    {invitation.managerUser?.computedName || "Not assigned"}
                  </p>
                </div>
              )}
            </div>
          ...
          <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                ...
                <p>{invitation.invitedByUser?.computedName || "System"}</p>
              </div>
              <div>
                <label className="text-sm font-medium text-gray-500">
                  Resend Count
