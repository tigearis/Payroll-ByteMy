...
import { FileText, FileStack, BarChart3 } from 'lucide-react';
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-600 mt-2">
            Automated invoice generation and consolidation system
          </p>
        </div>
      </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <CardContent>
                <div className="space-y-4">
                  <div className="flex justify-between items-center">
                    <span className="text-sm text-gray-600">Total Invoices This Month</span>
                  ...
                  <div className="flex justify-between items-center">
                    <span className="text-sm text-gray-600">Average Collection Time</span>
            ...
            <Card>
              ...
              <CardContent>
                <div className="space-y-4">
                  <div className="flex justify-between items-center">
                    <span className="text-sm text-gray-600">Manual Hours Saved/Month</span>
                    <span className="font-medium">18.3 hours</span>
                  </div>
                  <div className="flex justify-between items-center">
                    <span className="text-sm text-gray-600">Cost Savings/Month</span>
            ...
            <Card className="md:col-span-2">
              <CardHeader>
                ...
                <CardDescription>Impact of the new billing system</CardDescription>
              </CardHeader>
              <CardContent>
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-center">
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="text-sm text-gray-600">Faster Invoice Generation</div>
                  </div>
                  <div className="space-y-2">
