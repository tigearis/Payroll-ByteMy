      ...
      fallback={
        <div className="container mx-auto py-6 space-y-6">
          <PageHeader
            ...
            description="The AI Data Assistant is currently disabled."
            breadcrumbs={[
    ...
    >
      <PermissionGuard action="read">
        <div className="container mx-auto py-6 space-y-6">
          {/* Header */}
          <PageHeader
            title="Hasura Data Assistant"
            description="Ask questions about your business data in natural language. The AI assistant dynamically generates GraphQL queries and provides insights."
            breadcrumbs={[
              { label: "Dashboard", href: "/dashboard" },
              { label: "AI Assistant", href: "/ai-assistant" },
              { label: "Data Assistant" },
            ...
            <Card>
              ...
              <CardContent>
                <CardDescription className="text-sm">
                  Automatically generates and executes GraphQL queries based on
                  your questions
                </CardDescription>
              </CardContent>
            </Card>
                ...
                <CardContent className="space-y-3">
                  ...
                  <div className="flex items-start space-x-2">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-gray-600">
                        The AI analyzes your intent and schema
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start space-x-2">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-gray-600">
                        GraphQL query is automatically created
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start space-x-2">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-gray-600">
                        Receive business insights, not just data
                      </p>
                    </div>
                  </div>
                </CardContent>
              ...
              <div className="flex items-start space-x-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-blue-600 mt-1">
                    All queries respect your role-based permissions. You'll only
                    see data you're authorized to access. The AI assistant never
                    performs write operations - it only reads data for analysis.
                  </p>
                </div>
              </div>
            </CardContent>
