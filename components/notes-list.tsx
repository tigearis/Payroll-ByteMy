...
import { GetNotesExtracted } from "@/domains/notes/graphql/queries.graphql";
import { 
  AddNoteExtracted, 
  UpdateNoteExtracted 
} from "@/domains/notes/graphql/mutations.graphql";
...
export function NotesList({
  ...
  const [updateNote] = useMutation(UpdateNoteExtracted, {
    onCompleted: () => {
      setIsUpdating(false);
  ...
  const [addNote] = useMutation(AddNoteExtracted, {
    onCompleted: () => {
      setIsAdding(false);
