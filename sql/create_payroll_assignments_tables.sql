...
-- Run this in your Hasura migrations or PostgreSQL directly
...
GRANT SELECT, INSERT, UPDATE, DELETE ON payroll_assignments TO hasura;
GRANT SELECT, INSERT ON payroll_assignment_audit TO hasura;
