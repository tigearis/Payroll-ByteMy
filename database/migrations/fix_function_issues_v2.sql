-- Migration: Fix Function Issues V2
-- Date: 2024-01-01
-- Description: Drop and recreate functions with proper parameter naming and fixes

-- ============================================================================
-- Fix 1: Drop and recreate get_latest_payroll_version with correct column reference
-- ============================================================================

DROP FUNCTION IF EXISTS public.get_latest_payroll_version(uuid);

CREATE FUNCTION public.get_latest_payroll_version(payroll_id uuid) 
...
-- ============================================================================
-- Fix 2: Drop and recreate get_payroll_version_history with camelCase parameter
-- ============================================================================

DROP FUNCTION IF EXISTS public.get_payroll_version_history(uuid);

CREATE FUNCTION public.get_payroll_version_history(payroll_id uuid) 
...
-- ============================================================================
-- Fix 3: Drop and recreate generate_payroll_dates with camelCase parameters
-- ============================================================================

DROP FUNCTION IF EXISTS public.generate_payroll_dates(uuid, date, date, integer);

CREATE FUNCTION public.generate_payroll_dates(
    payroll_id uuid, 
...
-- ============================================================================
-- Fix 4: Add simplified create_payroll_version function with camelCase parameters
-- ============================================================================
...
-- ============================================================================
-- Fix 5: Ensure activate_payroll_versions uses correct column reference
-- ============================================================================
