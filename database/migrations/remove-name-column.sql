...
RAISE NOTICE 'Created backup table users_name_backup with % rows', (SELECT COUNT(*) FROM users_name_backup);
...
-- SELECT COUNT(*) FROM users WHERE computed_name IS NOT NULL;
-- SELECT id, first_name, last_name, computed_name FROM users LIMIT 5;