...
export const DOMAIN_PATTERNS = {
  ...
  PAYROLL_ENTITIES: {
    types: /^(Payroll|PayrollDate|PayrollCycle|PayrollStatus|AdjustmentRule)[A-Z][a-zA-Z0-9]*$/,
    enums: /^(PayrollStatus|PayrollCycleType|PayrollDateType)[A-Z][a-zA-Z0-9]*$/,
    functions: /^(generate|process|calculate|validate|adjust)[A-Z][a-zA-Z0-9]*Payroll[A-Z][a-zA-Z0-9]*$/,
  },
  
  // Client management entities
  CLIENT_ENTITIES: {
    types: /^(Client|ClientExternalSystem)[A-Z][a-zA-Z0-9]*$/,
    functions: /^(create|update|delete|get)[A-Z][a-zA-Z0-9]*Client[A-Z][a-zA-Z0-9]*$/,
  },
  ...
  AUTH_ENTITIES: {
    ...
    functions: /^(authenticate|authorize|validate|check|assign)[A-Z][a-zA-Z0-9]*$/,
  ...
  GRAPHQL_OPERATIONS: {
    payroll: /^(Get|Create|Update|Delete|Generate|Process)[A-Z][a-zA-Z0-9]*Payroll[A-Z][a-zA-Z0-9]*$/,
    client: /^(Get|Create|Update|Delete)[A-Z][a-zA-Z0-9]*Client[A-Z][a-zA-Z0-9]*$/,
 ...
 */
export function validateFileName(fileName: string, fileType: keyof typeof FILE_NAMING_PATTERNS): boolean {
 ...
 */
export function validateIdentifier(identifier: string, identifierType: keyof typeof IDENTIFIER_PATTERNS): boolean {
