...
export const CONVENTION_PRESETS = {
  REACT_COMPONENT: {
    fileName: FILENAMING_PATTERNS.COMPONENT_FILES,
    componentName: IDENTIFIERPATTERNS.REACT_COMPONENTS,
    props: IDENTIFIERPATTERNS.TYPES,
    hooks: IDENTIFIERPATTERNS.HOOKS,
    handlers: IDENTIFIERPATTERNS.EVENT_HANDLERS,
  },

  TYPESCRIPT_MODULE: {
    fileName: FILENAMING_PATTERNS.TS_FILES,
    functions: IDENTIFIERPATTERNS.FUNCTIONS,
    variables: IDENTIFIERPATTERNS.VARIABLES,
    types: IDENTIFIERPATTERNS.TYPES,
    constants: IDENTIFIERPATTERNS.CONSTANTS,
  },

  GRAPHQL_SCHEMA: {
    fileName: FILENAMING_PATTERNS.GRAPHQL_FILES,
    operations: IDENTIFIERPATTERNS.GRAPHQL_OPERATIONS,
    variables: IDENTIFIERPATTERNS.GRAPHQL_VARIABLES,
    types: IDENTIFIERPATTERNS.TYPES,
  },

  API_ROUTE: {
    fileName: FILENAMING_PATTERNS.TS_FILES,
    handlers: IDENTIFIERPATTERNS.FUNCTIONS,
    types: IDENTIFIERPATTERNS.TYPES,
    constants: IDENTIFIERPATTERNS.CONSTANTS,
  },
} as const;
