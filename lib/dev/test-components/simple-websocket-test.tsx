...
export function SimpleWebSocketTest() {
  ...
  return (
    <div className="space-y-4 border p-4 rounded-md">
      ...
      <p className="text-sm">
        This test uses a public echo server to verify basic WebSocket
        functionality. If this works but your Hasura connection doesn&apos;t,
        the issue is specific to your Hasura configuration.
      </p>
    </div>
  );
}
